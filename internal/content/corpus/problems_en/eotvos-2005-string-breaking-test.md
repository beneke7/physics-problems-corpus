...
language: en
translated: true
links_hu: eotvos-2005-string-breaking-test
topic: [mechanics]
subtopic: [energy-conservation, impulse-momentum, tension-force, oscillations]
format: open-ended
math_tools: [calculus, differential-equations, geometry-trigonometry]
core_ideas: []
has_figure: true
figure_files: [eotvos-2005-p1-fig1.jpg]
provenance_note: "English translation of Eötvös Competition 2005, Problem P1; translated from Hungarian source statement (cache/phoxiv/eotvos/2005_S.pdf)."
verification_status: pending
---

**P1. String-breaking test**
...
b) What force is applied to the string at the moment when it becomes straight?
