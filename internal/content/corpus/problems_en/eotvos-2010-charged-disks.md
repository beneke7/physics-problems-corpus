...
language: en
translated: true
links_hu: eotvos-2010-charged-disks
topic: [electromagnetism]
subtopic: [electrostatics, charge-distribution, conductors, electromagnetic-shielding, influence, force-analysis]
format: open-ended
...
**Problem 3. Charged disks and electromagnetic shielding**

Two identical thin-metal disks ($A$ and $B$), say 5 cm in diameter, hang from insulating threads directly opposite each other, parallel, close to each other, say at a 2 mm distance, as shown in figure a). Both disks are given the same appropriately small electric charge $q$. (Since $q$ is small, neither the tiny displacement of the disks nor the risk of discharge through air causes problems.) Initially, of course, each disk experiences a repulsive force from the other.
...
b) What would be the result if we tested Gabi's suggestion?

c) Is it possible to have a neutral disk $C$ of such size that the force on A and B would be exactly zero?
