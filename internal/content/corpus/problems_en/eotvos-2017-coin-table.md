...
translated: true
topic: [mechanics]
subtopic: [friction, kinematics, force-balance, work, energy-conservation]
format: open-ended
math_tools: [algebra, geometry, calculus]
core_ideas: []
has_figure: true
figure_files: [eotvos-2017-coin-table-fig1.png]
provenance_note: "English translation of Eötvös Competition 2017, Problem 1; translated from Hungarian source statement (cache/phoxiv/eotvos/2017.pdf). Statement figure harvested from the source PDF."
verification_status: pending
links_hu: eotvos-2017-coin-table
---

**1. Coin falling off the table**
...
Data: $m=7.7 \mathrm{~g}$, $d=1.0 \mathrm{~m}$, $\mu=0.3$.
