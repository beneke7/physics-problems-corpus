...
language: en
translated: true
links_hu: eotvos-2006-superconductor-loop
topic: [electromagnetism]
subtopic: [electromagnetic-induction, faraday, superconductivity, magnetic-dipole, rotational-dynamics, energy-conservation]
format: open-ended
...
**Problem 3. Induced Current in a Superconducting Loop**

A short-circuited flat square coil is made of superconducting material (negligible resistance). The sides of the square each have length $l$, and each side has mass $m$. The coil, with inductance $L$, can rotate freely about its lower horizontal edge.
