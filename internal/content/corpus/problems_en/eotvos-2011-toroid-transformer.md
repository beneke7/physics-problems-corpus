...
language: en
translated: true
links_hu: eotvos-2011-toroid-transformer
topic: [electromagnetism]
subtopic: [electromagnetic-induction, coupled-inductors, mutual-inductance, transformer, ac-circuits]
format: open-ended
math_tools: [algebra]
core_ideas: []
has_figure: true
figure_files: [eotvos-2011-toroid-transformer-fig1.png]
provenance_note: "English translation of Eötvös Competition 2011, Problem 3; translated from the Hungarian source statement (cache/phoxiv/eotvos/2011_S.pdf, statement-only extraction). Figure 4 harvested from the source PDF."
