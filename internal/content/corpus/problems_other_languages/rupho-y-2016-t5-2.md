...
has_solution: false
has_figure: true
figure_files: [rupho-y-2016-t5-2-fig01.png]
provenance_note: "phoXiv Mathpix Markdown: cache/phoxiv/rupho-y/2016/T5_2.mmd; figures require local harvest"
...
![](../../figures/rupho-y/figures/rupho-y-2016-t5-2-fig01.png)

а В предельном случае при $N \rightarrow \infty$, чему равно минимальное значение отношения $M / m$ при котором вышеописанное чудо возможно?
