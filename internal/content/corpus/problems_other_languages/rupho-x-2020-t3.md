...
![](rupho-x-2020-t3-fig03.png) отклоняются от горизонтального положения), безразличными (ни то, ни другое)? Считайте, что $\left|\alpha_{c}\right|=\alpha$, и что силы $Y$ и у линейно зависят от $\alpha$. Ответ обоснуйте с помощью формул, схем или рисунков.
