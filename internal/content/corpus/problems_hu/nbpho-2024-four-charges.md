...
language: hu
translated: true
links_en: nbpho-2024-four-charges
...
**i)** *(2 pont)* Hosszú idő elteltével mekkora a részecskék végsebességének ($v_{f}$) nagysága a rendszer tömegközéppontjához képest?

**ii)** *(5 pont)* Mekkora szög van az inicális sebesség ($\vec{v}_{0}$) és a végleges sebesség ($\vec{v}_{f}$) között?
