...
language: hu
translated: true
links_en: nbpho-2023-nitrogen-explosion
topic: [thermodynamics]
subtopic: [phase-transitions, ideal-gas-law, heat-transfer, material-properties]
math_tools: [calculus, algebra, geometry-trigonometry]
format: open-ended
points: 8
core_ideas: [kalda-thermo-idea4, kalda-thermo-idea9, kalda-thermo-idea19]
has_figure: true
figure_files: [nbpho-2023-nitrogen-explosion-fig1.jpg, nbpho-2023-nitrogen-explosion-fig2.jpg]
provenance_note: "NBPhO 2023, 2. feladat, szerző Päivo Simson. Born-digital PDF-ből kinyerve (cache/phoxiv/nbpho/2023.pdf) Mathpix OCR segítségével."
verification_status: pending
---

**2. Nitrogénexpólzió (8 pont)** — *Päivo Simson.*
...
**ii)** *(1{,}5 pont)* Mekkora a nyomás $p_{2}$ a gömb belsejében közvetlenül a robbanás előtt? A külső nyomás $p_{a}=1{,}0 \times 10^{5} \mathrm{~Pa}$.

**iii)** *(1{,}5 pont)* Mekkora a hőmérséklete $T_{2}$ a folyékony nitrogénnek közvetlenül a robbanás előtt?

**iv)** *(1{,}5 pont)* Számítsa ki az elpárolgó nitrogén tömegét a gömb belsejében a robbanás előtt.

**v)** *(2 pont)* Becsülje meg, mennyi ideig tart a gömb robbanásáig. A műanyag hőkapacitása és a hőáram a gömb felső felén keresztül elhanyagolható.
