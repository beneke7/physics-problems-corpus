...
source: "kevin-zhou"
native_id: "KZ-MRev-P025"
origin: "Kevin Zhou Physics Olympiad Handouts"
language: "hu"
translated: true
links_en: "kevin-zhou-mrev-p025"
topic: [mechanika, gravitáció]
subtopic: [Kepler-törvények, pályamechanika, kúpszeletek, perdület]
math_tools: [analízis, geometria]
format: "open-ended"
kind: "problem"
core_ideas: []
has_solution: false
...
[3] Feladat 25. In this problem, you will explore yet another slick derivation of Kepler’s first law. As
    usual, suppose the orbit lies in the xy plane. This derivation resolves around writing r(t) = r(t)r̂(θ)
    ahol r̂ = cos θ x̂ + sin θ ŷ, and solving a differential equation for v(θ).
