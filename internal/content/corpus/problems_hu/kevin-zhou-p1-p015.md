...
language: "hu"
translated: true
links_en: "kevin-zhou-p1-p015"
topic: [Matematikai módszerek]
subtopic: [sorfejtés, binomiális tétel, közelítések]
math_tools: [sorok és komplex számok, kisparaméteres közelítés]
format: "open-ended"
kind: "problem"
core_ideas: []
has_solution: false
...
[3] Feladat 16. The function cos−1 (1 − x) does not have a Taylor series about x = 0. However, it
    does have a series expansion about x = 0 in a different variable.
     ...
     (b) ⋆ What’s the next nontrivial term in the series?
       ...
       ahol the definition of the binomial coefficient is formally extended to arbitrary real n.
