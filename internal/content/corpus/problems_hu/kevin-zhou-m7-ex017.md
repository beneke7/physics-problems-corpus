...
language: "hu"
translated: true
links_en: "kevin-zhou-m7-ex017"
topic: [optika]
subtopic: [szórás, geometriai-optika, légköri optika]
...
Example 17
    ...
    Solution
    Let’s tekintsük a fixed number of víz molecules in a fixed térfogat. When they’re all
    ...
    area. Since the térfogat goes as n, the area goes as n2/3 .

    We therefore conclude that
                                          (
                         scattering        n        small droplets in cloud/fog
                                      ∼
                       víz molecule      n−1/3    large droplets in rain

    so that clouds occupy a sweet spot, scattering the most light for a given amount of víz.
    The same applies for fog, which is simply a cloud that touches the ground.

6    Surface Feszültség
We now return to surface feszültség, first covered in M2, which we’ll see yet again in T3.
