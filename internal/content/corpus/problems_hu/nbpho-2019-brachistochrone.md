...
language: hu
translated: true
links_en: nbpho-2019-brachistochrone
...
provenance_note: "NBPhO 2019 (Északi-Balti Fizika Olimpia), 5. feladat, szerző Rūdolf Treilis. Mathpix OCR born-digital PDF-ből (cache/phoxiv/nbpho/2019.pdf)."
verification_status: pending
---

**5. BRACHISZTOCHRON (10 pont)** — *Rūdolf Treilis.*
...
**ii)** *(2 pont)* Fermat elve szerint a fénysugár az egyik pontból a másikba a legrövidebb utazási idő pályáján halad. Feltételezd, hogy egy bizonyos közegben a fénysugár a fent bemutatott brachisztochron görbét követve terjedhet az $A$-ból a $B$-be! Határozd meg a közeg fénytörési indexét $n=n(x, y)$ az $x$ és $y$ koordináták függvényeként, ha $n(L, H)=1$.
...
**v)** *(2 pont)* Az ii) és iii) részekben levezetett egyenletek megoldásával kimutatható, hogy a brachisztochron görbe valójában egy cikloid szakasza. A cikloid az a görbe, amelyet egy kör szélén lévő rögzített pont nyom, miközben a kör csúszás nélkül gördül egy egyenes vonalon. Az $\frac{L}{H}=\frac{\pi}{2}$ speciális eset esetén határozd meg a minimális utazási időt $t_{\min }$ az $A$ és $B$ között!
