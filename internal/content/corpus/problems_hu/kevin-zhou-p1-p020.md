...
language: "hu"
translated: true
links_en: "kevin-zhou-p1-p020"
topic: [matematikai módszerek]
subtopic: [sorfejtések, aszimptotikus közelítések]
...
[2] Feladat 20. Find a series approximation for xy , given that y is small and x positive, but neither
  ...
  For example, let’s return to problem 18, ahol we consider an electric dipole with d/x ≪ 1.
