...
source: "kevin-zhou"
native_id: "KZ-P1-P009"
origin: "Kevin Zhou Physics Olympiad Handouts"
language: "hu"
translated: true
links_en: "kevin-zhou-p1-p009"
topic: [kvantumfizika, elektromágnesség]
subtopic: [hidrogénatom, atomfizika, ionizáció]
...
[3] Feladat 9. In this problem we’ll continue the dimensional analysis of the Schrodinger equation.
...
amplitude θ0 , three quantities which contain two dimensions (length and time). Hence we canpform
one dimensionless group, which is clearly just θ0 itself. The period of a pendulum is T = f (θ0 ) L/g.

   Példa 5: F = ma 2014 12
