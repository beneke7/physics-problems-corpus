...
language: hu
translated: false
links_en: komal-P5410
difficulty: P
verification_status: pending
---

P. 5410. A vándorsólyom szárnycsapások nélkül is képes megtenni nagyobb távolságokat. Ilyenkor a mozgása két részből áll. Az első részben kiterjesztett szárnyakkal körözve emelkedik egy fölfelé áramló meleg levegőoszlopban (termikben) $v_1$ függőleges sebességgel. A második részben a termiket elhagyva a vízszintessel $\alpha$ szöget bezárva állandó sebességgel siklik a következő, $L$ távolságra lévő termikig. A $v_2$ siklási sebesség jó közelítéssel egyenesen arányos a siklás vízszintessel bezárt $\alpha$ szögének szinuszával: $v_2=k
\sin\alpha$, ahol $k$ egy ismert állandó.
 ...
 Adatok: $v_1=2~\frac{\mathrm{m}}{\mathrm{s}}$, $k=10~\frac{\mathrm{m}}{\mathrm{s}}$, $L=2$ km.

![figure](../../figures/komal/figures/komal-P5410-fig1.gif)
