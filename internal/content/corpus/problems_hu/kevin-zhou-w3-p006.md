...
source: "kevin-zhou"
native_id: "KZ-W3-P006"
origin: "Kevin Zhou Physics Olympiad Handouts"
language: "hu"
translated: true
links_en: "kevin-zhou-w3-p006"
topic: [hullámfizika, optika]
subtopic: [hanghullámok, rezonancia, lebegések, polarizáció]
...
[2] Problem 6. Some problems about sound waves in everyday life.
    ...
    Now we’ll introduce polarization for light waves, putting the results of E7 to work.
         ...
         polarization an angle θ from the x-axis has electric field
                    ...
                    Ex (z, t) = (E0 cos θ) cos(kz − ωt),       Ey (z, t) = (E0 sin θ) cos(kz − ωt).
