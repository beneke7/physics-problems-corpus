...
language: hu
translated: true
links_en: nbpho-2023-wobble
topic: [astrophysics, gravitation, mechanics]
subtopic: [orbital-mechanics, gravitation, periodic-motion]
math_tools: [algebra, geometry-trigonometry, calculus]
format: open-ended
points: 8
core_ideas: [kalda-mechanics-idea39]
has_figure: true
figure_files: [nbpho-2023-wobble-fig1.jpg, nbpho-2023-wobble-fig2.jpg]
provenance_note: "NBPhO 2023, 3. feladat, szerző Taavet Kalda. Born-digital PDF-ből kinyerve (cache/phoxiv/nbpho/2023.pdf) Mathpix OCR segítségével."
verification_status: pending
---

**3. Rezgés (8 pont)** — *Taavet Kalda.*

Az úgynevezett astrometriai rezgés módszert vizsgáljuk az exobolygók detektálásához. A módszer azon alapul, hogy meg lehet mérni az égbolt azon pozícióban bekövetkező változást, amelyet a központi csillag szenvem végig az őt körülötte keringő bolygók gravitációs hatása miatt. Ez a módszer az utóbbi időkben vált megvalósíthatóvá a pontosabb mérőeszközök elérhetősége miatt.
...
**iii)** *(1 pont)* Mekkora a $B$ bolygó tömege $m_{B}$?
