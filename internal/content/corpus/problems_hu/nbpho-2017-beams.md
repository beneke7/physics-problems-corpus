...
id: nbpho-2017-beams
source: nbpho
native_id: "2017 P8 Beams"
year: 2017
language: hu
translated: true
links_en: nbpho-2017-beams
topic: [mechanics]
subtopic: [thermal-expansion, elastic-deformation, materials-science, load-bearing]
math_tools: [algebra, geometry-trigonometry]
format: open-ended
points: 6
core_ideas: []
has_figure: true
figure_files: [nbpho-2017-beams-fig1.jpg, nbpho-2017-beams-fig2.jpg]
provenance_note: "NBPhO 2017 (Északi-Balti Fizika Olimpia), 8. feladat, Andres Põldaru szerzője. Born-digital PDF-ből kinyerve Mathpix OCR-rel (cache/phoxiv/nbpho/2017.pdf)."
verification_status: pending
---

**8. GERENDÁK (6 pont)** — *Andres Põldaru.*
...
**ii)** *(4 pont)* Az összes gerenda kezdetben $T_0 = 0°\mathrm{C}$ hőmérsékleten van. Az maximális terhelés 20%-ának megfelelő súlyt helyezünk el a felső lemezen. Tartva ezt a súlyt, milyen hőmérsékletre lehet fűteni a középső gerendát úgy, hogy ne keletkezzenek maradandó deformációk? Ezúttal az anyag elastikus modulusza a hőmérsékletnek függvényében változik, ahogy az az alábbi ábrán látható (egy nagyobb ábra külön lapon áll rendelkezésre).
