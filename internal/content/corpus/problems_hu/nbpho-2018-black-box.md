...
**9. FEKETE DOBOZ (11 pont)** — *Jaan Kalda, Mihkel Heidelberg.*
...
**ii)** *(1 pont)* Határozd meg az akkumulátor elektromotoros erejét.

**iii)** *(1 pont)* Határozd meg a tekercs belső ellenállásához.

**iv)** *(3 pont)* Becsüld meg a kondenzátor kapacitásának értékét, $C$-t.

**v)** *(3 pont)* Becsüld meg az induktivitás értékét, $L$-t.
