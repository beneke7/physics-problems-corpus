...
source: "kevin-zhou"
native_id: "KZ-X2-P020"
origin: "Kevin Zhou Physics Olympiad Handouts"
language: "hu"
translated: true
links_en: "kevin-zhou-x2-p020"
topic: [kvantumfizika]
subtopic: [atomspektrumok, spektrumvonalak kiszélesedése, fotoeffektus]
math_tools: [valószínűségszámítás és statisztika, dimenzióanalízis]
format: "open-ended"
kind: "problem"
core_ideas: []
has_solution: false
...
[3] Problem 20. In this problem, we discuss how atomic physicists observe atomic energy levels.
    ...
    λ = 589 nm. (Why specifically sodium vapor?)
     ...
     (b) One contribution to spectral line width is the energy-time uncertainty principle: if an excited
         ...
         In the case of the sodium doublet, the lifetime is 16 ns. Estimate the spread in wavelengths
        ...
        (c) Another contribution to spectral line width is Doppler broadening: when a gas of atoms is
            ...
            Doppler effect. Estimate the resulting spread in wavelengths ∆λ at T = 1000 K. (You can
