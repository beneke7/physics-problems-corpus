...
id: apho-2005-e-q1
source: apho
native_id: "1. DETERMINATION OF SHAPES BY REFLECTION"
year: 2005
language: en
translated: false
...
has_solution: true
has_figure: true
figure_files: [apho-2005-e-q1-fig01.png]
provenance_note: "phoXiv Mathpix Markdown: cache/phoxiv/apho/2005_E.mmd; figures require local harvest"
verification_status: pending
solution_language: en
techniques: [graphical-reduction, exploit-symmetry]
---

## 1. DETERMINATION OF SHAPES BY REFLECTION
...
A. Draw a graph of: 'reflection angle of the laser beam against the angular position of the object' $(2 \times 1 \mathrm{pt})$
B. Determine the number of edges (sides) in each object ( $2 \times 0.25 \mathrm{pt}$ )
C. Use data from the graphic to sketch the shape of the object and find the angular positions of changing sides correspond with the top angular scale ( $2 \times 1.5 \mathrm{pts}$ )
