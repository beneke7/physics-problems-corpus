...
source: "kevin-zhou"
native_id: "KZ-M4-P016"
origin: "Kevin Zhou Physics Olympiad Handouts"
language: "en"
translated: false
links_hu: "kevin-zhou-m4-p016"
topic: [mechanics]
subtopic: [oscillations, damped-oscillations]
...
Consider a damped harmonic oscillator, which experiences force F = −bv − kx.

     (a) As in M1, show that the general solution for x(t) is

                                             x(t) = A+ eiω+ t + A− e−iω− t
