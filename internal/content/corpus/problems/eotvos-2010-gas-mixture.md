...
has_figure: true
figure_files: []
provenance_note: "Eötvös Competition 2010, Problem 2. Extracted from combined official document cache/phoxiv/eotvos/2010_S.pdf (statement-only extraction, solutions and commentary excluded). OCR note: corrected 'kiciny' to 'kicsi'. Figures referenced but not yet extracted from source PDF."
