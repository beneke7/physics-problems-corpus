...
provenance_note: "Eötvös Competition 2008, Problem P3. Mathpix OCR of the solutions PDF (cache/phoxiv/eotvos/2008_S.pdf) containing only problem statement (solution excluded). Figure extracted via pdfimages from source PDF."
verification_status: pending
links_en: eotvos-2008-charged-spheres
has_solution: true
