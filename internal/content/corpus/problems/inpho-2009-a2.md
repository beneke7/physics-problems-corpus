...
id: inpho-2009-a2
source: inpho
native_id: "2. A spatially uniform magnetic field $\vec{B}$ exists in the circular region $S$ and this field is decreasing in magnitude with time at a constant rate (see Fig. (1)). The wooden ring $C_{1}$ and the conducting"
year: 2009
language: en
translated: false
...
has_solution: false
has_figure: true
figure_files: [inpho-2009-a2-fig01.png]
