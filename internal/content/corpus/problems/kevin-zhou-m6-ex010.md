...
language: "en"
translated: false
links_hu: "kevin-zhou-m6-ex010"
topic: [mechanics]
subtopic: [rotating-reference-frames, coriolis, angular-momentum]
math_tools: [algebra]
format: "explanation"
kind: "example"
core_ideas: []
...
Kevin Zhou                                                             Physics Olympiad Handouts
  ...
  on one arm,
                                      2mω ṙ = −mω̇r
  which is equivalent, by the product rule, to the statement that ωr2 is constant. Then mr2 ω
