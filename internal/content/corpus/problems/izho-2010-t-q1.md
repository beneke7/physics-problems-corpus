...
![Rod of length $l$ hanging horizontally from a joint on a vertical support, held by a thread at its free end](../../figures/izho/figures/izho-2010-t-q1-fig1.png)
...
![Closed cylindrical vessel filled with liquid of height $H$, with a small inverted test-tube of gas volume $V_1$ at the bottom](../../figures/izho/figures/izho-2010-t-q1-fig2.png)
...
![Fig. 1: rectangular light source of sides $c$ and $b$ on the ceiling at height $L$ above the floor, with a square plate of side $a$ at height $h$ above the floor](../../figures/izho/figures/izho-2010-t-q1-fig3.png)
...
![Fig. 2: photograph of the plate shadow on the floor — a dark rectangle inside a lighter rectangle, with a cm scale grid](../../figures/izho/figures/izho-2010-t-q1-fig4.png)
