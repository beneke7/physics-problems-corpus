...
language: "en"
translated: false
links_hu: "kevin-zhou-r1-p011"
topic: [relativity]
subtopic: [relativistic-doppler-shift, moving-mirrors, photon-momentum, energy-conservation]
math_tools: [algebra]
format: "open-ended"
kind: "problem"
core_ideas: []
...
observer with speed v, if the light originally had frequency f .
     ...
     (b) Show that this is the same as if the light were sourced with frequency f by an object moving
         at speed 2v/(1 + v 2 /c2 ) towards the observer. Can you find an intuitive reason for this?
