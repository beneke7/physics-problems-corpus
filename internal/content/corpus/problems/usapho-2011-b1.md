...
subtopic: [ac-circuits, impedance, magnetostatics, induction]
difficulty: null
difficulty_norm: 5
difficulty_level: 4
math_tools: [calculus, geometry-trigonometry]
format: scaffolded
core_ideas: [kalda-circuits-idea44]
estimated_time_min: 50
points: null
has_solution: true
has_figure: false
figure_files: []
provenance_note: "phoXiv Mathpix Markdown: cache/phoxiv/usapho/2011.mmd"
...
b. A local rancher thinks he might be able to extract electrical power from the cable using electromagnetic induction. The rancher constructs a rectangular loop of length $a$ and width $b<a$, consisting of $N$ turns of wire. One edge of the loop is to be placed on the ground; the wire is straight and runs parallel to the ground at a height $h>a$. Write the current in the wire as $I=I_{0} \sin \omega t$, and assume the return wire is far away.
    ...
    iii. Assuming the loop is placed in this way, determine an expression for the emf induced in the loop (as a function of time) in terms of any or all of $I_{0}, h, a, b, N, \omega, t$, and fundamental constants.
