...
id: inpho-2022-a2
source: inpho
native_id: "2. The first explosion of an atomic bomb was the Trinity test in New Mexico in 1945. This explosion released a very large amount of energy $E$ which created an expanding fireball (known as the Trinity fireball). A snapshot of this fireball taken 0.025 s after the explosion is shown in the photograph below."
year: 2022
language: en
translated: false
topic: [mechanics]
...
has_solution: true
has_figure: true
figure_files: [inpho-2022-a2-fig01.png, inpho-2022-a2-fig02.png]
