...
id: ipho-2012-t-qt1
source: ipho
native_id: "Problem T1. Focus on sketches (13 points) Part A. Ballistics (4.5 points)"
year: 2012
language: en
translated: false
...
has_solution: true
has_figure: true
figure_files: [ipho-2012-t-qt1-fig01.png, ipho-2012-t-qt1-fig02.png]
provenance_note: "phoXiv Mathpix Markdown: cache/phoxiv/ipho/2012_T.mmd; figures require local harvest"
verification_status: pending
solution_language: en
techniques: [graphical-reduction, conservation-laws, superposition]
---
...
i. (0.8 pts) By adjusting the launching angle for a ball thrown with a fixed initial speed $v_{0}$ from the origin, targets can be hit within the region given by
