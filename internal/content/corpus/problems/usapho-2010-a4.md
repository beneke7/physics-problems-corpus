...
has_figure: false
figure_files: []
provenance_note: "phoXiv Mathpix Markdown: cache/phoxiv/usapho/2010.mmd"
...
$$
\begin{gathered}
2 \mathrm{p} \rightarrow \mathbf{X}_{1}+\mathrm{e}^{+}+\mathbf{X}_{2}(0.42 \mathrm{MeV}) \\
\mathrm{p}+\mathbf{X}_{1} \rightarrow \mathbf{X}_{3}+\gamma(5.49 \mathrm{MeV})
\end{gathered}
$$
...
$$
\mathrm{e}^{+}+\mathrm{e}^{-} \rightarrow 2 \gamma(x)
$$

Subsequently, two major processes occur simultaneously. The "pp I branch" is the single reaction

$$
2 \mathbf{X}_{3} \rightarrow{ }^{4} \mathrm{He}+2 \mathbf{X}_{4}(y),
$$
...
$$
\begin{gathered}
\mathbf{X}_{3}+{ }^{4} \mathrm{He} \rightarrow \mathbf{X}_{5}+\gamma \\
\mathbf{X}_{5}+\mathrm{e}^{-} \rightarrow \mathbf{X}_{6}+\mathbf{X}_{7}(z) \\
\mathbf{X}_{6}+\mathbf{X}_{4} \rightarrow 2^{4} \mathrm{He}
\end{gathered}
$$
