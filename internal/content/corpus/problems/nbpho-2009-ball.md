...
source: nbpho
year: 2009
native_id: "2009 P3 BALL"
language: en
translated: false
topic: [mechanics]
subtopic: [friction, rolling, rotational-motion, energy-conservation]
math_tools: [calculus, differential-equations, geometry-trigonometry]
format: open-ended
points: 8
core_ideas: []
has_figure: true
figure_files: [nbpho-2009-3-ball-fig1.jpg]
provenance_note: "NBPhO 2009 (Nordic-Baltic Physics Olympiad), Problem 3. OCR via Mathpix (cache/phoxiv/nbpho/2009.pdf). Fixed OCR artifacts: (1) Removed stray closing parenthesis after surface area expression. (2) Corrected 'inductance' to 'induction' for magnetic field terminology."
verification_status: pending
links_hu: nbpho-2009-ball
has_solution: true
...
![figure](../../sources/nbpho/figures/nbpho-2009-3-ball-fig1.jpg)
