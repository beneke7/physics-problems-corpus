...
language: "en"
translated: false
links_hu: "kevin-zhou-m6-p006"
topic: [gravitation]
subtopic: [orbits, kepler-laws, inverse-square]
...
In this problem we’ll verify some of the basic facts stated above.
     ...
     (b) Using this result, prove the vis-viva equation
      ...
      (c) Prove Kepler’s third law.
       ...
       energy. Then its distance to the Sun evolves as r(t) ∝ t2/3 , like how a ∝ T 2/3 for bound orbits.
