...
difficulty_level: 5
source: "kevin-zhou"
native_id: "KZ-M7-P013"
origin: "Kevin Zhou Physics Olympiad Handouts"
language: "en"
translated: false
links_hu: "kevin-zhou-m7-p013"
topic: [fluid-mechanics]
subtopic: [buoyancy, floating-bodies, stability]
...
A long log with square cross section and density ρl floats in water with density ρw .
    If α = ρl /ρw , then when α ≪ 1, the log will float stably with one of its sides parallel to the water.
                                                     √
      (a) As α is increased, show that once α > (3− 3)/6, this orientation becomes unstable. (Hint: to
