...
id: eupho-2024-T3
source: eupho
native_id: "EuPhO 2024 Theory Problem 3"
name: "EuPhO 2024 – Theory T3: Fabry–Pérot interferometer"
...
figure_files: [eupho-2024-T3-1.png]
has_figure: true
provenance_note: "Legacy EuPhO import; retained without re-OCR in this pass."
topic: [optics]
subtopic: [interferometer, thin-mirrors, energy-storage, transients]
...
*European Physics Olympiad 2024, Theory Problem 3. Transcribed faithfully from the born-digital source PDF (via phoxiv.org); inline math normalized from Unicode to LaTeX.*
