...
translated: false
topic: [mechanics]
subtopic: [statics, torque, equilibrium, force-balance, elasticity]
difficulty: null
difficulty_norm: 4
math_tools: [calculus]
format: scaffolded
...
has_solution: false
has_figure: true
figure_files: [usapho-2022-a1-fig01.png, usapho-2022-a1-fig02.png]
provenance_note: "phoXiv Mathpix Markdown: cache/phoxiv/usapho/2022.mmd; figures require local harvest"
...
c. Now suppose that one support remains at the left end, while the other is a distance $d>\ell / 2$ away from the left end, as shown at right above. In static equilibrium, find the bending moment $M\left(x_{0}\right)$ at a distance $x_{0}<d$ from the left end.
