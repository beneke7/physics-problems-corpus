...
id: eupho-2019-T1
source: eupho
native_id: "EuPhO 2019 Theory Problem 1"
name: "EuPhO 2019 – Theory T1: Ice pellets"
...
figure_files: [eupho-2019-T1-1.png]
has_figure: true
provenance_note: "Legacy EuPhO import; retained without re-OCR in this pass."
topic: [thermodynamics]
subtopic: [heat-transfer, phase-transitions, atmospheric-physics]
...
*European Physics Olympiad 2019, Theory Problem 1. Transcribed faithfully from the born-digital source PDF (via phoxiv.org); inline math normalized from Unicode to LaTeX.*
