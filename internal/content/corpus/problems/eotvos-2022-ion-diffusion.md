...
subtopic: [diffusion, boltzmann-distribution, thermodynamic-equilibrium, electrostatics, ionization]
format: open-ended
math_tools: [calculus, algebra, exponential-functions]
core_ideas: []
has_figure: false
figure_files: []
provenance_note: "Eötvös Competition 2022, Problem 2. Hungarian problem statement from Mathpix OCR of cache/phoxiv/eotvos/2022.pdf."
verification_status: pending
links_en: eotvos-2022-ion-diffusion
has_solution: true
