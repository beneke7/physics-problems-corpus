...
language: "en"
translated: false
links_hu: "kevin-zhou-p1-p007"
topic: [relativity, quantum-physics]
subtopic: [natural-units, mass-energy, particle-physics]
...
[2] Problem 7. In particle physics it is conventional to work in “natural units”, where the numeric
    ...
    always restore these factors by dimensional analysis.
       According to standard references, the mass of the Higgs boson is about 125 GeV, where 1 eV is
