...
![Figure 6.2: graph of the three-term cosine approximation to a unit square wave, amplitude against time](../../sources/bpho-r1/figures/bpho-r1-2001-q6-fig2.png)

Figure 6.2

![Figure 6.1: circuit with battery V, two-position switch S between contacts A and B, capacitor C, and milliammeter](../../sources/bpho-r1/figures/bpho-r1-2001-q6-fig1.png)
