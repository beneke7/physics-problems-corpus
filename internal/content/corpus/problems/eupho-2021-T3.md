...
id: eupho-2021-T3
source: eupho
native_id: "EuPhO 2021 Theory Problem 3"
name: "EuPhO 2021 – Theory T3: Glass ball"
...
figure_files: [eupho-2021-T3-1.png, eupho-2021-T3-2.png]
has_figure: true
provenance_note: "Legacy EuPhO import; retained without re-OCR in this pass."
topic: [optics]
subtopic: [refraction, dispersion, caustics, ray-optics, measurement-from-photo]
...
*European Physics Olympiad 2021, Theory Problem 3. Transcribed faithfully from the born-digital source PDF (via phoxiv.org); inline math normalized from Unicode to LaTeX.*
