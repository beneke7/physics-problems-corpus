...
language: "en"
translated: false
links_hu: "kevin-zhou-m7-p019"
topic: [mechanics]
subtopic: [fluids, fluid-dynamics, bernoulli-principle]
math_tools: [algebra]
format: "open-ended"
kind: "problem"
core_ideas: []
...
This problem is about the subtle phenomenon of vena contracta. An incompressible
    ...
    Naively, the flow looks as shown at left below.
     ...
     (b) Argue that the net force on the fluid shown inp
         argue by momentum conservation that v2 ≈ (P1 − P2 )/ρ.
