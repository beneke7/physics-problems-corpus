...
language: "en"
translated: false
links_hu: "kevin-zhou-r3-p022"
topic: [relativity, thermodynamics]
subtopic: [gravitational-redshift, time-dilation, tolman-temperature-gradient]
...
[5] Problem 22. In this problem, we give one of the classic justifications for gravitational redshift,
    ...
    rays were transmitted from the top to the bottom of a tower.
      ...
      (f) The gamma ray had energy 14 keV. According to the energy-time uncertainty principle, what
