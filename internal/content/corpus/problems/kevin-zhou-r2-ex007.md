...
language: "en"
translated: false
links_hu: "kevin-zhou-r2-ex007"
topic: [relativity]
subtopic: [time-dilation, relativistic-dynamics, oscillations]
math_tools: [algebra]
format: "explanation"
kind: "example"
core_ideas: []
...
F⊥ = ma⊥ = mω 2 r
                                               p
  from which we immediately conclude ω = g/L. We can use the results of problem 18 to
  ...
  and the force’s relation with acceleration is different,
                              ...
                              F⊥ =        ,   F⊥ = γma⊥ = γmω 2 r.
                                      γL
  Combining these results, we find                   r
                                                 1       g
                                              ω=           .
                                                 γ       L
