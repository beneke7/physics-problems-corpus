...
translated: false
topic: [mechanics]
subtopic: [rotational-dynamics, statics, work-energy]
difficulty: P
difficulty_norm: 3
math_tools: [calculus, geometry-trigonometry]
format: scaffolded
core_ideas: [kalda-mechanics-idea2, kalda-mechanics-idea3, kalda-mechanics-idea6]
estimated_time_min: 25
points: 5
has_solution: false
has_figure: true
figure_files: [komal-P4644-fig1.gif]
