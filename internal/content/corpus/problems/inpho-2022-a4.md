...
id: inpho-2022-a4
source: inpho
native_id: "4. A student performed an experiment to determine the acceleration due to gravity $(g)$ using a simple pendulum which has a spherical bob of diameter $d$ hung with a long string. She varied the length"
year: 2022
language: en
translated: false
topic: [mechanics]
...
has_solution: true
has_figure: true
figure_files: [inpho-2022-a4-fig01.png]
