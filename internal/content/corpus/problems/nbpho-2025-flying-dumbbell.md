...
source: nbpho
native_id: "2025 P1 Flying Dumbbell"
year: 2025
language: en
translated: false
links_hu: nbpho-2025-flying-dumbbell
topic: [mechanics]
subtopic: [elasticity, oscillations-mechanical, collisions, rigid-body]
math_tools: [differential-equations, calculus, geometry-trigonometry]
format: open-ended
points: 10
core_ideas: []
has_figure: false
figure_files: []
provenance_note: "NBPhO 2025 (Nordic-Baltic Physics Olympiad), Problem 1, by Jaan Kalda. Extracted from born-digital PDF (cache/phoxiv/nbpho/2025.pdf) via Mathpix OCR (cache/phoxiv/nbpho/mmd/2025.mmd)."
...
**1. Flying Dumbbell (10 points)** — *Jaan Kalda.*
