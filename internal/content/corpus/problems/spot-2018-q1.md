...
![A chain hanging between two posts](../../sources/spot/figures/spot-2018-q1-fig1.png)
...
![Figure 1 from Biggins and Warner: (a) photograph of a chain fountain; (b) minimal model with tensions $T_T$, $T_C$, $T_F$ and heights $h_1$, $h_2$](../../sources/spot/figures/spot-2018-q1-fig2.png)
...
![Experimental data: rise height $h_2$/m versus table-to-floor height $h_1$/m, with a straight-line fit](../../sources/spot/figures/spot-2018-q1-fig3.png)
