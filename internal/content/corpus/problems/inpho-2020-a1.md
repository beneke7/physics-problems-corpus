...
id: inpho-2020-a1
source: inpho
native_id: "1. A certain gas obeys the equation of state $U(S, V, N)=a S^{7} / V^{4} N^{2}$, where $a$ is a dimensioned constant. Here $U$ represents the internal energy of the gas, $S$ the entropy, $V$ the volume and $N$ the fixed number of particles of the system."
year: 2020
language: en
translated: false
...
has_solution: true
has_figure: true
figure_files: [inpho-2020-a1-fig01.png]
