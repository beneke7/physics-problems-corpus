...
points: "1+1+1+3+2+1.5+1.5+2.5+1.5+1=16"
has_solution: false
has_figure: true
figure_files: [inpho-2008-q4-fig1.png]
provenance_note: "INPhO 2008, p. 3-4"
verification_status: pending
---

Two identical walls, each of width $w(=0.01 \mathrm{~m})$, are separated by a distance $d(=0.1 \mathrm{~m})$ as shown in Fig. (3). Temperatures of the external face of the walls are fixed ( $T_{1}$ and $T_{2}, T_{2}>T_{1}$ ). Coefficient of thermal conductivity of wall is $k_{w}=0.72 \mathrm{~W}-\mathrm{m}^{-1}-\mathrm{K}^{-1}$. We define
