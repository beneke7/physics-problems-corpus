...
subtopic: [relativistic-energy-momentum, refraction, lorentz-force, magnetic-field]
difficulty: null
difficulty_norm: 4
math_tools: []
format: scaffolded
...
The neutrinos did not all arrive at once. The first arrived with an energy of about $E_{1}=40 \mathrm{MeV}$, and the last arrived about $t=10 \mathrm{~s}$ later with an energy of about $E_{2}=20 \mathrm{MeV}$.
