...
id: inpho-2019-a6
source: inpho
native_id: "6. Consider $n$ moles of a monoatomic non-ideal (realistic) gas. Its equation of state may be described by the van der Waal's equation"
year: 2019
language: en
translated: false
topic: [thermodynamics]
subtopic: [ideal-gas, processes, adiabatic, efficiency, first-law]
difficulty: null
difficulty_norm: 5
math_tools: [calculus]
format: scaffolded
core_ideas: [kalda-thermo-idea10, kalda-thermo-idea21]
estimated_time_min: 70
points: null
has_solution: true
has_figure: true
figure_files: [inpho-2019-a6-fig01.png, inpho-2019-a6-fig02.png]
