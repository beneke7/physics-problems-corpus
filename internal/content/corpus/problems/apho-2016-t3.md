...
| A3 | For the ring described in Part (A1), what is the potential energy $U$ of this ring if the ring is placed in a uniform magnetic field $B_{z}$ pointing to the z-direction? You should assume the potential energy to be zero when $\theta=\pi / 2$.![](apho-2016-t3-fig02.png) Figure 2 | 2 points |
| :--- | :--- | :--- |
