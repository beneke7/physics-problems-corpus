...
language: en
translated: false
topic: [mechanics, electromagnetism, oscillations-and-waves]
subtopic: [momentum, work-energy, dc-circuits, geometrical-optics, lenses-mirrors]
difficulty: null
difficulty_norm: 4
difficulty_level: 4
...
has_solution: true
has_figure: true
figure_files: [izho-2011-t-q1-fig1.png, izho-2011-t-q1-fig2.png, izho-2011-t-q1-fig3.png, izho-2011-t-q1-fig4.png]
provenance_note: "IZhO 2011 Theory, p. 2"
...
![Cube of mass $M$ on a table, with a spherical cavity of radius $R$; a puck of mass $m$ at the bottom of the cavity moving with velocity $v$; gravity $\mathbf{g}$](../../figures/izho/figures/izho-2011-t-q1-fig1.png)
...
![Infinite ladder circuit: series sources $\varepsilon_1, r_1$ in the top branch, shunt sources $\varepsilon_2, r_2$, load resistor $R$ at the right end](../../figures/izho/figures/izho-2011-t-q1-fig2.png)
...
![Object AB: vertical arrow pointing up, labeled A (top) and B (bottom)](../../figures/izho/figures/izho-2011-t-q1-fig3.png)

![Image A'B': horizontal arrow pointing right, labeled B' (left) and A' (right)](../../figures/izho/figures/izho-2011-t-q1-fig4.png)
