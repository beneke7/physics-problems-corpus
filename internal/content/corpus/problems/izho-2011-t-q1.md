...
![Cube of mass $M$ on a table, with a spherical cavity of radius $R$; a puck of mass $m$ at the bottom of the cavity moving with velocity $v$; gravity $\mathbf{g}$](../../sources/izho/figures/izho-2011-t-q1-fig1.png)
...
![Infinite ladder circuit: series sources $\varepsilon_1, r_1$ in the top branch, shunt sources $\varepsilon_2, r_2$, load resistor $R$ at the right end](../../sources/izho/figures/izho-2011-t-q1-fig2.png)
...
![Object AB: vertical arrow pointing up, labeled A (top) and B (bottom)](../../sources/izho/figures/izho-2011-t-q1-fig3.png)

![Image A'B': horizontal arrow pointing right, labeled B' (left) and A' (right)](../../sources/izho/figures/izho-2011-t-q1-fig4.png)
