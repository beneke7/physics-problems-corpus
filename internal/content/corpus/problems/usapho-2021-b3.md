...
translated: false
topic: [mechanics]
subtopic: [equilibrium, stability, force-balance, circular-motion, energy-conservation]
difficulty: null
difficulty_norm: 5
difficulty_level: 5
...
has_solution: true
has_figure: true
figure_files: [usapho-2021-b3-fig01.png, usapho-2021-b3-fig02.png, usapho-2021-b3-fig03.png, usapho-2021-b3-fig04.png]
provenance_note: "phoXiv Mathpix Markdown: cache/phoxiv/usapho/2021.mmd; figures require local harvest"
verification_status: pending
solution_language: en
techniques: [stability-analysis, conservation-laws, choose-reference-frame]
---
...
![](../../figures/usapho/figures/usapho-2021-b3-fig01.png)
...
![](../../figures/usapho/figures/usapho-2021-b3-fig02.png)
...
![](../../figures/usapho/figures/usapho-2021-b3-fig03.png)
...
![](../../figures/usapho/figures/usapho-2021-b3-fig04.png)
(view from above)
