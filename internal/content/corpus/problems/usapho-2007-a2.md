...
id: usapho-2007-a2
source: usapho
native_id: "A2. A simple gun can be made from a uniform cylinder of length $L_{0}$ and inside radius $r_{c}$. One end of the cylinder is sealed with a moveable plunger and the other end is plugged with a cylindrical cork bullet. The bullet is held in place by friction with the walls of the cylinder. The pressure outside the cylinder is atmospheric pressure, $P_{0}$. The bullet will just start to slide out of the cylinder if the pressure inside the cylinder exceeds $P_{c r}$."
year: 2007
language: en
translated: false
topic: [thermodynamics, mechanics]
subtopic: [ideal-gas, adiabatic-processes, friction, elasticity]
difficulty: null
difficulty_norm: 3
difficulty_level: 4
math_tools: []
format: scaffolded
core_ideas: [kalda-thermo-idea8, kalda-thermo-idea9, kalda-mechanics-idea6]
...
A2. A simple gun can be made from a uniform cylinder of length $L_{0}$ and inside radius $r_{c}$. One end of the cylinder is sealed with a moveable plunger and the other end is plugged with a cylindrical cork bullet. The bullet is held in place by friction with the walls of the cylinder. The pressure outside the cylinder is atmospheric pressure, $P_{0}$. The bullet will just start to slide out of the cylinder if the pressure inside the cylinder exceeds $P_{c r}$.
