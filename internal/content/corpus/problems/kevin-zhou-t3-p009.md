...
language: "en"
translated: false
links_hu: "kevin-zhou-t3-p009"
topic: [thermodynamics]
subtopic: [phase-transitions, latent-heat, clausius-clapeyron, vapor-pressure]
math_tools: [calculus, integration]
format: "open-ended"
kind: "problem"
core_ideas: []
has_solution: true
...
[3] Problem 9. Suppose that at pressure P0 , a liquid-gas phase transition takes place at temperature
    ...
    Kevin Zhou                                                            Physics Olympiad Handouts
       ...
       one mole of nitrogen gas. Initially, both compartments have volume V0 , pressure 0.5 atm,
       and temperature 373 K. A piston is then slowly inserted, compressing the system isothermally.
       ...
       Now, water condenses at temperature 373 K at pressure p = 1 atm. Thus, as the volume
