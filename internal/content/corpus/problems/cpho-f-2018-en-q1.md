...
has_solution: false
has_figure: true
figure_files: [cpho-f-2018-en-q1-fig01.png]
...
(2) ( 15 points). The sphere begins to slip when $\theta=\theta_{2}$. Find a condition, involving $V_{M}\left(\theta_{2}\right)$ and $a_{M}\left(\theta_{2}\right)$, satisfied by $\theta_{2}$.
(3) (5 points). The sphere loses contact with the hemisphere when $\theta=\theta_{3}$. Find the speed of the centre of mass of the sphere relative to the hemisphere.
