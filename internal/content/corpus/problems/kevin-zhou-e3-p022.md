...
language: "en"
translated: false
links_hu: "kevin-zhou-e3-p022"
topic: [magnetostatics]
subtopic: [solenoids, magnetic-field-lines, magnetic-flux, superposition]
...
[3] Problem 23 (Purcell 6.63). A number of simple facts about the fields of solenoids can be found
    ...
    Kevin Zhou                                                              Physics Olympiad Handouts
      ...
      (d) Any field line that is a distance r0 from
                                                √ the axis far back
                                                               √ in the interior of the coil exits from
          the end of the coil at a radius r1 = 2r0 , assuming 2r0 is less than the solenoid radius.
