...
language: en
translated: false
links_hu: nbpho-2005-water-pump
...
provenance_note: "NBPhO 2005 (Nordic-Baltic Physics Olympiad), Problem 4. Mathpix OCR of born-digital PDF (cache/phoxiv/nbpho/2005.pdf)."
...
3) If the tank rotates too fast, the pump efficiency drops due to cavitation: the water starts "boiling" in some parts of the pump. Find the highest cavitation-free angular speed $\omega_{\text {max }}$ (3 pts).
4) If the power of the electric engine is $P$, what is the theoretical upper limit of the volume productivity of the pump $\mu_{\text {max }}$ (volume of the pumped water per unit time)?
