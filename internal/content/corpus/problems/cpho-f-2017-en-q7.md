---
id: cpho-f-2017-en-q7
source: cpho-f
native_id: "Problem 7 (35 points). (1) The equivalence principle, first elucidated by Albert Einstein in 1911, states that the laws of physics in a reference frame with gravity present are the same as those in some accelerating reference frame without gravity, provided that the acceleration is equal to a certain value. We study this principle by considering the following two examples."
year: 2017
language: en
translated: false
topic: [relativity, gravitation]
subtopic: [time-dilation, gravitation]
difficulty: null
difficulty_norm: 4
math_tools: []
format: scaffolded
...
has_solution: false
has_figure: true
figure_files: [cpho-f-2017-en-q7-fig01.png]
