...
translated: false
topic: [mechanics]
subtopic: [collisions, momentum, circular-motion]
difficulty: P
difficulty_norm: 3
math_tools: [calculus, geometry-trigonometry]
format: scaffolded
core_ideas: [kalda-mechanics-idea43, kalda-mechanics-idea53, kalda-kinematics-idea12]
estimated_time_min: 25
points: 5
has_solution: false
has_figure: true
figure_files: [komal-P4686-fig1.gif]
provenance_note: "KöMaL physics points contest, 201412"
verification_status: self-solved
techniques: [conservation-laws, exploit-symmetry, choose-reference-frame]
---
...
![figure](../../raw_html/komal_figures/komal-P4686-fig1.gif)
