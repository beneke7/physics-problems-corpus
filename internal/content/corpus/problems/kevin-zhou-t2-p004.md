...
language: "en"
translated: false
links_hu: "kevin-zhou-t2-p004"
topic: [thermodynamics]
subtopic: [thermodynamic-potentials, maxwell-relations, nonideal-gas]
...
From Problem 2, the nonideal gas has internal energy $$U(T,V)=\frac{3}{2}nRT-\frac{an^{2}}{V}.$$
     ...
     (b) This gets us close to the desired result, except that we don’t know how to evaluate ∂S/∂V |T .
         ...
         follows from taking the partial derivatives of the quantity U − T S with respect to T and V .
