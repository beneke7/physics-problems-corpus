...
language: "en"
translated: false
links_hu: "kevin-zhou-m6-ex004"
topic: [gravitation]
subtopic: [orbits, stability, kepler-laws, virial-theorem]
math_tools: [calculus, integration, small-parameter-approximation]
format: "explanation"
kind: "example"
core_ideas: []
has_solution: true
...
Kevin Zhou                                                               Physics Olympiad Handouts
  ...
  masspM ≫ m. The ring rotates around the planet with the Keplerian angular velocity
...
3    Kepler’s Laws
    ...
    Kepler’s laws for a general orbit are:
      ...
      3. When the orbit is bound, the period T and semimajor axis a obey T 2 ∝ a3 .
    ...
    set of points P so that P F1 + P F2√= 2a is a constant, where a is the semimajor axis. The
    semiminor axis b is related by a = b2 + d2 , as one can show by considering an appropriate
