...
has_figure: false
figure_files: []
provenance_note: "Kalda thermo handout, pr 63, orig EstFin-2011"
...
a) The electronic component has been dissipating energy with a constant power of $P=35 \mathrm{~W}$ for a long time, and the average plate temperature has stabilized at the value $T_{0}=49^{\circ} \mathrm{C}$.
