...
has_solution: true
has_figure: true
figure_files: [izho-2010-e-q1-fig1.png]
provenance_note: "IZhO 2010 Experiment, p. 2-3"
...
6. Glass tube with the inner diameter — $\mathbf{D = 4.6\ mm}$
7. Wooden sticks (diameter 3 mm)
8. A set of metal rods, length 4 cm, diameters $\mathbf{d = 2.5;\ 3.0;\ 3.5;\ 4.0\ mm}$
9. Disposable glass
