...
id: eupho-2023-T3
source: eupho
native_id: "EuPhO 2023 Theory Problem 3"
name: "EuPhO 2023 – Theory T3: Plate between magnets"
...
figure_files: [eupho-2023-T3-1.png]
has_figure: true
provenance_note: "Legacy EuPhO import; retained without re-OCR in this pass."
topic: [electromagnetism]
subtopic: [eddy-currents, magnetic-braking, current-streamlines]
...
*European Physics Olympiad 2023, Theory Problem 3. Transcribed faithfully from the born-digital source PDF (via phoxiv.org); inline math normalized from Unicode to LaTeX.*
