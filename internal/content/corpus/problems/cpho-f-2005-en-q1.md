...
has_solution: false
has_figure: true
figure_files: [cpho-f-2005-en-q1-fig1.png]
provenance_note: "CPhO Final 2005, p. 1"
...
(b) i. Analyze which of the two frequencies of light will pass through the plate faster in different possible cases, for the values $n_1 = 1.55$, $n_2 = 1.52$.

ii. Analyze which of the two frequencies of light will pass through the plate faster in different possible cases, for the values $n_1 = 1.40$, $n_2 = 1.38$.
