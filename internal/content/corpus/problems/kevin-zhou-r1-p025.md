...
source: "kevin-zhou"
native_id: "KZ-R1-P025"
origin: "Kevin Zhou Physics Olympiad Handouts"
language: "en"
translated: false
links_hu: "kevin-zhou-r1-p025"
topic: [relativity]
subtopic: [relativistic-motion, proper-acceleration, time-dilation]
...
[4] Problem 25. A rocket starts from rest in the lab frame at the origin, then accelerates with uniform
    proper acceleration a0 (i.e. as measured by an accelerometer on the ship).
      ...
      (a) Show that the acceleration measured in the lab frame is a0 /γ 3 . (We already proved this more
