...
**Megoldás.**
 ...
 $(4)$ $v_2t_2\sin2\alpha-\frac{g}{2}t_2^2=d\tg\alpha.$ 
 Ezekből az ismeretlen mennyiségek ($d,\alpha, v_1$ és $v_2$) kifejezhetők. 
 $a)$ (1)-ből kifejezve $v_1$-et és azt (2)-be helyettesítve 
 $(5)$ $\frac{g}{2d}=\frac{\tg\alpha}{t_1^2}$ 
 adódik. Hasonló módon a (3)-ból kifejezett $v_2$-t (4)-be írva kapjuk, hogy 
 $(6)$ $\frac{g}{2d}=\frac{\tg 2\alpha-\tg\alpha}{t_2^2}.$ 
 (5) és (6) összevetéséből 
 $\frac{t_2^2}{t_1^2}=\frac{\tg 2\alpha-\tg\alpha}{\tg\alpha}=\frac{2}{1-\tg^2\alpha}-1=\frac{1+\tg^2\alpha}{1-\tg^2\alpha},$ 
 ahonnan 
 $(7)$ $\alpha=\arctg \sqrt{\frac{t_2^2-t_1^2}{t_2^2+t_1^2}}\approx 7{,}13^\circ.$ 
