...
**Megoldás.**
 ...
 $OA=OA'=\frac{R}{\tg\varphi}=\frac{\ell}{5}\cdot \frac{\cos\varphi}{\sin\varphi}$ 
 ...
 $\mu \ge \frac{S}{N}\equiv\tg\varphi+\frac{1}{10\,\tg^2\varphi}+\frac{1}{10}.$ 
 ...
 Ezeket az eredményeket más úton (grafikus ábrázolás vagy differenciálszámítás nélkül) is megkaphatjuk. Bevezetve az $x\equiv\tg\varphi$ jelölést az egyensúly feltétele: 
...
\sqrt[3]{\frac{27}{40}}.$ 
 ...
 $\frac{x_0}{2}=\frac{1}{10\,x_0^2}, \qquad \text{vagyis}\qquad x_0=\frac{1}{\root 3 \of {5}}\qquad\text{és}\qquad \varphi_0=\arctg x_0=30{,}3^\circ.$ 
 ...
 $\tg\varphi \ge \frac{R}{\ell}=\frac15,\qquad \text{vagyis}\qquad \varphi\ge 11{,}3^\circ$ 
 feltételnek is.
