...
**Megoldás.**
 ...
 Ebből az következik, hogy $\tan{\beta_\mathrm{max}}\geq 1$, vagyis a $\beta_\mathrm{max}$ szögnek nagyobbnak vagy egyenlőnek kell lenni $45^{\circ}$-nál. Egyenlőség esetén $n=\sqrt{2}$, egyébként a henger anyagának a levegőre vonatkoztatott törésmutatójának ennél kisebbnek kell lenni:
...
![solution figure](../../figures/komal/figures/komal-G848-sol-fig1.gif)
