...
translated: false
problem: komal-P5580
figure_files: [komal-P5580-sol-fig1.gif]
...
**Megoldás.**
 ...
 $\alpha=\arctg\frac{v_B\sin 45^\circ}{v_A+v_B\cos 45^\circ}=\arctg\frac{4\sqrt{2}}{6+4\sqrt{2}}=25{,}9^\circ$ 
 szöget zár be. (Az $A$ pont pedig értelemszerűen nyugalomban van.) 

 Az ábra alapján $h=4{,}5\,\mathrm{m}\cdot\tg\alpha=2{,}18\,\mathrm{m}$, a két eldobott test közötti minimális távolság pedig a kinagyított ábrarészlet alapján $d_\mathrm{min}=(2{,}5\,\mathrm{m}-h)\cos\alpha=0{,}28\,\mathrm{m}=28\,\mathrm{cm}$.

![solution figure](../../raw_html/komal_figures/komal-P5580-sol-fig1.gif)
