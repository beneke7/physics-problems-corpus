...
**I. megoldás.**
 ...
 $t=\frac{x}{v_x}$ 
 idő múlva csapódik a talajba. A kő az eldobás pillanatában $y(0)=H$ magasságban van, és függőleges sebessége $v_y(0)=v_x\tg\alpha$, míg a becsapódáskor $y(t)=0$ és $v_y(t)=-v_x\tg\beta$ (a negatív előjel abból származik, hogy $v_y(t)<0$). Mindezek alapján két egyenletet írhatunk fel: 
$$\begin{gather*}
y(t)=H+v_y(0)t-\frac{g}{2}t^2=H+v_x\tg\alpha\,t-\frac{g}{2}t^2=H+x\tg\alpha-\frac{g}{2v_x^2}x^2=0,\\
v_y(t)=v_y(0)-gt=v_x\tg\alpha-gt=v_x\tg\alpha-\frac{g}{v_x}x=-v_x\tg\beta.
\end{gather*}$$
 A második alapján 
 $\frac{g}{v_x^2}x=\tg\alpha+\tg\beta,$ 
 és ezt az elsőbe behelyettesítve, majd rendezve: 
$$\begin{gather*}
H+x\tg\alpha-\frac{x}{2}(\tg\alpha+\tg\beta)=0,\\
x=\frac{2H}{\tg\beta-\tg\alpha}.
\end{gather*}$$

 Megjegyzések. 1. A megoldásunk alapján: 
 $v_x=\sqrt{\frac{2gH}{\tg^2\beta-\tg^2\alpha}},$ 
 és ebből a mozgáshoz szükséges kezdősebesség: 
 $v_0=\frac{v_x}{\cos\alpha}=\frac{1}{\cos\alpha}\sqrt{\frac{2gH}{\tg^2\beta-\tg^2\alpha}}=\sqrt{\frac{2gH}{\tg^2\beta\cos^2\alpha-\sin^2\alpha}}.$ 
...
**II. megoldás.**
 ...
 $\frac{g}{2}t^2=x\tg\beta-H.$ 
 A két kifejezést egyenlővé téve megkapjuk a kérdéses $x$ távolságot: 
 $x\tg\alpha+H=x\tg\beta-H\qquad\Rightarrow\qquad x=\frac{2H}{\tg\beta-\tg\alpha}.$

![solution figure](../../raw_html/komal_figures/komal-P5652-sol-fig1.gif)
