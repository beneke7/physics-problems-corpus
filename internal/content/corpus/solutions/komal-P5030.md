...
**Megoldás.**
 Amikor a középső test sebessége maximális, a gyorsulása nulla, tehát a rá ható eredő erő is nulla. Ez a feltétel a szigetelő pálca közepénél, vagyis az egész rendszer tömegközéppontjában teljesül. 
 A tömegközéppont az átfúrt gömb kezdeti helyzetétől balra, attól 
 $x=\frac{m\cdot 3d+m\cdot d-m\cdot d}{m+m+m+m}=\frac{3}{4}d$ 
 ...
 $\frac{1}{2}mv^2+\frac{1}{2}(3m)\left(\frac{v}{3}\right)^2=\frac{kQ^2}{d}\left(1+\frac13-\frac12-\frac12\right),$ 
 ahonnan az átfúrt gömb maximális sebessége (balra) 
 $v=\sqrt{\frac{kQ^2}{2md}},$ 
 a szigetelő pálca legnagyobb sebessége pedig (jobbra) 
 $3v=3\sqrt{\frac{kQ^2}{2md}}.$
