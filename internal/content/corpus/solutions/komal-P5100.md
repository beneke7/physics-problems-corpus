...
**Megoldás.**
 ...
 A két lövedék eltalálná egymást, ha $x_1=x_2$ és $y_1=y_2$ teljesülne. Formálisan $t=10~$s jó megoldásnak látszik, de az összeütközés mégsem jön létre, mert ekkor $y_1=y_2\approx -250~{\rm m}<0,$ a lövedékek tehát már a találkozásuk előtt a földbe csapódnak. Az $y_1=0$ feltételből $t=$4,9 s és $x_1=156$ m, $y_2=0$-ból pedig $t_2=$8,0 s és $x_2=416~$m adódik.
