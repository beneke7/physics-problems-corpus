...
**Megoldás.**
 ...
 vagyis 
 $(1)$ $A=\frac{a}{\cos\alpha}+g\tg\alpha.$ 
...
\frac{Mh}{\sin\alpha}\left(\frac1{\cos^2\alpha}\cdot a+ \frac{g^2\tg^2\alpha}{a} +2g\frac{\sin\alpha}{\cos^2\alpha} \right).$ 
 ...
 $\frac1{\cos^2\alpha}\cdot a+\frac{g^2\tg^2\alpha}{\sin\alpha}\cdot \frac1a\ge
2\sqrt{\frac1{\cos^2\alpha}\cdot a\cdot \frac{g^2\tg^2\alpha}{a}} =
2g\frac{\sin\alpha}{\cos^2\alpha}.$ 
 ...
 $F=2Mg\tg\alpha\approx 11{,}3\ \rm N,$ 
 a mozgás ideje 
