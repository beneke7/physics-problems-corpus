...
**Megoldás.**
 Az $e$ töltésű, $m$ tömegű elektronok $\frac{1}{2}mv_0^2=eU_0$ mozgási energiával, tehát 
 $v_0=\sqrt{\frac{2eU_0}{m}}$ 
 ...
 $t_2=\frac{s- (\ell/2)}{v_0}$ 
 idő alatt teszik meg az elektronok. 
 Az $U$ feszültségű eltérítőlemezek között az $E=U/d$ térerősség hatására az elektronok (az ábrának megfelelően) függőlegesen lefelé 
 ...
 $v_\text{le}=at_1.$ 
 Az ernyőig haladva a további függőleges irányú elmozdulásuk: $y_2=v_\text{le}t_2$. 
 A fenti összefüggésekből azt kapjuk, hogy az ernyőnek csapódó elektron összes függőleges elmozdulása 
 $y=y_1+y_2=\frac{s\ell}{2dU_0}\, U=0{,}4~\frac{\rm mm}{\rm V}\, U.$ 
