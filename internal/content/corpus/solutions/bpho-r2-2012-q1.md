...
(i) Electron energy = 100 eV = $1.6 \times 10^{-17}\,\mathrm{J}$.

Equating this to kinetic energy gives

$$
\frac{1}{2}m_{e}v^{2}=1.6 \times 10^{-17}\,\mathrm{J},
$$

so

$$
v=\sqrt{\frac{2(1.6 \times 10^{-17}\,\mathrm{J})}{9.1 \times 10^{-31}\,\mathrm{kg}}}
=5.9 \times 10^{6}\,\mathrm{m\,s^{-1}}.
$$
...
$$
v_{1/2}=\frac{v_{\max}}{\sqrt{2}}=4.2 \times 10^{6}\,\mathrm{m\,s^{-1}}.
$$
