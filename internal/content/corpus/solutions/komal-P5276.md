...
**Megoldás.**
 Ismert, hogy a légnyomás a magassággal exponenciálisan csökken, és kb. 5500 méterenként feleződik: 
 $p(x)=p_0\,2^{-\frac{x}{5500~\rm m}}.$ 
 Ezek szerint a felvonó tetejénél a nyomás és az indító állomáson mérhető nyomás aránya: 
 $\frac{p_\text{fent}}{p_\text{lent}}\approx
2^{-\frac{3000{~\rm m}-1000{~\rm m}}{5500{~\rm m}}}=0{,}78.$ 
 ...
 $\frac{V_\text{fent}}{V_\text{lent}}\approx
 \frac{1}{{0{,}78}}=1{,}28.$ 
 A térfogat a gömb átmérőjének köbével arányos, tehát 
 $\frac{d_\text{fent}}{d_\text{lent}}\approx
\sqrt[3]{ 1{,}28}\approx 1{,}08,$ 
 tehát a kitágult lufi átmérője a kiszálláskor 
 $d_\text{fent}\approx 1{,}08\cdot 25{~\rm
cm}=27{~\rm cm}$ 
 lesz.
