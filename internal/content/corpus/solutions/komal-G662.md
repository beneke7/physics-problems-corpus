...
**Megoldás.**
 Mindhárom esetben a korong középpontja ugyanolyan irányban (előrefelé) mozog, mint amerre a fonalakat húzzuk. Az $(a)$ és a $(c)$ esetben a korong $v$-nél nagyobb sebességgel, a $(b)$ esetben pedig $v$-nél kisebb sebességgel gördül előre a korong.

 Megjegyzés. Ha a korong sugara $R$, a kis hengereké pedig $r$, akkor a korong középpontjának sebessége a három esetben:
 $u_a=u_c=\frac{R}{R-r}v,\qquad u_b=\frac{R}{R+r}v.$
 ...
 $\frac{v-u_a}{u_a}=-\frac{r}{R};\qquad \frac{v-u_b}{u_b}=+\frac{r}{R};\qquad \frac{ u_c-v}{u_c}=+\frac{r}{R}.$
