...
**Megoldás.**
 a) Az $M=60\,\mathrm{kg}$ tömegű ember és az $m=40\,\mathrm{kg}$ tömegű, $\ell=6\,\mathrm{m}$ hosszúságú palló közös tömegközéppontjának a ház felett kell lennie, határesetben épp a ház pereménél. A tömegközéppont távolsága a palló közepétől:
 $s=\frac{M\frac{\ell}{2}}{M+m}=1{,}8\,\mathrm{m},$
 így a pallónak legfeljebb
 $x=\frac{d}{2}+s=4{,}8\,\mathrm{m}$
