...
**Megoldás.**
 Jelöljük a keresett frekvenciát $f$-fel! Ekkor a pingponglabda pattogásának a periódusideje $T=1/f$, és definíció szerint a dugattyú mozgásának körfrekvenciája $\omega=2\pi f$. Ahhoz, hogy a pingponglabda pont $T$ idő alatt essen vissza, (a nehézségi gyorsulást szokásosan $g$-vel jelölve) 
 $v=\frac{gT}{2}$ 
 ...
 $\frac{V}{v}=\frac{1-k}{1+k}$ 
 arányt adja, ami az első két egyenletből kapható 
 $\frac{V}{v}=\frac{2A\omega}{gT}=\frac{4\pi Af^2}{g}$ 
 hányadossal összevetve az 
 $f=\sqrt{\frac{1-k}{1+k}\cdot\frac{g}{4\pi A}}$ 
 kifejezésre vezet. Adatainkat behelyettesítve $f=1{,}72\,\mathrm{Hz}$.
