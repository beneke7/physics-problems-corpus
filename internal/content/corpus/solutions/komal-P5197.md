...
**Megoldás.**
 Az $r$ sugarú lufi és a benne lévő hélium $m$ össztömege megegyezik a kiszorított levegő tömegével, hiszen lebeg a levegőben. Tehát 
 $m=\frac{4r^3\pi}{3}\varrho_\text{levegő}.$ 
 Ha a lufit a fonálnál fogva $R$ sugarú körpályán $v$ sebességgel mozgatjuk, akkor a fonálerő sugár irányú komponense 
 $F_1=\frac{mv^2}{R}=\frac{4r^3\pi v^2}{3R}\varrho_\text{levegő},$ 
 érintő irányú komponense pedig a közegellenállási erővel megegyező 
 $F_2=\frac{c}{2}\,\left(r^2\pi\right)\,v^2 \varrho_\text{levegő}$ 
 nagyságú. ($c\approx 0{,}45$ a gömb közegellenállási alaktényezője.) 
 Mivel a fonál mindig $45^\circ$-os szöget zár be a kör érintőjével, $F_1=F_2$ teljesül, ahonnan a körpálya sugara: 
 $R=\frac{8r}{3c}\approx 1{,}2~\rm m.$ 
 Érdekes, hogy $R$ nem függ sem a lufi sebességétől, sem a közeg (a levegő) sűrűségétől. 

 Megjegyzés. A közegellenállási erő lényegében abból származik, hogy a lufi mozgatása közben a közelében lévő (nagyjából a lufi térfogatával megegyező mennyiségű) levegőt is mozgásba kell hoznunk, és a megmozgatott levegő sebessége $v$ nagyságrendű. (A ,,nagyjából'' és a ,,nagyságrendű'' kifejezések pontosítását az alaktényezőtől várhatjuk.) 
