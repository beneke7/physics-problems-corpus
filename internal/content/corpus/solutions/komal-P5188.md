...
**Megoldás.**
 A grafikonról leolvasható, hogy a hasáb gyorsulása: $a=\mu g=-2~\frac{\rm m}{\rm s^2}\approx 0{,}2\,g$, tehát a csúszási súrlódási együttható közelítőleg 0,2. (A pontosabb érték: 0,204.) A hasábra a vízszintes felület olyan erőt fejt ki, amely a függőlegessel (a hasáb haladási irányához képest ,,hátrafelé'') $\varphi=\arctg \mu=11{,}31^\circ\text{-os}$ szöget zár be. 
 ...
 $v_2-v_1=\frac{m}{M+m}v_0\cos\gamma'(\tg\gamma'-\mu).$ 
 (Látható, hogy ha $\tg\gamma'=\mu$ teljesülne, akkor nem változna meg a hasáb sebessége a kilövés következtében, ahogy ezt már korábban beláttuk.) A leeresztett csövű ágyúnál viszont $v_2-v_1=0{,}294~{\rm m/s}\approx 0{,}3~{\rm m/s}$, tehát a hasáb sebessége a kilövés hatására 6,3 m/s-ra nő. A hasáb a további mozgása során ugyanolyan ütemben lassul, mint korábban (hiszen a súrlódás miatti fékeződés üteme nem függ a mozgó test tömegétől).
