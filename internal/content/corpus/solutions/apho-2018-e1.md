...
translated: false
problem: apho-2018-e1
solution_type: official
source_document: solution-document-apho-2018-e1-s
source_pdf: cache/phoxiv/apho/2018/E1_S.pdf
figure_files: []
provenance_note: "Source-provided solution section from cache/phoxiv/apho/2018/E1_S.pdf."
---
...
n c d
  (2)
b. Connect pins 8 and 4 to a battery.
8 5
5 4
,
,
...
B.5 The name of the chosen element: a
...
circular coil.
2..Method 2:
Connect the sensor to the battery
according to the diagram, forming a
bridge. The GMR element under
consideration is a.
If at 0 I  the bridge is
balanced, then 0 U   .
Set the current I in the coil, the
...
 
   .
If at 0 I  , the bridge is unbalanced and the initial voltage is 0 U  ,
then 0
4
U U R
R E
...
can be accepted.
B.6 Table of   B  corresponding to the values I and B.
6300mV E 
1.25 pt
I (mA) B (mT) U  (mV) 0 U U     B 
0
10
20
45
...
  . %
0.25 pts
B.10 The value of the resistances r and R of the GMR element:
  0 0 0 B r R R R R    ;   0 0 0 B R R R R R   
...
C.1 Table with the values of the output signal S corresponding to the
values of the current I and the magnetic field B.
1.0 pts
I B S I B S
5
C.2 Graph 2 - Graph   S B of the output signal S as a function of the
applied magnetic field B.
1.0 pts
C.3 1. Region of saturation in the curve   S B : S
2. Region of linearity in the curve   S B : L
2
2.0 10 mV/mT m  
0.5 pts
C.4 The coercive field is
c 0 10mT B  .
0.5 pts
2. Dependence of output signal on the voltage
C.5 Table with the values of S corresponding to the values ofE . 0.25 pts
E (V) S (mV)
0 0
6
1.51 91.5
...
4.6 274
6.25 365
C.6 Graph 3 - S as a function ofE . 0.25 pts
C.7
2
E
S B    
...
7
C.8 1. The magnetic field used in this experiment.
...
value S2.
c. 0 2 1 S S S    ; 0 0 B S m   / .
3.With flux concentrator
For each value of L1, do the same, to obtain B S m   / .
0.25 pt
0.75 pt
C.9 Table to find 0 / B B for different values of 1 L . 0 0 / / B B S S   
1 17mV S  ; 0 21 2 17 4 2mV . . S     .
0.5 pt
1 L (mm) 2 S (mV) 1 1 L / (mm-1
) 2 1 S S S    0 / B B
...
C.10 Graph 4 – Graph of 0 / B B as a function of 1 1/ L .
Use the function 2
0 1
1
1
...
D.1 Diagrams of the experiment and expressions for calculating h B .
...
value S1
b. Rotate the sensor holder by about 180o
. Find the direction with
...


D.2 h 0 035mT B  . . 0.25 pts
b. Magnitude of the Earth’s magnetic field and magnetic inclination
D.3 Diagrams of the experiment and expressions for calculating Earth B
and  .
...
inclination.
From the obtained  , Earth h / cos B B   .
...
0.5 pts
2. DC wattmeter
D.5 Diagram of the wattmeter circuit together with the load and the
multimeters.
0.5 pt
D.6 Table with the values of the sensor output signal S corresponding to
