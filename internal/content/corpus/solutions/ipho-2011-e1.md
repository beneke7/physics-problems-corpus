...
translated: false
problem: ipho-2011-e1
solution_type: official
source_document: solution-document-ipho-2011-e1-s
source_pdf: cache/phoxiv/ipho/2011/E1_S.pdf
figure_files: []
provenance_note: "Source-provided solution section from cache/phoxiv/ipho/2011/E1_S.pdf."
---
...
4 163.7
5 182.1
This graph is linear of which the slope is the dropped off capacitance 19.9 C pF/section.
Given that the distance between the plates 0.20 d mm, 1.5 K ,
0
K A
C
d
...
b
K
if medium between plates is the
dielectric of which 1.5 K .
...
7
From this graph, 8
17.5 pF/ mm 1.75 10 F/ m m .
Using this value of m, 5 kHz f , 714 nF/s, and 0.01 kHz f ,
9
3
8 3 2
714 10
...
Using the f vs. x graph and the data in the table around 5 kHz f , it is found that when f is
changed by 1 kHz ( 1 kHz f ,) x is roughly changed by 1.5 mm ( 1.5 mm x .) Hence,
when f is changed by 0.01 kHz f (the smallest detectable of the change,) the distance
moved is 0.015 mm x .
y = 17.455x - 504.54
0.0
50.0
