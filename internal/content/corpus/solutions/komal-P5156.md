...
**Megoldás.**
 Jelöljük a vékony lemez egységnyi felületű darabjának tömegét (felületi tömegsűrűségét) $\eta$-val, a peremkörének sugarát pedig $R$-rel. Ez utóbbi kifejezhető $r$-rel és $h$-val:
 $R^2+(r-h)^2=r^2,\qquad \text{vagyis}\qquad R=\sqrt{h(2r-h)}.$
 ...
 $m_1gx_1=m_2gx_2,$
 azaz
 $2\pi r h \cdot \frac{h}{2}\cdot \eta g= r\pi \sqrt{h(2r-h)}\cdot \frac{r-h}{3}\cdot \eta g.$
 Ebből a $\lambda=h/r$ dimenziótlan arányszámra (algebrai átalakítások után) a
 $10\lambda^3-4\lambda^2+5\lambda-2\equiv (5\lambda-2)(2\lambda^2+1)=0$
