...
**Megoldás.**
 $a)$ Kezdetben a víz magassága
 $h=\frac{V}{A}=\frac{5~\rm dm^3}{10~\rm dm^2}=0{,}5~{\rm dm}=5\cdot 10^{-2}~\rm m.$
 A hidrosztatikai nyomás ekkor
 $p_0=\varrho g h=489~{\rm Pa}\approx 0{,}5~\rm kPa.$
 A melegítés során az edény térfogatának relatív változása:
 $\frac{\Delta V}{V}=5\cdot 10^{-5}\cdot 60=0{,}003.$
 ...
 $\Delta p=0{,}002\, p_0\approx 1~\rm Pa$
 értékkel csökken .
 $b)$ A víz térfogata a melegítés során
 $4\cdot 10^{-4}\cdot 60=0{,}024$
 arányban megnő. Ugyanakkor az edény alapterülete is megnő 0,002 arányban, a magasság relatív változása tehát
 $\frac{\Delta h}{h}\approx \frac{\Delta V}{V}-\frac{\Delta A}{A}=0{,}024-0{,}002=0{,}022.$
