...
**Megoldás.**
 ...
 ${\cal E}_0=\frac{1}{2}\cdot kQ^2\left(-\frac{1}{d}-\frac{1}{d}-\frac{1}{d}-\frac{1}{d}+\frac{1}{\sqrt{2}d}+
\frac{1}{\sqrt{2}d}\right)=\frac{kQ^2}{d}\left(\frac{1}{\sqrt{2}}-2\right).$
 Hasonló módon számíthatjuk ki a különböző módon eltávolított töltések elektrosztatikus energiáját is:
 ${\cal E}_a={\cal E}_b=-\frac{kQ^2}{d}\qquad\textrm{és}\qquad{\cal E}_c=0.$
 ...
 $W_a={\cal E}_a-{\cal E}_0=\frac{kQ^2}{d}\left(1-\frac{1}{\sqrt{2}}\right),$
 $W_b={\cal E}_b-{\cal E}_0=\frac{kQ^2}{d}\left(1-\frac{1}{\sqrt{2}}\right),$
 $W_c={\cal E}_c-{\cal E}_0=\frac{kQ^2}{d}\left(2-\frac{1}{\sqrt{2}}\right).$

![solution figure](../../figures/komal/figures/komal-P5632-sol-fig1.png)
