...
translated: false
problem: komal-P5456
figure_files: [komal-P5456-sol-fig1.gif]
...
.
 ...
 $mgR \sin \alpha=F(R+x),
$
 ahol $\alpha$ a lejtő hajlásszöge, továbbá $(R + x)$ az $F$ erő hatásvonalának a lejtőtől mért távolsága. Láthatjuk, hogy minél nagyobb $x$, annál kisebb az $F$ erő.
 ...
 $\textrm{tg}\,\beta =0{,}8 \quad \to \quad \beta=38{,}7^\circ.
$
 Csúcsszögek segítségével kaphatjuk meg $x$-et:
 $x=R \sin\beta.
$
 Tehát a keresett legkisebb erő:
 $mgR \sin \alpha =F(R+R \sin \beta) \quad \to \quad F=\frac{mg \sin\alpha }{1+\sin\beta }=\frac{mg}{5(1+\sin \beta )} \approx 360\, \textrm{N},
$
 ahol kihasználtuk, hogy $\sin \alpha=1/5$.
...
![solution figure](../../figures/komal/figures/komal-P5456-sol-fig1.gif)
