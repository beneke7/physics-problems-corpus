...
translated: false
problem: ipho-2014-t2
solution_type: official
source_document: solution-document-ipho-2014-t2-s
source_pdf: cache/phoxiv/ipho/2014/T2_S.pdf
figure_files: []
provenance_note: "Source-provided solution section from cache/phoxiv/ipho/2014/T2_S.pdf."
---
...
that
𝑎𝑝0
𝑅𝑇 2 ≪ 1, then (B1.3)takes the form
𝑉𝐺 ≈
𝑅𝑇
𝑝0
1 −
...
the flat surface.
C2.Let 𝑃𝑒be vapor pressure at a temperature 𝑇𝑒, and 𝑃𝑒 − ∆𝑃𝑒be vapor pressure at a temperature 𝑇𝑒 − ∆𝑇𝑒.
In accordance with equation (3) from problem statement, whentheambient temperature falls by an amount of
∆𝑇𝑒the saturated vapor pressure changes by an amount
∆𝑃 𝑒 = 𝑃 𝑒
𝑎
𝑏𝑅𝑇𝑒
2 ∆𝑇𝑒 (C2.1).
