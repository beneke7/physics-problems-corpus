...
**Megoldás.**
 A korong és a rézgyűrű tehetetlenségi nyomatéka
 $\Theta=\left(\frac{1}{2}m_1+m_2\right)R^2=0{,}006~\rm kg\,m^2.$
 Ha a fonalat $K$ erő feszíti, akkor a mozgásegyenletek:
 $Mg-K=Ma,\qquad Kr=\Theta\beta,\qquad a=r\beta.$
 Innen a korong szöggyorsulása:
 $\beta=\frac{Mgr}{\Theta+Mr^2}=158~\frac{1}{\rm s^2},$
 a szögsebessége pedig $t=3~$s múlva
 $\omega=\beta t=475~\frac{1}{\rm s }.$
 A $Q$ töltésű rézgyűrű $T=2\pi/\omega$ idő alatt fordul körbe, vagyis a kerület mentén mozgő töltés
 $I=\frac{Q \omega}{2\pi}=\frac{Q \beta t}{2\pi}=0{,}604~\rm mA$
 áramot képvisel. Ekkora áram a körvezető középpontjában
 $B=\frac{\mu_0I}{2R}=1{,}9\cdot10^{-9} ~\rm T$
