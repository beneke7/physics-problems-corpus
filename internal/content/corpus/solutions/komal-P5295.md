...
translated: false
problem: komal-P5295
figure_files: [komal-P5295-sol-fig1.gif, komal-P5295-sol-fig2.gif]
provenance_note: "KöMaL official solution (Hungarian)"
---

**Megoldás.**
 Az $F\cdot v=P$ összefüggésből indulunk ki, ahol a $F$ a kisautó vonóerejét, $v$ a sebességet jelenti. Ez az egyenlőség a mozgás során minden pillanatban fennáll, így pl. ha $v$ időbeli változását ismerjük, ennek segítségével $F$ változása azonnal megállapítható. Az $m$ tömegű kisautó $a$ gyorsulása:
 $a=\frac{F-mg\sin\alpha}{m}= \frac{P}{mv}- g\sin\alpha .
$
 ...
 $v_\text{max}=\frac{P}{mg\sin\alpha}$
 ...
 Az erő-sebesség grafikon ( 2. ábra ) a $F\cdot v=P$ összefüggésnek megfelelően hiperbola alakú, amely a $v=v_\text{max}$-nak megfelelő $O$ pontnál véget ér. Az erő a minimális értékét itt éri el (a megbeszélt értelemben ,,végtelen'' idő múlva):
 $F_{\text{min}}=mg\sin\alpha.$
...
![solution figure](../../figures/komal/figures/komal-P5295-sol-fig1.gif)

![solution figure](../../figures/komal/figures/komal-P5295-sol-fig2.gif)
