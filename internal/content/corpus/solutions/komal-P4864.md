...
**Megoldás.**
 Ha $v_0$ kezdősebességgel, a vízszinteshez képest $\alpha$ szögben hajítunk el egy testet, akkor a függőleges irányú kezdősebessége $v_0\sin\alpha$, a mozgásának ideje 
 $t=\frac{2v_0}{g}\sin\alpha.$ 
 Ennyi idő alatt a test vízszintes irányban 
 $d=tv_0 \cos\alpha=\frac{v_0^2}{g}\sin(2\alpha)$ 
