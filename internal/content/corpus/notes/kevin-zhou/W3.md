...
**[3] Problem 4.** $\phantom{0}^{01m}$ USAPhO 1998, problem B1. (The official solution has a qualitatively incorrect answer for the final part of the problem; see Stefan Ivanov's errata for the correct answer.)

**[3] Problem 5.** $\phantom{0}^{01W}$ USAPhO 2016, problem A1.
...
**[4] Problem 13.** $\phantom{0}^{01T}$ IZhO 2021, problem 3. A problem on the propagation of light through a waveguide, unifying material from E7 and W1.
...
**[4] Problem 17.** $\phantom{0}^{01T}$ IPhO 1995, problem 2. Refraction in the presence of a linearly varying wave speed. (This is a classic setup with a neat solution, also featured in IPhO 1974, problem 2.)

**[3] Problem 18.** INPhO 2019, problem 1. Another exercise on refraction, with an uglier solution.

**[3] Problem 19.** $\phantom{0}^{01^}$ USAPhO 2025, problem B2. A problem on shock wave wavefronts.

**[3] Problem 20.** $\phantom{0}^{01h}$ IPhO 2003, problem 3B. An exercise on refraction and radiation pressure.

**[4] Problem 21.** $\phantom{0}^{01T}$ IPhO 1993, problem 2. Another exercise on the same theme.
...
**[3] Problem 30.** $\phantom{0}^{01^}$ USAPhO 2024, problem A3. A series of optics exercises relevant for real cameras.

**[3] Problem 31.** $\phantom{0}^{01^}$ USAPhO 2026, problem A1. This question is straightforward, but assumes you know the definition $P = 1/f$ of optical power (expressed in "diopters", which just means $\mathrm{m}^{-1}$).
