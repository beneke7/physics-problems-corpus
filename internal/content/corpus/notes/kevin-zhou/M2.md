...
The same principle applies to uniform rotation, where a centrifugal force appears in the rotating frame, acting like an effective gravitational acceleration $\omega^2 r_{\perp}$, where $r_{\perp,\mathrm{cm}}$ is the part of $r$ perpendicular to the axis of rotation.
