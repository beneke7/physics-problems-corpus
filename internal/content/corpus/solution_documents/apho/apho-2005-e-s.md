---
id: solution-document-apho-2005-e-s
source: apho
...
mapped_problems: [apho-2005-e-q1, apho-2005-e-q2]
verification_status: pending
provenance_note: "Source-provided solution document; preserved from cache/phoxiv/apho/2005_E_S.pdf."
---

Digitally signed by APhO.
                                                                                   ORG



             EXPERIMENTAL COMPETITION                                       APhO   DN: CN = APhO.ORG, C =
                                                                                   ID, O = Asian Physics
                                                                                   Olympiad, OU = ICT
...
Barcode: B00110
                                    ...
                                    Reflected Ray     Cal. Reflected Ray
             Object Position (αº)        (βº)                (βº)
                             -10                211                  -149
                              -5                223                  -137
                               0                230                  -130
                              10                251                  -109
...
Barcode : B01110
             ...
             Object Position   Reflected Ray     Cal Reflected Ray
                  (αº)              (βº)                (βº)
                          10               278                  -82
                          20               296                  -64
                          30               313                  -47
...
There are weird data for r2, r4 and r5. It is impossible to have r with either negative or very large value
...
B1.   Determination of the power factor n: Dependence of the magnetic braking force
      ...
      braking force only depends on the velocity of the magnet, so we can simplify:
                                     FMB = − k0 d p v n = − k1v n
      where k1 = k0 d p is constant in this experiment.
...
To calculate the power factor n:
                                             ...
                                             ⎛ k ⎞
                               ln sin θ = ln ⎜ 1 ⎟ + n ln ( v )
                                             ⎝ mg ⎠


The experimental data:

           H              t         Sin θ          v              ln ( v )   ln ( sin θ )
         (mm)            (s)                      mm/s
                   22.98±0.00
        23±0.5           5          0.054         10.88           2.39         -2.92
...
Note:
        ...
        •   Typical error for h measurement is shown in the first row:
            h = ( 23 ± 5 ) mm . Similar error applies for the rest of h data.
...
y = ln ( sin θ ) and x = ln v .

From the data in Fig. 5. we have: ∆x = 2.1 and ∆y = 2.0 , and the typical errors:
δ x = 0.075 and δ y = 0.075 .
So the error estimate for n:

                      2       2              2           2
        ∆n     ⎛δ x⎞ ⎛δ y⎞      ⎛ 0.075 ⎞ ⎛ 0.075 ⎞
           = ⎜ ⎟ +⎜         ⎟ = ⎜       ⎟ +⎜      ⎟ = 0.05
         n     ⎝ ∆x ⎠ ⎝ ∆y ⎠    ⎝ 2.1 ⎠ ⎝ 2.0 ⎠
        ∆n = 0.05 n = 0.048
...
B2.   Determination of the power factor p: Dependence of the magnetic braking
      ...
      that θ = arcsin s ( h / l ) = 6.8° . Distance travelled remains: s = 250 mm, and the
      ...
      use the previously obtained value: n = 0.96 ± 0.05 .
...
where y = −n ln v and x = ln d .

For the data shown in Fig. 6 we obtain: ∆x = 0.94 dan ∆y = 2.01 , with typical error:
δ x = 0.105 and δ y = 0.095
So the error estimate for p:

                     2         2             2           2
        ∆p   ⎛δ x⎞ ⎛δ y ⎞    ⎛ 0.105 ⎞ ⎛ 0.095 ⎞
           = ⎜ ⎟ +⎜      ⎟ = ⎜       ⎟ +⎜      ⎟ = 0.12
         p   ⎝ ∆x ⎠ ⎝ ∆y ⎠   ⎝ 0.94 ⎠ ⎝ 2.01 ⎠
                                   15/17
        EXPERIMENTAL COMPETITION
...
Magnetic Braking on an inclined plane
 ...
 (A.1) 1.0    Adjusting the orientation of the inclined plane track
 1.0

 (A.2) 1.0    Explanation using appropriate diagram of field and force lines
 1.0
 ...
 4.0   0.5   Obtain data >= 5 sets + corresponding calculations ,
             0.1 each data set.
        0.25 Units
        0.5 Graph
        0.25 Linear regression or graphic analysis
