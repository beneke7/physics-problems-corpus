...
frequency. We note that VS could vary due changing load impedance. The data is shown below:SOLUTION
2
...
Table 2. Results of L determination from RLC resonanceSOLUTION
3
...
Table 3. RLC measurements for C = 470 F and 1000 FSOLUTION
4
...
“intercept” however they are less accurate.SOLUTION
5
...
Table 5. Mutual inductance determinationSOLUTION
6
...
(2) Copper:
(a) (b)
Table 7. Skin depth experiment for Cu: (a) Raw data, (b) Power factor n and  analysisSOLUTION
9
Figure 7. Skin depth analysis for Cu
(3) SS304:
(a) (b)
Table 8. Skin depth experiment for SS304: (a) Raw data, (b) Power factor n and  analysis.
Figure 8. Skin depth analysis for SS304: Skin depth vs. frequency to determine power factor n and .SOLUTION
10
(4) SS410:
(a) (b)
...
penetrate the metal and the fringing field around the metal becomes dominant thus the “skin depth”SOLUTION
11
...
material because it is non-contact.SOLUTION
12
...
surface area of the metal i.e. 2 A WL  , where W and L is the width and the length of the “pan”, t0 isSOLUTION
13
...
marks t = 0 s and record the NTC resistance as a function of time as the “pan” cools.SOLUTION
14
...
Figure 12. Specific heat measurement for SS410 panSOLUTION
15
...
monitor the heating behavior.SOLUTION
16
...
Table 12. Properties of the Al panSOLUTION
17
...
Mass m V=2.16x10-3
kg
Ambient temperature T0 303.66 K (RNTC0 = 7.864 k)SOLUTION
18
...
yield higher load resistance.SOLUTION
19
Appendix:
