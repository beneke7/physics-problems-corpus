---
id: solution-document-apho-2014-t3-s
source: apho
...
mapped_problems: [apho-2014-t3]
verification_status: pending
provenance_note: "Source-provided solution document; preserved from cache/phoxiv/apho/2014/T3_S.pdf."
---
...
– 0.5 points each
Notes:
• y and r̃E need not be identified, but may be useful in a later part.• rE should be perpendicular to the projected light path, but in our astro-
...
Page 3(e) (1 point) Using the formula for light deflection, write down an expression for the
...
10 16
a
Page 4which suggests that a or qE or both should be small.
...
Page 5(h) (2 points) Suppose we have an event where a lensing object of 6.0⇥1030 kg (3.0 solar
