...
(f) (2 points) Consider the case where we have a lensing object of the order of a few
    ...
    sheet. Points will be deducted for wrong answers.)
        • a is large and tan a, sin a, cos a        • qE is large and tan qE , sin qE ,
          must be calculated exactly.                  cos qE must be calculated exactly.
       • a is small and the small angle ap-         • qE is small and the small angle
         proximations to tan a, sin a, cos a          approximations to tan qE , sin qE ,
         are permissable.                             cos qE are permissable.
       • a is irrelevant and need not be cal-       • qE is irrelevant and need not be cal-
         culated                                      culated
...
(g) (3 points) Using the conditions in part (f), rewrite your expression in part (e) in terms
    ...
    a few ⇥ DL ). Show your working.
      ...
      So that (1 point)                           ✓                    ◆
                               ...
                               rS = rE a = rE2
                                   2      2            DL (DS DL )
      To write this in terms of qE , DL and DS , we use rE = qE DL to get (1 point)
                                               ✓          ◆
                                          1 2      DS DL
                                      rS = qE
                                          2       DS DL
...
(h) (2 points) Suppose we have an event where a lensing object of 6.0⇥1030 kg (3.0 solar
    ...
    lens and observer line up?
      ...
      Thus the angular Einstein radius is
                     p
               qE = 4.9 ⇥ 10 15 = 7.0 ⇥ 10 8 radians = 0.014 arcseconds
