...
or
                        𝑣0                          𝑣0                𝑣0
     ∆𝑃s = −𝜌0 𝑐 (1 +      ) (𝑣1 − 𝑣0 ) = −𝜌0 𝑐 (1 + ) ∆𝑣 ⇒ 𝛼 = − (1 + ) (a4)
                        𝑐                           𝑐                 𝑐
If 𝑣0 /𝑐 ≪ 1, we have
                  ∆𝑃s = −𝜌0 𝑐∆𝑣                                                    (a5)
...
Furthermore, from continuity equation and 𝐶c (𝑟 = 𝑅) = 1.0, we have
                  𝜋𝑅2 𝑣0 = 𝜋(𝐶c 𝑅)2 𝑣c = 𝜋𝑅2 𝑣c ⇒ 𝑣0 = 𝑣c = √2𝑔ℎ                    (d2)
Therefore
                    𝑃0 = 𝑃a = 𝑃ℎ − 𝜌0 𝑔ℎ                                    (d3)
                                                                   𝜏 𝐿
(C.2) (1.2 pt) Pressure 𝑃(𝑡) and flow velocity 𝑣(𝑡) just before 𝑡 = = and 𝑡 = 𝜏
                                                                      2    𝑐
Ans:
...
the fluid pressure is 𝑃(𝜏/2) = 𝑃1 = 𝑃0 + Δ𝑃s = 𝑃0 + 𝜌0 𝑐𝑣0 .
     At the reservoir end of the pipe, fluid pressure reduces to the constant
hydrostatic pressure 𝑃ℎ = 𝑃0 + 𝜌0 𝑔ℎ. Equivalently, we may say that the reservoir
...
and we have
 ∆𝑃1′ = −∆𝑃1r = 𝑃ℎ − 𝑃1 = (𝑃0 + 𝜌0 𝑔ℎ) − (𝑃0 + 𝜌0 𝑐𝑣0 ) = −𝜌0 𝑐(𝑣0 − 𝑔ℎ/𝑐) (e2)
...
pressure 𝑃(𝜏) = 𝑃0 + 𝜌0 𝑔ℎ = 𝑃ℎ as given in Eq. (e4) , and all fluid particles in the
...
Ans:
     Enforcing the approximation 𝑃ℎ = 𝑃0 + 𝜌0 𝑔ℎ ≈ 𝑃0 is equivalent to putting
...
(D.2) (2.0 pt) Estimating Δ𝑃𝑛 and 𝜌0 𝑐𝑣𝑛 by graphical method
Ans:
     To solve Eqs. (f7) and (f8) using graphical method, we rewrite them as follows:
                   ∆𝑃𝑛 = −(𝜌0 𝑐𝑣𝑛 − 𝜌0 𝑐𝑣𝑛−1 ) − ∆𝑃𝑛−1       (𝑛 = 1,2,3,4)        (g1)
                                         𝑘𝑗
                               ∆𝑃𝑛 =           (𝜌 𝑐𝑣 )2                                      (𝑛 = 1,2,3,4)                 (g2)
                                        2𝜌0 𝑐 2 0 𝑛
In a plot of ∆𝑃 vs. 𝜌0 𝑐𝑣, Eq. (g1) and Eq. (g2) correspond to a line passing through
the point (𝜌0 𝑐𝑣𝑛−1 , −∆𝑃𝑛−1 ) with slope −1 and a parabola passing through the
...
P/MPa
         ...
         -0.5
          ...
          -1
                                    𝜌0 𝑐𝑣3 , −∆𝑃3                      𝜌0 𝑐𝑣2 , −∆𝑃2
         -1.5                                 n=3, r/R=0.2                n=2, r/R=0.3            n=1, r/R=0.4
 ...
 𝑛              𝑟𝑛 /𝑅          𝐶𝑛            𝑘𝑛        𝑣𝑛 /(m/s)           𝜌0 𝑐𝑣𝑛 /MPa        ∆𝑃𝑛 /(MPa)         ∆𝑃𝑛 /(𝜌0 c𝑣0 )
...
valve, we have Δ𝑃sudden = 𝜌c𝑣0 = 6.0 MPa.
 ...
 4       0.00                                   0.0              0.0              0.643               11 %
            ...
            Pn /MPa                    Excess pressures at valve
            1.5
