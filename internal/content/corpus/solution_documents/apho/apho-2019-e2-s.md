...
default
 ...
 Frames                      Distance (graticule          Distance (m)               Speed (m/s)
                             squares)
 8                           6.5                          0.83                       0.26
 7                           6.0                          0.76                       0.27
 9                           6.8                          0.85                       0.24
...
Here 𝑥G is the x coordinate of the position where the pulse front is at y=0. This is treated as the new origin,
and the offset in the 𝑥 = 0 position is 𝑥G = 4.5 gr sq.

                               𝑥 − 𝑥G A
  𝑥 (gr sq)     𝑦 (gr sq)                      Δ[ 𝑥 − 𝑥G A ]
                               gr sq A
         5.0           0.2          0.25                    0.02
         6.0           0.3          2.25                    0.15
         7.0           0.6           6.3                     0.4
...
The best estimate of the height of the lump is found to be 5mm. The expected speed of fluid of depth 9mm,
                                    X     W                     W        Z
compared to fluid of depth 4mm is       = times larger, which is ×0.26       = 0.39 𝑚/𝑠.
                                    Y     A                     A        [
