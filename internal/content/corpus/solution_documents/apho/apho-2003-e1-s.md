---
id: solution-document-apho-2003-e1-s
source: apho
...
provenance_note: "Source-provided solution document; preserved from cache/phoxiv/apho/2003/E1_S.pdf."
---
                ...
                dR     dR ⎜               2
                       ...
                       = 2 ε0          ⎝
                          1   2
                                     ...
                                     ⎝
                                           1
condition for Pmax :                R =                              (0.3 point)
                                          ωC
                          ε0
                        1 2
                                                   ε0 R
...
c. ( 1 point)        R +⎜
                      ...
                      RP                ε 2 0 ε 2 0 ⎝ ωC ⎠ R
                                                 V2
                                 1    1          1
Note: The linear graph will be     or 2 versus 2 . If a is the slope and b is the
                                RP   V          R
intercept with the Y axis, then
                 1      a              1 b
                     =        ⇒ C =
              ω C
                2 2
                  ...
                  R   2
                          = ⎜ ε 0 ⎟⎜ ⎟ − ⎜    ⎟
                            ⎝2    ⎠⎝ V ⎠ ⎝ ωC ⎠
                                               2
                                   ⎛R⎞
Note: The graph will be R 2 versus ⎜ ⎟ and C is determined from the Y-intercept.
                                   ⎝V ⎠
d)

                                                                                          V2
    No.            Resistor(s)             R (Ω)              V (V)                  P=           (W)
                                                                                              R
     1                   RA                 680                9.86                   0.144
     2                   RB                1500               17.36                   0.202
     3                   RC                3300               22.81                   0.159
     4               R A + RB              2180               20.49                   0.193
     5                RA // RB              468                7.28                   0.111
     6               R B + RC              4800               23.98                   0.122
     7                RB // RC             1032               13.78                   0.186
     8               R C + RA              3980               23.66                   0.141
     9                RC // RA              564                8.42                   0.126
    10            R A + RB + RC            5480               24.40                   0.109
...
slope = a = 0.004 × 106 Ω/W , Y-intercept = b = 0.0015 (ΩW)-1 :
       1       a             1 b
            =      ⇒ C =          = 1.95 × 10 −6 F = 1.95 µF
     ω C
       2 2
               b             ω a
 ...
 -1.000       0.000     1.000      2.000        3.000   4.000      5.000
          ...
          -5.00
                                              ...
                                              ⎛ 1 ⎞
                                                   ⎟ = 2.5428 × 10 Ω
                                                                  6  2
Graphical analysis:             Y-intercept = ⎜
                                              ⎝ ωC ⎠
                       1
                         = 1.595 × 103 Ω ⇒ C = 1.99 × 10 −6 F = 1.99 µF
                      ωC
