---
id: solution-document-apho-2010-e2-s
source: apho
...
mapped_problems: [apho-2010-e2]
verification_status: pending
provenance_note: "Source-provided solution document; preserved from cache/phoxiv/apho/2010/E2_S.pdf."
---
...
27 April 2010
 ...
 (1) Record the measured PC resistance (R) and θ P in the data table. Transform the
    measured R values into conductance (C) values and record them in the data table.


    θ P (degree)        R (Ω)             C (1/Ω)          J = cos 2 θ P
...
27 April 2010
 ...
 (2) Plot the PC conductance values as a function of θ P on a graph paper.
...
27 April 2010
 ...
 (2) Utilizing the conductance versus θ P graph in Exp. II-A-(2) to determine the relative
    ...
    Cmin = 0.0515 Ω −1 ⇒ θ P = 81D            ⇒     J min = cos2 81D = 0.025

    Cmax = 0.233 Ω −1           ⇒ θ P = 65D   ⇒     J min = cos2 65D = 0.18
...
27 April 2010
 ...
 Uncertainty Analysis: by using the formula of error propagation
                      P      ∆J                      S
 G = G ( S , J max ) = max ⋅       = (3.0 × 10−3 )
                      J max ∆I max                 J max
                  2                         2                                  2                             2
          ∂G                    ∂G                             3.0 × 10−3                     3.0 × 10−3 S
 ∆G =                 ( ∆S ) +
                          2
                                                ( ∆J max ) =
                                                        2
