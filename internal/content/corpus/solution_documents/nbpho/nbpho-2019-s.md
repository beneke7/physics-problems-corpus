...
NORDIC-BALTIC PHO 2019 - SOLUTIONS                  iv) (2.5 points) Since L⊙ and m are constant, eration a are related by a = αr. The equation      (the length of time where itʼs not equal to
...
i) (1 point)From the energy conservation law,                                                                          Iα = F r = −kxr.                                   Fµ
                                                    launched directly opposite to the motion of                                                                  −k x −        = M ẍ.
...
hence                   √                          ⃗v1 − ⃗v⊕ , where v⊕ =           R⊕ is Earthʼs ve-
                 ...
                 vm =            .                  locity.  For  convenience,    letʼs write x = vv⊕2 .                                                The rotational equation of motion yields
                                                                                                         with a period of                            1    2                        2
                                                                                                                                                     2 M r α = rFµ = rM gµ so α = M r Fµ . Since
                            r⊕                      Consider the total energy of an elliptical or-                                   √               the direction of the frictional force is con-
...
From energy conservation,                         ing the two equations and rearranging, Ra⊕ =                                                                                  gµT
                                               v2 R ⊕  2
                                                                                                                                                                      ωmax =        .
           mv02    GM⊕ m           mv12   2 − GM   ⊕
                                                        = 2 − x2 . From Keplerʼs III Law, iii) (2 points) The motion of the cylinder is si-                                      r
                 −       =     ,                                           (       )      nusoidal:
                                                                     √2πR⊕ 2 − x2 −3/2 .
                                                                         3
           2         r⊕      2            T2       4π 2
...
can be expressed as                                              2
             ...
             Iavg =             I(t)dt,                            L⊙ (2 − x2 )3/2
                      T    0                                         2             ,              The acceleration is
                                                                  4πR⊕     x
where I(t) the solar irradiance at time t. We                 √         √                                    a = ẍ = −
                                                                                                                          2 k
                                                                                                                              A sin(ωt).
                                                                   R⊕
...
J = mvr = mωr2 = Const. Thus,                  rotating about the point of contact with the reads
                                               ground. The moment of inertia with respect                   −kx + Fµ = M ẍ,
             ∫ 2π              ∫ 2π                                                2   1   2
...
netic field doesnʼt do any work. In the crit- iii) (4 points)Minimal deflection angle corres-                                                               ′       M (r)ρ
                                                                                                      ...
                                                                                                      sin2 θ= n(y)          dy
                                                                                                                C 2 , hence dx =          An (y) − 1
ical case, where the electron is almost reflec- ponds to the rays traversing the prisms sym-          with A = C12                                        ii) (2 points) All the subsequent integrals will
...
locity of the electron at the surface of the find the minimal deflection angle in terms of
                                                                                                                                        dy
                                                                                                      iv) (2 points) We know that       dx (y = 0) =      to the edge where the pressure will be 0. The
