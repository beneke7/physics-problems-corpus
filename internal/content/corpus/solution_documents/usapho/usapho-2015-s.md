  ...
  a. An estimate for the regime where quantum effects become important can be found by simply
     ...
     or                                             r
                                             ...
                                             Eq =   mg 2 h2 .
                                                  2
                                                          p
     One can also use dimensional analysis to find Eq ∝ 3 mg 2 h2 , though this will receive only
     partial credit.
...
2015 USA Physics Olympiad Exam                Part A                                                6
  ...
  c. It turns out that it is possible to replace the above circuit with a new circuit as follows:
    ...
    across AB will be Is R, so Rt = 9R. The statement we made above is called Norton’s theorem.
...
A away from the equilibrium position and then released from rest.
  ...
  a. Depending on the value of A, the motion can be divided into two types: motion that expe-
     ...
     The maximum possible acceleration of the top block without slipping is mb amax = µmt g. If
...
2015 USA Physics Olympiad Exam               Part A                                             8
  ...
  c. Assume still that A  Ac . What is the maximum speed of the bottom block during the first
    ...
    which gives a half period of                    p
                                             t=π     mt /k.
...
to cool. To figure out what happens, suppose water vapor obeyed the ideal gas law P V = nRT .
For a constant volume process, T ∝ P , so the path would be a straight line towards the origin of
the P T diagram. This isn’t what happens here, because we run into the coexistence curve, and
...
The nature of magnetic dipoles.
  a. A “Gilbert” dipole consists of a pair of magnetic monopoles each with a magnitude qm but
     ...
     and the magnetic field obeys
      ...
      iii. Evaluate this expression in the limit as d → 0, assuming that the product qm d = pm
  ...
  b. An “Ampère” dipole is a magnetic dipole produced by a current loop I around a circle of
     ...
     the circular loop, and the loop lies in the xy plane at z = 0.
      ...
      iii. Evaluate the expression in Part bi in the limit as r → 0, assuming that the product
           kIrγ = p0m is kept constant, keeping only the lowest non-zero term. Write your answer
           in terms of k, p0m , z, and any necessary fundamental constants.

                                                Solution
          Using our previous result,

                                       µ0 I   2πr2         µ0 I πr2   µ0 π p0m
                              B(z) =                     ≈          =
                                       4π (r2 + z 2 )3/2   2π z 3     2π k z 3
...
2015 USA Physics Olympiad Exam               Part B                                             20
      ...
      iv. Assuming that the two approaches are equivalent, pm = p0m . Determine the constant k
          in Part bii.
