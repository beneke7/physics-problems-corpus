...
moves from rest through a vertical distance h.
  ...
  b.     i. As found above, the acceleration is
                                                    ...
                                                    a=            .
                                                          1+β
         ii. In this case, the friction force is equal to the kinetic friction, f = µmg cos θ. Then
                            ma = mg sin θ − µmg cos θ        ⇒        a = g(sin θ − µ cos θ).
...
energy is
                                            P1 = F v1 .
Suppose this force is exerted by an interaction with a second particle, which moves with speed v 0 .
...
E = Ecm + Eint , where the “center of mass energy” Ecm = M vcm     2 /2 is the kinetic energy associated
...
2013 Semifinal Exam                           Part B                                               14
  ...
  a.    i. A length l of the rod has charge q = πR2 lρ; the force on it is F = qE and the power
           delivered is P = F v. Combining these,

                                       P = πR2 lρEv,      P = πR2 ρEv.
...
2013 Semifinal Exam                           Part B                                            15
  ...
  c.    i. Suppose that the solenoid has length l. The inductance is
          ...
          loop of length d intersecting the solenoid. This loop encloses N d turns of wire, so from
...
2013 Semifinal Exam                          Part B                                            16
      ...
      ii. Consider an Amperian loop just inside the surface of the solenoid. From above, the
          magnetic field through this loop is B = µ0 N I, so
                                              I
                                                          dφB
                                                 E · dl =
                                                           dt
                                                  dI             1       dI
                               2πRE = µ0 N πR2         ⇒ E = µ0 N R
                                                  dt             2        dt
