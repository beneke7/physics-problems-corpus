---
id: solution-document-aupho-2013-s
source: aupho
...
provenance_note: "Source-provided solution document; preserved from cache/phoxiv/aupho/2013_S.pdf."
---

PHYSICS: Solutions
             2013 Australian Science Olympiad Exam
...
Throughout, take the acceleration due to gravity to be 9.8 m s−2 .
     ...
     1 m s−1 . However, they do not fly as fast as 100 m, which is a typical length of an oval, in 1 s, which
     rules out d. and e.
...
Solution: c. the total force on the system is m1 g which results in an acceleration of
m1 g/(m1 + m2 ) = 6.0 m s−2 .
Question 7
A shark, with a sucker-fish attached, is swimming at constant speed looking for prey. Under these
conditions:
...
Solution: b. as the sucker-fish is attached to the shark they have the same acceleration. Since ΣF = ma
...
at rest?                                               being pushed to the right with constant velocity?
   ...
   a. 29.4 N downwards                                    a. 29.4 N downwards
   b. 49 N downwards                                      b. 49 N downwards
   c. 78.4 N downwards                                    c. 78.4 N downwards
   d. 0 N                                                 d. 0 N
   e. 19.6 N upwards                                      e. 49 N to the right
...
of a radioisotope halves, of 99m Tc is τ1/2 = 6.01 hours.
...
any radioisotope, the number of atoms, half-life and radioactivity are related by the formula
            ...
            (number of atoms) =         (half-life in seconds) × (activity in decays per second).
                                   ln 2
In this question, we examine a model of the process of 99m Tc uptake in a patient’s cancerous thyroid
...
the total blood volume of the patient be V = 5 L = 5 × 10−3 m3 , and let each thyroid gland (there are
two) have volume Vt = 9 mL. The 99m Tc emits gamma rays of energy E = 2.24 × 10−14 J .
Give your answers both as formulae and numerically where applicable.
   ...
   a) What is the concentration (in number of atoms per litre) of 99m Tc in the bloodstream after the
      injection?
      Solution: The concentration is N/V = aτ1/2 /(V ln 2) = 2.31 × 1012 atoms/L
   ...
   c) The continuity equation in fluid mechanics states that the volume flow rate of fluid flowing
      ...
      Solution: The flow rate through a circular pipe is π r2 v. The flow rate in the neck,
...
     same continuous pipe this continuity equation would net be expected to hold.
  d) What is the initial rate of energy release due to gamma radiation emitted from a thyroid gland? In
     ...
     Solution: The initial rate is −∆E/∆t = EA = 8.30 × 106 J s−1
...
Marker’s comments:
  ...
  c) Many students did not understand that the product π r2 v was required to be constant by the
...
collision. In this question, a positive velocity indicates motion to the right.
   ...
   b) Find the fraction of the kinetic energy which is lost if two gunky blobs of masses m = 0.50 kg and
      M = 3.0 kg with velocities v = 0.50 m s−1 and V = −0.10 m s−1 , collide head-on and the final
      velocity of the gunky blob with mass m is v′ = −0.25 m s−1 .
      Solution: Here momentum is conserved but energy is not because the blobs are gunky rather than
      hard. Hence,
                                       MV + mv = MV′ + mv′
      and V ′ = 0.025 m s−1 . The kinetic energy is calculated using K = mv2 /2 to be initially
...
raised, so that the board is inclined at an angle θ to the bench.
   ...
   b) The board is gradually tilted up until the cube of pineapple begins to slide inexorably toward the
      waiting mouth at bottom of ramp. Show that µ = tan θ .
       Solution:
...
                                                                              27
        ...
        This page may be torn out and used as equipment.                      15
