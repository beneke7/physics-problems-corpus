...
question – everyone is different.
    ...
    Question 11
     ...
     Data
                                 ...
                                 Thermal conductivity of mug: κ = 1.0 W m−1 K−1
                                          Room temperature: Troom = 25 ◦ C
                                         Density of water: ρ = 1000 kg m−3
                                Specific heat capacity of water: c = 4180 J kg−1 K−1
     ...
     Maria pours her tea, filling her mug completely, and immediately places the lid on her mug.
        ...
        b) Find the time it takes Maria’s tea to reach 55 ◦ C.
             Solution: Maria’s mug has a surface area of S = 2π r2 + 2π rh = 350 cm2 , which includes the area
             of both the bottom and the lid. The contents have a mass of m = ρπ r2 h = 0.50 kg.
...
c) Maria decides to reheat her tea from 55 ◦ C to 70◦ C with a small 1.1 kW heater she places into the
   ...
   Solution: The heater provides the power to heat the tea. P = Qt so t = QP . The heat required for the
...
The block is pushed against the spring with displacement x1 and then released at time t = 0.
   ...
   E      potential
            energy                                           Kinetic energy
                       ...
                       spring                cliff                            block                  stop
                       unstretched                                            lands        time
...
c) A section of the rough ground a distance d from the cliff is made smooth (frictionless) and a
   second spring, with constant k2 = 2k1 is placed on it, as shown below.
     ...
     (ii) Find an expression for the largest possible maximum compression of the second spring that
          ...
          Solution: The time it takes the block to fall is related to the height of the cliff by h = 12 gt 2
                                 p
          which implies that t = 2h/g.
                                       Page 13 of 20
                  2014 Physics Australian Science Olympiads Examination
                 c Australian Science Innovations 2014 ABN 81731558309
...
When arranged randomly the chocolates have a packing fraction of 0.64.
   ...
   a) Find the packing fraction of the chocolates when they are neatly packed in stacked layers with the
      ...
      of side length 2r. The volume of the sphere is Vsphere = 43 π r3 and the volume of the cube is
...
chocolates per second and the level in of chocolates in the top of the funnel is steady.
  ...
  c)    (i) How many bags of 30 can be filled per minute
       ...
       (ii) How fast do the chocolates shoot out of the funnel
            into a bag?
            Solution: Only one chocolate can come out of the                                     2r
            funnel at once and each chocolate must travel 2r to
            leave the funnel. This means that in one second the        Figure 2: Funnel for filling
            chocolates travel a distance 10r. Hence, the speed is      bags.
            10r per second.
...
broad-line region is σBLR .
   ...
   b)     (i) Find an expression for the radius RBLR of the broad-line region.
              ...
              takes light to travel across the region is RBLR = τ c/2.
...
Marker’s comments:
  ...
  c) Many students understood that RBLR ∝ τ c, and correctly estimated MBH . A common mistake was
