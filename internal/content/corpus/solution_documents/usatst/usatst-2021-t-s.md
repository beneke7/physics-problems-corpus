...
Copyright ©2021 American Association of Physics Teachers2021 USAPhO+ 2
Question 1
The Jet Stream
...
ρairvrelAcs
.
Copyright ©2021 American Association of Physics Teachers2021 USAPhO+ 3
...
landing?
Copyright ©2021 American Association of Physics Teachers2021 USAPhO+ 4
Solution
...
below has an independent uncertainty of ∆t = 5min. From the data and the map, determine
...
Copyright ©2021 American Association of Physics Teachers2021 USAPhO+ 5
Solution
...
w
+ t0.
We can read tNS off the second table, and calculate D from the figure. The unknown
...
w
.
Therefore, plotting the time difference versus Dcosθ, where θ can also be measured from
the graph, gives
2vw
v2
rel − v2
...
lowest fit lines.
Copyright ©2021 American Association of Physics Teachers2021 USAPhO+ 6
Noethersville
Einsteinopolis
Curieton
Newton City
...
E W
200 km
Copyright ©2021 American Association of Physics Teachers2021 USAPhO+ 7
Question 2
The Dark Forest
...
πr3
ρ.
Copyright ©2021 American Association of Physics Teachers2021 USAPhO+ 8
Solving for ρ, we find
ρ =
3π
GT2
.
(c) The energy density of the axion field is m2a2
0/(2~3c). Find the axion field amplitude a0.
Solution
...
mistake was to write v = fλ, but this is only true for waves which travel at a constant
...
Copyright ©2021 American Association of Physics Teachers2021 USAPhO+ 9
Solution
...
Copyright ©2021 American Association of Physics Teachers2021 USAPhO+ 10
Solution
Using Ampere’s law,
B =
µ0NI
...
Copyright ©2021 American Association of Physics Teachers2021 USAPhO+ 11
...
Bmax = 5.0 T, g = 1.0 × 10−16
GeV−1
and your previous results, compute the numerical value of Φ0.
Solution
First, we have to restore the dimensions of g. Notice that since current gȧB has the
same units as displacement current 0Ė, the quantities ga and (E/B)0 must have the
...
denote the value given above as g0, the true value of g is 0g0.
...
Rin µ00g0
a0ω
Copyright ©2021 American Association of Physics Teachers2021 USAPhO+ 12
...
R
.
(b) Find the average value of the current squared hI2i in the circuit due to thermal noise.
Solution
The energy stored in the inductor is LI2/2. By the equipartition theorem, the average
energy stored in any such quadratic degree of freedom is kBT/2, so
hI2
i =
kBT
L
...
(c) At any moment in time, the noise current is oscillating sinusoidally with typical amplitude
In =
p
hI2i, which is much larger than Is. However, the phase of the noise current also
...
Copyright ©2021 American Association of Physics Teachers2021 USAPhO+ 13
...
Solution
Uncertainty goes down by
√
n when averaging n independent trials. Here we have
n = te/tc, so
¯ In = In
r
tc
...
Solution
By setting Is = ¯ In and solving for te, we find
te ∼
kBTR
ω2Φ2
0
...
average axion signal also starts going down as 1/
√
n.
Copyright ©2021 American Association of Physics Teachers2021 USAPhO+ 14
Question 3
Great Hall
...
magnetic field B = Bẑ as shown. An electric field E = Ex̂ is applied in the plane of the plate
...
Solution
The current density is given by nV qev.
...
qeEx̂ − qevxBŷ + qevyBx̂ − γvxx̂ − γvyŷ = 0.
...
eB2
.
Copyright ©2021 American Association of Physics Teachers2021 USAPhO+ 15
...
thus
qeE/Lx̂ + qeVH/Lŷ − qevxBŷ − γvxx̂ = 0.
Copyright ©2021 American Association of Physics Teachers2021 USAPhO+ 16
...
Solution
The current is I = qenV aAw, where v is the speed of each electron. Then the angular
momentum is
mevRẑ =
ImeR
qenV Aw
...
Lcan = L + CqeΦ, for some constant C, is conserved. Find C.
Solution
...
dt
.
Copyright ©2021 American Association of Physics Teachers2021 USAPhO+ 17
The electric field results in a force qeE on each electron, and thus we find that
2πR
me
qe
dv
...
2π
∆Φ.
Then, for L + CqeΦ to be conserved,
C =
1
2π
.
...
Solution
We require |qe|∆Φ
2π = ~ such that we get the same set of allowed mechanical angular
momenta. Then,
∆Φ =
h
|qe|
.
Copyright ©2021 American Association of Physics Teachers2021 USAPhO+ 18
...
Copyright ©2021 American Association of Physics Teachers2021 USAPhO+ 19
Solution
We set
|qe|ν =
h
