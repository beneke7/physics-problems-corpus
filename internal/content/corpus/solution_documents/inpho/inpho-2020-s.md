...
INPhO 2020 Page 3            Questions & Summary Answers
          ...
          Leg BC is isentropic/adiabatic ⇒ Q = 0 or S = constant. From first law,
           ...
           Also, S = 7C
                 ...
                 HB
2. An insulating uniformly charged cylindrical shell
   ...
   uniform magnetic field Bex ẑ, and is initially at rest.
...
INPhO 2020 Page 5          Questions & Summary Answers
    ...
    (c) Now consider a two electron system with arbitrary atomic number Z. Use the Bohr model
                                                                                             (3.8)
   ...
   Take the speed of sound in the medium to be 330 m/s.
    (a) Determine the time period T of the source.
              ...
              HB
               ...
               first peak is at t = 16 s and the second peak is at t = 40 s. Hence the time period of the
               source T =24 s.

    (b) The figure below shows the circular trajectory of the source S. Qualitatively mark the                     [6]
...
INPhO 2020 Page 12          Questions & Summary Answers                   Last four digits of Roll No.:
    ...
    (d) Calculate the distance (D) between the detectors.                                                 [9]
         ...
         HB           A0i              Di
          ...
          By symmetry, Ao and A0o are equidistant from the detector 1. Similarly, Ai and A0i are
          equidistant from the detector 2. It takes 9 s from Ai to A0i (Ao and A0o ). Hence


                                                           3π
                                        2∠αo = 2∠αi =                                         (4.16)
                                                            4
                                             Di = R cos αi ≈ 115 m                            (4.17)
                                                    R
                                             Do =        ≈ 784 m                              (4.18)
                                                  cos αo
...
INPhO 2020 Page 13          Questions & Summary Answers
          ...
          frequencies of detectors 1 and 2 is 4 seconds.
                                     ...
                                     ⇒θ= −              +                                      (4.21)
                                       ...
                                       = 1.4 rad                                               (4.22)
                                                   q
          The distance between the detectors =        OD2in + OD2out − 2ODin .ODout . cos(1.4) ≈ 773
          m
...
INPhO 2020 Page 15         Questions & Summary Answers
     ...
     We now calculate the acceleration of P on the rod in the direction of the string, (aP )|| (in
                                             2
     the ground frame) and set it equal to uD .
     ...
     circle of radius 3L
                       4 - this gives a centripetal acceleration of ω × 4 directed towards the CM.
                                                                     2  3L
     ...
     where Icm is the moment of inertia of the rod and the bullet system about its center of mass.
                     2  mL2   mL2     5mL2
     Now, Icm = mL 12 + 8 + 8 = 24 , thereby yielding
                                                           6vo
                                                     ω=
                                                           5L
