...
ﬁnal solutions may exist. A correct method will be suitably awarded.H B C S E
...
where ω = 4πN
T
Final answers written in the form of W are also accepted.H B C S E
...
value of the moment of inertia is 4.00 × 105gm-cm2.H B C S E
...
ηmax ≈ 0.4 (2.26)Page 7 INPhO 2025 Questions
...
to scale with 1 cm along the V -axis representing 4litre, and 1 cm along the T-axis representing
80K.
It is given that the pressure at the point X is minimum for the whole cycle, with the temperature
and volume at this point being TX = 224K and VX = 24litre.
X≡ (24L,224K)
...
are given one extra answer box in the answersheet, in case of any mistake in the ﬁrst.Page 8 INPhO 2025 Questions Last four digits of Roll No.:
...
dV
(3.4)
At points of extreme pressure (maxima or minima), we have dP
dV = 0. Equation (3.4) then
simpliﬁes to:
T = n
dT
dV
...
here by O1 and O2.Page 9 INPhO 2025 Questions
V o l u m e , V
T e m p e r a t u r e , T
X
Pmax
O1
25◦Page 10 INPhO 2025 Questions Last four digits of Roll No.:
Volume, V
T e m p e r a t u r e , T
X
Pmax
O2
25◦Page 11 INPhO 2025 Questions
...
O2 1.3 cm 5.4 cm 5.2 L 432.0 K 6.8 (accetable range is 6.3 to 7.5)Page 12 INPhO 2025 Questions Last four digits of Roll No.:
...
the magnetometer inside the MBB. She has a cubical test magnet of side length w = 10mm (see
Fig. (1)) and unknown dipole strength ⃗ P.
...
vector ⃗ P either parallel or anti-parallel to the y-axis or x-axis. The diﬀerent orientations (I to IV)
...
varies as follows:Page 13 INPhO 2025 Questions
ry
ry
rx rx
ry
...
more, yielding a positive value (see ﬁg.(c)).Page 14 INPhO 2025 Questions Last four digits of Roll No.:
...
2,000
rx (cm)
B x (µT) Horizontal Scan (ry ﬁxed)
A
B
...
Let us consider another example with Orientation I, as shown in the ﬁgure below.Page 15 INPhO 2025 Questions
...
horizontal scan. This happens at rx = −2cm. At this position, the magnet’s centre is
...
cubic magnets (of side length w = 10mm). In set M1, two magnets, each of dipole moment
P′, are joined in an attractive conﬁguration. In set M2, the magnets are joined in a repulsive
conﬁguration using a strong adhesive. Thus, each magnetic set has a length of 2w (as shownPage 16 INPhO 2025 Questions Last four digits of Roll No.:
in Fig. (5)).
w
w
M1
...
point P, which is at a distance r from the center of the magnet, can be expressed as:Page 17 INPhO 2025 Questions
B =
µ0
4π

...
ii. [10 marks] One set of Vanya’s data is presented in the table below.Page 18 INPhO 2025 Questions Last four digits of Roll No.:
...
= 1.21A · m2
.
The acceptable range of P′ is: 1.00 − 2.00A · m2Page 19 INPhO 2025 QuestionsPage 20 INPhO 2025 Questions Last four digits of Roll No.:Page 21 INPhO 2025 Questions
5. Metalens
...
Solution:Page 22 INPhO 2025 Questions Last four digits of Roll No.:
A
B
A’
B’
...
= ∆rsinθ1 +
Φ(r + ∆r)
k0Page 23 INPhO 2025 Questions
Simplifying:
Φ(r + ∆r) − Φ(r)
∆r
=
...
dϕ
dr
For paraxial rays, we can use small angle approximation, sinθ1 = r/u and then aboveH B C S E
