---
id: solution-document-eotvos-2006-s
source: eotvos
...
provenance_note: "Source-provided solution document; preserved from cache/phoxiv/eotvos/2006_S.pdf."
---
...
versenyz®t kiállító gimnázium a Debre eni Egyetem Kossuth Lajos Gyakorló Gimnáziuma volt. Két versenyz® érkezett
külföldr®l, a révkomáromi Selye János magyar tannyelv¶ gimnáziumból, ®k Gy®rött írták meg dolgozatukat.
...
(Bea szerint is így logikus.)
     ...
     Megoldás. A h®vezetésre felírható legegyszer¶bb összefüggés (ebben a különböz® könyvek és táblázatok egyetér-
tenek) a következ®:
                                                   ∆Q         ∆T
                                                     Φ= = −λA    .
                                                    ∆t        ∆x
                                         ...
                                         vízre (18
                                                     ◦
                                                         C-on)   λv = 587 · 10−3      ,
                                                                                  mKs
                                                                                    J
                                          jégre (0               λj = 2200 · 10−3       .
                                                     ◦
                                                         C-on)
                                                                                  mKs
A jobb összehasonlíthatóság kedvéért emeltük ki mindegyik adatból a 10
                                                                               −3
                                                                                    tényez®t.
     Igaz, hogy a h®vezetési együtthatók függnek a h®mérséklett®l, de nem változnak olyan er®sen, hogy elfedjék azt
a tényt, mely szerint a gázok h®vezet® képessége sokkal-sokkal kisebb, mint a folyadékoké, illetve a szilárd anyagoké.
A gázoknál     sak a vákuum lehet jobb h®szigetel®. (A dupla ablak, vagy a réteges öltözködés el®nye éppen a leveg®
rossz h®vezetésén alapul.)
     Szemléletesen tehát azt mondhatjuk, hogy a feladatbeli henger fels® felében h®szigetel®, alsó felében h®vezet®
...
h®mérsékleteken a jég a stabil fázis.
     A jég viszont még jobb h®vezet®, mint a víz, tehát a feladatban kérdezett végállapot a következ®: alul jég, felette
leveg® és egy kevés vízg®z keveréke, víz pedig egyáltalán nem lesz a hengerben! A jég és a gáz határán a h®mérséklet
    ◦
...
A lendületmegmaradásból következ®leg
                                                      ...
                                                      vx =          =           .
                                                              mx      m0 + ̺A x
                 ∆x
Itt vx helyére      -t helyettesítve, majd ∆t-t kifejezve
                 ∆t
                                                                 m0 + ̺A x
                                                          ∆t =             · ∆x,
                                                                   m0 v0
...
tehát
                                          1       1                        1
                                            Θω02 = Θω 2 − 2mgl(1 − cos α) + LI 2 .
                                          2       2                        2
    Most kezdjünk a diszkusszióhoz! Vizsgáljuk meg el®ször azt az esetet, amikor a meglökéssel adott v0 sebesség ki si,
és emiatt a kilendülési α szög is olyan ki si, hogy megengedhet® a sin α ≈ α és cos α ≈ 1 közelítés. Ekkor a forgómozgás
dinamikai egyenlete:
                                                   Θβ = 2mglα − BIl2 ,
...
szám? Mi van akkor, ha           < 2 ? Elég gyenge mágneses tér, ki siny B esetén ez bizonyára el®fordulhat! Visszatérve
                           mL        l
a dinamikai egyenlethez, azt látjuk, hogy ilyenkor β a 0 < α < 180 intervallumon mindig pozitív marad, akármilyen
                                                                     ◦
...
Írjuk be ide is az áram szögfüggését:
                                             ...
                                             1                          1 B 2 l4
                                        0=     Θω02 + 2mgl(1 − cos α) −          sin2 α.
                                             2                          2 L
                       2             2
Felhasználva, hogy sin α = 1 − cos α, jól látszik, hogy cos α-ra kaptunk egy másodfokú egyenletet, ami lényegében
                  2
ilyen alakú: a cos α + b cos α + c = 0, és aminek megoldása:
...
(A gyökjel el®tt azért választottuk a pozitív el®jelet, mert az felel meg nagyobb cos α-nak, tehát kisebb α szögnek.
A teker s nyilván ott áll meg, ahol el®ször teljesül a megállás ω = 0 feltétele.) A megoldásból látszik, hogy minél
nagyobb a meglökés v0 sebessége, annál kisebb lesz cos αmax értéke, vagyis annál nagyobb αmax szögnél áll meg a
