---
id: solution-document-eotvos-2005-s
source: eotvos
...
provenance_note: "Source-provided solution document; preserved from cache/phoxiv/eotvos/2005_S.pdf."
---
...
jelzett állapotba. Lesz-e ott sebessége? Ezt érdemes kiszámítanunk. Írjuk fel a munkatételt a 2.(a) helyzett®l a 2.(b)-ig
                                                                     √
jelzett folyamatra! A széls® testek h utat süllyednek, a középs® h    3 utat emelkedik, ezért
                                                     √          1
...
miatt) megegyezik a P pontban lev® középs® test sebességének AP irányú vetületével, vagyis
                                                   ...
                                                   ∆v
                                                      = sin ∆α ≈ ∆α.
                                                    v
Másrészt a P QA derékszög¶ háromszögb®l
                                                   v∆t
                                                       = tg ∆α ≈ ∆α.
                                                    h
...
hogyan változik. Mivel P Q ≈ vt (ahol t a 2.(b) ábrán látható állapottól mért id®), Pitagorasz tétele szerint
                                ...
                                AP = h2 + v 2 t2 = h      1+         2
                                                                  ...
                                                                  h          2h         2
                                                         2
Ebb®l leolvashatjuk, hogy az AP szakasz hossza a = v         /h gyorsulással növekszik, s a fonal nyújthatatlansága miatt a
...
   Ha az erny® S távolságra van az optikai rá stól (7. ábra ), akkor az els® f®maximum távolsága a           entrumtól
                                                   ...
                                                   s1 ≈ S · sin α1 = S     ,
                                                                         D
és általában, a k -adik f®maximum távolsága
                                                             λ
                                                         sk ≈ kS
                                                               .
                                                            D
...
valamelyik, hozzá legközelebb es® lyukon. Ez az egyenes még egy sorozat lyukon fog áthaladni, amelyek mind                   d
távolságra követik egymást. Most keressünk egy másik lyuksort, amelyen átmen® egyenes párhuzamos az el®z®vel. Sok
                                              √
                                                3
ilyen lyuksort találunk, ezek egymástól D = d     távolságra helyezkednek el (8. ábra ). Figyeljük meg azt az irányt a
                                               2
térben, amely az elképzelt egyenesekre mer®leges, de a már kijelölt entrum felé vezet® iránnyal akkora α1 szöget zár
be, hogy teljesül a
                                                        D sin α1 = λ
összefüggés.
   ...
   Ha az ilyen irányba haladó elemi hullámok ered®jét vizsgáljuk a messze lév® erny®n, akkor azt látjuk, hogy a
kiválasztott egyenesen elhelyezked® lyukakból jöv® elemi hullámok er®sítik egymást, mert az erny®h®z érve már szinte
nin s is útkülönbség köztük. De a szomszédos egyenesen fekv® lyuksorból induló elemi hullámokkal is er®síteni fogják
egymást, mert köztük az útkülönbség (D sin α1 ) éppen λ-val egyenl®, és ugyanez igaz a többi egyenesen fekv® lyukakból
induló hullámokra is. Tehát ebben az irányban az összes lyukon átjöv® fény er®síteni fogja egymást!
   Így az erny®n a    entrumhoz legközelebbi (egyik) er®sítési helynek a       entrumtól való távolsága:
...
vül is): az egyik pontrá s 90 -os elforgatottja a másiknak. (Most akár 30 -os elforgatottat is mondhatnánk, de egy
                                               ◦
téglalaprá s esetén nagyon jól látszik, hogy 90 -os elforgatásról van szó.)
   Mindezt a 10. ábra szemlélteti, melynek alsó részén a lyukak rá sa, felül pedig az erny®n látható elhajlási kép
látható, természetesen eltér® méretarányban.
   ...
   A feladatban szerepl® háromszögrá sot úgy is el®állíthatjuk, hogy három, egyenként D állandójú, közönséges optikai
                                                                                                 ◦
                                    sak annyi, hogy mindegyik rá s rései a másik rá s réseivel 60 -os szöget zárjanak
rá sot egymásra fektetünk. A feltétel
...
primer és szekunder körére felírhatjuk:
                                              ...
                                              U
                                               ...
                                               0 = jωM Ie1 + jωL2 Ie2 + RIe2 ,

ahol Ie1 a primer-, Ie2 a szekunder körben folyó áram komplex alakja, M pedig a két teker s köl sönös induk iós
együtthatója. A második egyenletb®l Ie2 -t kifejezve és az els® egyenletbe helyettesítve, valamint felhasználva a szoros
                          2
 satolás esetén érvényes M = L1 L2 összefüggést, rendezés után kapjuk:
                                                 ...
                                                 U                I1 = Z
                                                         jωL2 + R
                                          L1
A helyettesít® kap solásban jωL1 és R        váltóáramú ellenállások párhuzamos ered®jét kell kiszámítanunk:
                                          L2
                                                 jωL1 · R L 1
                                                                       jωL1 R
                                          f′ =
