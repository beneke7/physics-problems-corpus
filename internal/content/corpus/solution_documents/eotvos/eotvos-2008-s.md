---
id: solution-document-eotvos-2008-s
source: eotvos
...
Gyula 5 éve vesz részt. 1987-ig Vermes Miklós, 1988-tól Radnai Gyula az elnöke a Versenybizottságnak.
   A 2008. október 17-én délután 3 és este 8 óra között tartott versenyen Budapesten 40, a 14 vidéki városban összesen
...
érvényes. Ebb®l a lengés periódusideje:
   ...
   2. feladat. Ugyanabból az anyagból készült, állandó fajh®j¶ három test h®mérséklete          13 ◦ C, 27 ◦ C és 90 ◦ C.
A két melegebb test tömege egyenként fele a 13          C-os test tömegének. Megfelel® h®gépek és energiatároló eszközök
                                                    ◦

közbeiktatásával, küls® energia befektetése nélkül szeretnénk a 13     C-os testet minél jobban leh¶teni.
                                                                     ◦
...
mazállapotváltozás nem történik, h®tágulásuk elhanyagolható.)
  b) Mennyire h¶lhet le az eredetileg 13 ◦ C-os test?
                                                                                                         (Radnai Gyula )
...
A hidegebb test által felvett h® nagysága:
                                                   ...
                                                   c m · (330 − 300) = c m · 30.
Így az összesen nyert munka: c m · 3, ezt használhatjuk fel majd a h¶t®gép meghajtására.
    Most már foglalkozhatunk a h¶t®géppel, aminek az alsó h®tartálya lesz a c fajh®j¶, 2m tömeg¶, T3 = 13            C = 286 K
                                                                                                                 ◦
...
h®mérséklet szorzata.
                                                                                   ⋆
    Jelöljük T -vel az a kiszámítandó h®mérsékletet, amire a hideg test leh¶l, és T -gal azt a h®mérsékletet, amire a
két másik test felmelegszik. Ekkor tehát
                                                        T · T ⋆ = 286 · 330,
és az energiaegyenlet:
                                          c · 2m(T ⋆ − 330) − c · 2m(286 − T ) = c m · 3.
                                                                 ⋆
A fenti két egyenlet már meghatározza a keresett T és T              értékeket:

                                        T = 278 K = 5 ◦ C,           T ⋆ = 339,5 K = 66,5 ◦ C.
Vagyis a kezdetben 13         C-os test végül is 5 ◦ C-osra h¶thet® le. Ezt kellett kiszámítanunk.
                          ◦
...
a Versenybizottság. Most viszont szándékosan más megoldást közlünk, olyat, amilyet az idei verseny gy®ztesei adtak
erre a feladatra.
...
nagyobb lesz, mint a telep feszültsége, hiszen most már ez a gömb is er®térbe, a jobb oldali gömb er®terébe került!
    A helyzet annyira meglep®, hogy eredményhirdetéskor (te hnikai okokból egy 3000 V-os feszültségforrást hasz-
nálva) kísérletileg is bemutattuk. Amikor a bal oldali gömböt feltöltöttük 3000 V-ra, a jobb oldali gömbre kap solt
elektrosztatikus voltmér® 800 V-ot mutatott. Amikor pedig a jobb oldali gömböt is feltöltöttük 3000 V-ra, a bal oldali
gömb feszültsége 3800 V-ra n®tt!
    Mindenképpen több töltés került tehát a bal oldali gömbre, mint a jobb oldalira, ezért a közéjük középre lógatott
és feltöltött alufólia   síkra a bal oldali gömb nagyobb taszítóer®t gyakorol, mint a másik gömb. A fólia sík tehát jobbra
fog kilendülni!
    Az egyik gy®ztes versenyz® (Almási Gábor) még azt is megjegyezte, hogy ha túl közel van egymáshoz a két gömb,
akkor a közéjük lógatott fémfólián már töltetlen állapotban is a két gömb poten iálja közötti, tehát a telepfeszültségnél
nagyobb poten iál alakulhat ki. Ezért, amikor hozzáérünk a telepb®l jöv® vezetékkel, lehet, hogy leveszünk róla töltést,
így áll be a fólia a telep feszültségére. Ebben az esetben azonban negatív töltése lesz, s a bal oldali gömb jobban fogja
vonzani, mint a jobb oldali, vagyis ilyenkor a fólia balra lendül ki.
    Hogyan lehetne elkerülni a kudar ot? Több mód is van rá. A legbiztosabb eljárás az, hogy egyszerre töltjük fel a
két gömböt, de az is elég, ha kell® távolságra, viszonylag messze helyezzük ®ket egymástól. Igaz, ebben az esetben nem
olyan látványos az a kísérlet, hogy közöttük középen nem hat er® a belógatott fóliára.
...
nya; és Lovas Lia Izabella, a pé si Le®vey Klára Gimnázium 12. évf. tanulója, Simon Péter tanítványa.
    III. díj: Farkas Márton, a Fazekas Mihály F®városi Gyakorló Gimnázium 12. évf. tanulója, Horváth Gábor
tanítványa.
...
Gábor tanítványa.
   ...
   2008. november 21-én zajlott le az ünnepélyes eredményhirdetés. El®ször a Versenybizottság elnöke ismertette
...
(USA) anyagi támogatását, amely nélkül nem lehetett volna megrendezni ezt az ünnepélyes eredményhirdetést és
meleg kézszorításon kívül nem lehetett volna mással honorálni a versenyz®k és tanáraik szép teljesítményét.
