...
1. ábra).
(
    Az ábrán C és C     jelöli az érintési pontokat. A szö ske az A pontból ugrik el, v1 kezd®sebességgel, a vízszintessel
                      ∗

α szöget bezáró irányban. A fatörzs tengelyével azonos magasságban lév® B (és B ∗ ) pontban a szö ske sebessége v2 , a
...
Ebb®l
    ...
    Mekkora γ szögnél lesz v1 a legkisebb? (Els® sejtésünk szerint γ = 0 esetben, amikor épp át súszik a szö ske a
                                 1                                                  1
fatörzs tetején. Ekkor cos 0 +        = 1, 5. A kérdés az, hogy lehet-e cos γ +          < 1, 5.)
                              2 cos 0                                            2 cos γ
                                                                                   1
   Írjuk fel a számtani és a mértani közép közötti egyenl®tlenséget cos γ és             esetén! (Feltéve, hogy egyik sem
                                                                                2 cos γ
negatív, ami azért igaz, mert cos γ nem negatív, ami viszont 0 ≤ γ ≤ 90 -ból következik.)
                                                                          ◦
...
is   kisebb! Az eredeti kérdésre a helyes válasz tehát:
   ...
   Az érdekesség kedvéért kiszámíthatjuk α és β megfelel® értékeit is ebben az esetben:
                                   ...
                                   α = 67, 5 =  ◦
                                    ...
                                    √ !
                                      2
az elugrási AG távolság pedig R 1 +      ≈ 17 m. Az ábrán jelölt F pont a parabola fókuszpontja lesz.
                                     2

   2.  Egy 3 dm magas, hengeres, zárt edényben 300 K h®mérséklet¶, 105 Pa nyomású leveg® van. Kívülr®l történ®
...
ez jó közelítéssel teljesül.) Ezt felhasználva válaszolhatunk az a) kérdésre.
                                                                                                            h
   Hasonlítsunk össze két olyan (∆x vastagságú) réteget, amelyek az alap- és a fed®laptól egyenl® (x ≤        ) távolságra
                                                                                                            2
...
s¶r¶ségét vehetjük 1000 kg/m3 -nek.)
