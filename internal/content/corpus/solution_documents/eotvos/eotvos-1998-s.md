...
-gal szokás jelölni.Ha nem lenne a gravitá iós forgatónyomaték, akkor a torziós inga lengésidejét így lehetne kiszámítani: T =
2π
p
...
Radóval.2. Visszatérve a feladat megoldására, a helyes végeredménnyel azonos nagyságrend¶ eredmény adódhat a fentinél
...
= 2,5 · 10−5
radián.
Ha nem sak az er®k párhuzamosságát tételezi fel valaki, hanem még azt a kis eltérést is elhanyagolja, amivel a
...
egyforma. Az els®be 1 cm3
, a másikba 2 cm3
kölnivizet töltünk. Vajon körülbelül hányszor több id® alatt párolog el
...
∆̺
∆z
jelenti a z tengely irányú s¶r¶ség-gradienst a gáztérben: esetünkben a kölnig®z függ®leges s¶r¶ségeloszlásáról
van szó. Ez arányos az A keresztmetszeten id®egység alatt átáramló anyag tömegével, a
∆m
∆t
tömegárammal, esetünk-
...
∆̺
∆z
mindig ellentétes el®jel¶ek. A törvényben éppen azért szerepel a negatív el®jel, hogy a
...
(5. ábra)!
5. ábra. Azállandósult s¶r¶ségeloszlások a felül nyitotthosszú és rövid kém s®ben.
Látszik, hogy a
∆̺
∆z
hányados a fele hosszúságú kém s®ben kétszer akkora, tehát itt a
∆m
∆t
párolgási sebesség is
kétszerese a másikénak. Mivel a hosszú kém s®be ráadásul kétszer annyi kölnivizet is töltöttünk, ezért jó közelítéssel
négyszer annyi id® alatt párolog el 2 cm3
kölnivíz a 40 m hosszú kém s®b®l, mint 1 cm3
kölnivíz a 20 m-esb®l.
Válaszoljunk még arra a kérdésre, hogy mi történne, ha mindkét kém s® tetejét annyira leragasztanánk, hogy a
fed®lapokon supán egy-egy parányi (egyforma) nyílás maradna. Módosulna-e az el®z® válasz? Természetesen igen,hiszen új, az el®z®t®l eltér® s¶r¶ségeloszlás alakulna ki mindkét kém s®ben. Ha ugyanis sak egy nagyon pi i nyíláson
...
2
B0 nagyságú.
A d élhosszúságú, négyzet alakú keret tehát egy olyan mágneses mez®be merül, amelynek uxusa Φ =
1
2
B0d2
.
...
tanítványa;
Nagy Kálmán, a budapesti Veres Péter Gimnázium 12. osztályos tanulója, VargaMária tanítványa;Pogány Ádám, az ELTE zikus hallgatója, aki a Fazekas Mihály F®városi Gyakorló Gimnáziumban érettségizett
mint Horváth Gábor tanítványa;
