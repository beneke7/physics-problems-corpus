---
id: solution-document-eotvos-2012-s
source: eotvos
...
mapped_problems: [eotvos-2012-glass-rod, eotvos-2012-rolling-ball, eotvos-2012-toroidal-coils]
verification_status: pending
provenance_note: "Source-provided solution document; preserved from cache/phoxiv/eotvos/2012_S.pdf."
---

Beszámoló a 2012. évi Eötvös-versenyr®l
Radnai Gyula
2012. október 12-én délután 3 órai kezdettel került sor a háború utáni 64. Eötvös-versenyre. A versenyen részt
vehetett bárki, aki 2012-ben fejezte be középiskolai tanulmányait, vagy ebben az évben is középiskolai tanuló volt.
Az öt óra (300 per ) megoldási id® alatt mobiltelefon és laptop kivételével bármely magukkal hozott segédeszközt
(könyvet, füzeteket, táblázatokat, zsebszámológépet) használhattak a versenyz®k.
...
versenyz® volt egyetemista. Sajnos sem debre eni, sem szegedi egyetemi hallgató nem volt a versenyz®k között.
Középiskolai versenyz®k legtöbben ebben az évben is a F®városi Fazekas Mihály Gyakorlóiskolából jöttek. Közülük
négyen voltak 12. osztályosok, heten 11.-esek, s®t volt négy 10. osztályos versenyz®, akik közül hárman is szépen
szerepeltek.
A feladatokat az Eötvös-versenybizottság t¶zte ki, és a versenyz®k dolgozatait is ugyanez a bizottság értékelte.
Tagjai Honyek Gyula és Vigh Máté, elnöke Radnai Gyula volt. Károlyházy Frigyes, aki több mint fél évszázadon át
volt tagja a versenybizottságnak, már nem tudott részt venni a munkában, 2012. július 2-án, 83 éves korában elhunyt.
Ismertetjük a feladatokat és azok megoldását.
1. feladat. Egy sík, érdes felület¶, a vízszinteshez képest α szögben döntött korong egyenletesen, Ω szögsebességgel
forog. Egy b¶vész a forgó korong közepére egy R sugarú, tömör gumilabdát helyez, majd megfelel® irányban elgurítja.
A közönség legnagyobb ámulatára a labda középpontja ezután egyenes vonalú, egyenletes mozgást végez, amit mindaddig
...
α a korong d®lésszöge;
Ω a korong szögsebessége;
R a labda sugara.
Szükség lehet még a következ®kre:
m a labda tömege;
Θ =
2
5
mR2
a labda tehetetlenségi nyomatéka a középpontján átmen® tengelyre vonatkozólag;
S a labdára ható súrlódási er®;
N a labdára ható nyomóer®;
v0 a labda (tömeg)középpontjának kezd®sebessége;
ω0 a labda kezdeti szögsebessége.
A labda tömegközéppontja egyenes vonalú egyenletes mozgást végez, miközben a nyomóer®, a súrlódási er® és
a nehézségi er® hat rá. Ezek ered®je tehát zérus kell legyen. Ez sak úgy lehet, ha a nyomóer® nagysága N = mg cosα
és a súrlódási er® nagysága S = mgsinα. A súrlódási er®nek mer®legesnek kell lennie a sebességre, mert különben
...
A megoldás kul sa, hogy a labda forgását két, egymásra mer®leges tengely körüli forgás ered®jeként fogjuk fel.1. A korong síkjával párhuzamos, lejtés irányú tengely körül a labda egyenletesen forog:
ω1 = ω0 =
v0
R
.
...
R
, ahol r = v0t.
A szöggyorsulás, mivel ω2(t) lineáris függvénye az id®nek:
β =
ω2
t
=
...
ΩR
.
Megkaptuk a szükséges kezd®feltételeket. Érdekes, hogy sem v0, sem ω0 nem függ a labda m tömegét®l, v0 pedig még
...
plánparalel réteget kapunk (3. ábra).3. ábra
...
vezethet® vissza.
I. Az (1) teker s uxusának változása hatással van a (2) teker sre, ebben U
(I)
...
alkalmazzuk, gyelembe véve, hogy az R1 sugarú körlapot N1I1 áram metszi:
...
2 + U
(II)
2 .Használjuk ki, hogy a két teker s sak menetszámában különbözik, vagyis A1 = A2 = A és R1 = R2 = R, ekkor
U2 = µ0
(N1 + N2)A
2πR
∆I1
...
Ságvári Endre Gimnáziumban érettségizett mint Gy®ri István tanítványa.Heten kaptak di séretet: Béres Bertold, a BME zika BS szakos hallgatója, aki a budapesti Puskás Tivadar
