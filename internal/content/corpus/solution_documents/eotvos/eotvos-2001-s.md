---
id: solution-document-eotvos-2001-s
source: eotvos
...
provenance_note: "Source-provided solution document; preserved from cache/phoxiv/eotvos/2001_S.pdf."
---
...
A versenyen részt vehettek a 2001-ben érettségizettek, valamint a középiskolások. Délután 3h
-tól este 8h
-ig zajlott
a verseny. Minden, az önálló munkához szükséges segédeszközt (magukkal hozott könyveket, jegyzeteket, zsebszámoló-
gépet) használhattak a versenyz®k a feladatok megoldásához. Budapesten kívül 14 vidéki városban lehetett megírni a
dolgozatot. Összesen 200 dolgozat érkezett be a Versenybizottsághoz, közülük 91-et Budapesten, 19-et Pé sett, 15-öt
...
A vágási felületeket hajszálvékony szigetel® réteggel látjuk el, utána a részeket újra teljes gömbbé egyesítjük. Ezután
mindkét gömb bal oldali részére ugyanakkora, ki siny Q töltést viszünk.
Ábrázoljuk mindkét esetben a gömb körül kialakuló er®vonalképet! (A két gömb messze van egymástól, köl sönhatásuk
elhanyagolható.)
(Károlyházy Frigyes)
Megoldás. Mind az a), mind a b) esetben a bal oldali gömbszeletre vitt Q töltés a jobb oldali gömbszeleten
töltésmegosztást hoz létre. Ha q-val jelöljük a Q töltésnek azt a részét, amely a feltöltött gömbszelet sík felület¶ részén
helyezkedik el, akkor a jobb oldali gömbszelet sík felületére −q töltés vándorol, hiszen a két egymás melletti síkfelület
síkkondenzátort képez (1. ábra).
1. ábra
Vajon mekkora lesz q, és hogyan oszlanak el a töltések a gömb küls® felületén? A választ pl. az energiaminimum el-
véb®l kaphatjuk meg. Eszerint egyensúlyi helyzetben a töltések úgy helyezkednek el a vezet®k felületén, hogy a rendszer
teljes elektrosztatikus energiája a lehet® legkisebb legyen. Jelen esetben a síkkondenzátor energiája (a szigetel®réteg
hajszálvékony volta miatt) elhanyagolhatóan ki si, a rendszer energiája tehát a gömbön kívüli elektrosztatikus mez®
energiájával egyezik meg. Ez az energia nyilván ugyanolyan töltéseloszlásnál lesz minimális, mint amilyen a Q töltéssel
feltöltött eredeti (szétvágatlan) gömb esetében, vagyis az ismert egyenletes töltéseloszlásnál.
Más módon is érvelhetünk. Külön-külön mindkét gömbszelet poten iálja állandó, mivel elektrosztatikában a fém
bármilyen alakú is legyen, mindig ekvipoten iális, s a belsejében a térer®sség mindig zérus. Mennyi most a két fém-
...
Q
4R2π
= állandó.Az egyenletes felületi töltéss¶r¶séghez tartozó elektromos térer®sség a gömbön belül (a síkkondenzátor belsejét
...
r2
(r > R).
A gömbön kívül kialakuló er®vonalkép tehát jó közelítéssel a 2. ábrán látható lesz.
2. ábra
Megjegyzés: A feladatot 11 versenyz® oldotta meg jól, ezen kívül még három versenyz® adott be a b) kérdésre helyes megoldást.
Két megoldónak
1
jutott eszébe a középen félbevágott gömb esetére az alábbi szellemes megoldás:
...
2. Egy henger alakú zárt tartály fekv® helyzetben egyenletesen forog (vízszintes) hossztengelye körül, 0,5/s fordulatszámmal.
A tartály 100 kg homokot tartalmaz, bels® átmér®je és hossza egyaránt 1 m, fala érdes.
Be süljük meg, mennyivel növekszik a homok h®mérséklete 10 per alatt, ha a falon keresztül elszök® h®mennyiséget elhanya-
goljuk!
(Károlyházy Frigyes)
...
vesz fel, amelynek határa id®ben nem változik. Emiatt a homok tömegközéppontja mindig ugyanott, a henger forgástengelyét®l
vízszintes irányban valamekkora k távolságra helyezkedik el (lásd az ábrát!).
1Bartos Imre (Budapest) és Siroki László (Debre en)A homok bels® energiájának növekedése (azaz a súrlódási er®k munkája) nyilván megegyezik a henger egyenletes forgatása
során végzett munkával, ez utóbbi pedig a hengerre kifejtend® mg · k forgatónyomatéknak és a henger ∆ϕ szögelfordulásának
szorzatával egyenl®:
Wsúrl. = mg · ∆ϕ.
A tíz per alatti szögelfordulás:
∆ϕ = ω ∆t = 2πn∆t = 2π · 0,5 s−1
· 600 s = 1885 rad.
A nehézségi er®:
mg = 100 kg · 9,81
m
s2
= 981 N.
Hátra van még a nehézségi er® k karjának kiszámítása. Be süljük meg el®ször a tömegközéppont és a forgástengely rtkp
távolságát! Felhasználjuk, hogy egy α nyílásszög¶ hengerszelet térfogata
V =
1
2
hr2
...
V = m/̺ ≈ 60 − 65 dm3
.
(A homok s¶r¶sége nyilván a homok min®ségét®l, nedvességtartalmától, összetételét®l stb. is függ, de mindenképpen kisebb,
mint a tömör kvar táblázatban megtalálható 2,65 kg/dm3
-es s¶r¶sége.) Ezekb®l az adatokból és be slésekb®l α ≈ 90◦
, illetve
rtkp ≈ 4 dm adódik.
...
k ≈ rtkp · sin45◦
≈ 2,8 dm,
a súrlódási munkára pedig mintegy 520 J-t kapunk. Ezt felhasználva és a homok fajh®jét 800 J/(kg◦
C)-nak véve kapjuk:
∆T ≈ 6,5 ◦
C.
Mivel a homok s¶r¶sége és fajh®je is mintegy 10%-ra határozatlan mennyiség, a homok dinamikus rézs¶szöge is rejt ekkora
bizonytalanságot, helyesnek tekinthetünk minden olyan be slést, amely mintegy 20%-kal tér el ∆T fenti értékét®l, vagyis 5 és
8 ◦
C közé esik.
Megjegyzések. 1. A feladat megoldása során összesen 57 versenyz® jutott el odáig, hogy konkrét numerikus be slést tudott
...
feladatot.2. Érdemes a feladatban leírt jelenséget kísérletileg is tanulmányozni. (A fényképen látható berendezést, amely a feladatban
...
b) Mekkora frekven iával billeg (kis kitérések esetén) a rajzszög az egyensúlyi helyzete körül?Az egyszer¶ség kedvéért tételezzük fel, hogy a rajzszög feje homogén körlap, t¶jének tömege a fejhez képest elhanyagolható, és
...
t¶jének asztalra mer®leges vetülete és a lejtvonal által bezárt szög).2. ábra 3. ábra
...
r
R
β.3. Gyorsulva elfordul a rajzszög fejének síkja a fej középpontján, valamint a fej és az asztal érintkezési pontján áthaladó
tengely körül: X
M′′
= Θ′′
· β′′
...
szim-
metriamegfontolások és a tehetetlenségi nyomatékot deniáló összefüggés szerint Θ′
...
2Pozsgay Balázs (Budapest) dolgozatahallgatója, aki a pé si Magyar-német Nyelv¶ Iskolaközpontban érettségizett és Kotek László tanítványa volt; Siroki
...
Verseghy Feren Gimnázium 11. évf. tanulója, Lapu Béla tanítványa.2001. november 23-án délután került sor az ünnepélyes eredményhirdetésre. Ennek során a Versenybizottság elnöke
...
eredmények kihirdetése követte. A díjakat Gyulai József akadémikus, az ELFT elnöke adta át.A 2001. évi Eötvös-verseny nyertesei
