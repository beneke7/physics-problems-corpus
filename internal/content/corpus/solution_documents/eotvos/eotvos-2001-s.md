...
A tíz per    alatti szögelfordulás:
                                      ∆ϕ = ω ∆t = 2πn∆t = 2π · 0,5 s−1 · 600 s = 1885 rad.
A nehézségi er®:
                                                                     m
                                                mg = 100 kg · 9,81      = 981 N.
                                                                     s2
...
(A homok s¶r¶sége nyilván a homok min®ségét®l, nedvességtartalmától, összetételét®l stb. is függ, de mindenképpen kisebb,
                                                     3                                                          ◦
mint a tömör kvar táblázatban megtalálható 2,65 kg/dm -es s¶r¶sége.) Ezekb®l az adatokból és be slésekb®l α ≈ 90 , illetve
rtkp ≈ 4 dm adódik.
...
kb. azonos magasságba kerül, s emiatt a keresett er®kar
                                                   ...
                                                   k ≈ rtkp · sin 45◦ ≈ 2,8 dm,
                                                                                                   ◦
a súrlódási munkára pedig mintegy 520 J-t kapunk. Ezt felhasználva és a homok fajh®jét 800 J/(kg       C)-nak véve kapjuk:
...
egyetlen síkban (az ábra síkjában) van, ezért könnyen felrajzolható (1. ábra ).
  ...
  Jelölések: N1 illetve N2 az asztalra mer®leges nyomóer®k, S1′ illetve S2′ a rajzszögre ható tapadási súrlódási er®k,
...
az N1 /N2 arányt meghatároznunk. Írjuk fel a merev test egyensúlyának feltételeit!
        X−
         →
   1.    F = 0. Ezt alkalmazva például az asztallappal párhuzamos összetev®kre:
...
A fenti két egyenletb®l:
                                                  S1′ + S2′ = (N1 + N2 ) tg α.
        X
   2.       M = 0. Ez a feltétel jelen esetben   sak egy összefüggést ad:


                                                 N1 k1 = N2 k2 + (S1′ + S2′ )k3 .
                 ′    ′
Behelyettesítve S1 + S2 el®bb kiszámított értékét:


                                            N1 k1 = N2 k2 + (N1 + N2 ) tg α · k3 ,
...
Ki siny ϕ szögekre sin ϕ ≈ ϕ, tehát itt egy
                                                                    β = −ω 2 ϕ
alakú összefüggést kaptunk, ami ω körfrekven iájú harmonikus rezgésnek felel meg.
    A rajzszög (kis kitérés¶) billegésének körfrekven iája tehát
                                            ...
                                            p
                                       2
és ha ebbe behelyettesítjük r = l          / R2 + l2 -et, akkor
                                                            s          √
                                                               g sin α R2 + l2
                                                        ω=         3 2   1 2   .
                                                                   2l + 4R
                                                              ...
                                                              −1                            −1
A megadott számadatokkal a körfrekven ia 9,02 s                    , a frekven ia 1,44 s         , a periódusid® pedig T ≈ 0,7 s lesz.
                                                                                   2
    Megjegyzések: 1. A b) kérdésre    sak egyetlen teljes megoldás érkezett , ez sem dinamikai, hanem energetikai meggondolásokkal
...
mint 40 százaléka) adott elvileg és numerikusan is helyes megoldást.
                                                                                       ...
                                                                                       −      →
                                                                                              −
    2. A merev testek forgómozgásának általánosan érvényes egyenlete az N = Θ ω perdületvektor id®beli változási sebességével
fogalmazható meg:
                                                                   X−
                                                                    →
                                                                        →
...
négyzetével arányos, jelen feladatnál tehát kis kitérések esetén gyelmen kívül hagyható. A forgómozgás dinamikai egyenlete
                                  X−
                                   →    −
                                        →
ebben a közelítésben valóban       M = Θ β alakba írható, s ennek a vektoregyenletnek különböz® komponenseit tartalmazza
(2) és (3).
              −
              →
    3. Az N       = Θ−
                     →
                     ω összefüggésben szerepl® Θ tehetetlenségi nyomaték nem skalár, hanem irányfügg®, ún. tenzor mennyiség.
