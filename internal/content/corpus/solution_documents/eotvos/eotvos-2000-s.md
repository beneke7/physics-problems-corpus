...
ahogyan ez a 2. ábra kinagyított részén is látható.
      A kiválasztott lán szemre ható er®k ered®je zérus. Írjuk fel el®ször az érint® irányú er®k egyensúlyát:
                                         ...
                                         (K + ∆K) cos ε − mg sin α − K cos ε = 0.

Mivel ε ≪ 1, ezért cos ε ≈ 1, tehát írhatjuk:
                                                      ∆K = mg sin α.
...
zérus legyen. Eddig még    sak az érint® irányú egyensúlyt vizsgáltuk! Írjuk fel a sugár irányú er®k egyensúlyát is:
                                     ...
                                     (K + ∆K) sin ε + K sin ε − N − mg cos α = 0.

Használjuk fel, hogy sin ε = d/(2R), valamint cos α = (R − y)/R.
...
Mivel ∆K ≪ K , ezért az els® két tag összege Kd/R-nek vehet®. Fejezzük ki az N nyomóer®t:
                                                 ...
                                                 N =K       − mg     ,
                                                          R       R
                           mg
és helyettesítsük be K =      (y + l − R)-et! Azt kapjuk, hogy minden y -ra fenn kell állnia az alábbi egyenl®ségnek:
                           d
                                                            2y + l − 2R
                                                  N = mg                .
                                                                 R
...
Ez a feladat megoldása: a lánlelógó részének legalább 2R hosszúságúnak kell lennie.
...
telített g®z nyomásához képest.
   Kiindulási állapotban a kém s® felül nyitott, benne vizet forralunk, tehát az alján 100 C-os a víz, felette 100 C-os
                                                                                          ◦                       ◦
...
200 ◦ C, az alján pedig 100 ◦ C. N®tt a g®z átlagh®mérséklete, ezért a nyomása nem       sökkenhetett. Csökkent viszont a
s¶r¶sége (legjobban a kém s® tetején, ahol a legjobban n®tt a h®mérséklete), s ez  sak úgy lehetséges, hogy a g®z egy
része le sapódott vízzé. Alul tehát maradt víz (még n®tt is a mennyisége), amelyet 100 C-on tartottunk. A 100 C-os
                                                                                       ◦                        ◦
...
Ha a > b, akkor az ered® intenzitás
                                                      ...
                                                      I∼         (a − b) .
                                                               2
Ez nem sak akkor következik be, ha d sin α = λ/2, hanem minden olyan esetben, amikor


                                                        λ
                                      d sin α = (2k + 1) ,         (k = 0, ±1, ±2, . . .)
                                                        2
Azokban az esetekben pedig, amikor

                                                     λ
                                      d sin α = 2k     = kλ,       (k = 0, ±1, ±2, . . .)
                                                     2
