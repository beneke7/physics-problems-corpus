...
szakasz hosszának,
ahányszorosa az Ma nyomaték nagysága az Mb nagyságának.3. ábra
...
elmozdulását hozza létre, tehát nem járul hozzá annak függ®leges irányú lesüllyedéséhez.Látható, hogy ebben a durva modellben az a) esetbeli végpont lesüllyedése kb. kétszerese a b) esetének, és sejthet®,
...
T
T0
következik.A vízg®z nyomására tehát kétféle összefüggést tudtunk felírni. Egyrészt a már említett pg®z = f(T) g®ztenzió
...
FCb = k
e2
d2Coulomb-er® hat. Az el®bbi (megfelel® irányú mozgás esetén) mindig a másik elektron felé mutató er®, az utóbbi
...
A mozgásegyenlet
X
F = ma, vagyis az irányokat is gyelembe véve:
evB − k
e2
d2
= m
...
lás er®s mágneses térben nem folytonosan, hanem ugrásszer¶en (kvantumosan) változik. Ez az ellenállás-kvantumkifejezhet® univerzális mikrozikai állandókkal (elemi töltés, Plan k-állandó). Az 1985-ben Klaus von Klitzing német
