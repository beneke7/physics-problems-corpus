---
id: solution-document-bpho-r2-2013-s
source: bpho-r2
...
provenance_note: "Source-provided solution document; preserved from cache/phoxiv/bpho-r2/2013_S.pdf."
---

British Physics Olympiad 2013 – Round3
...
where ρw = 1000 kg/m3 is the density of water, and Astone = 0.25 m2 is the area of the face of
the stone where the water hits.

All this water has its velocity reduced from 7m/s to zero, so a = −7 24 W
                                                             a
...
]<% = ]P% =  9.8 24 W   ×  4000 `M2WT   ×  0.25 2   ×  0.1 2  = 980 *

From earlier we have: ]<% = −2< a = − <  T.U ^% #_!  − T.U
                                     a



Substituting the numbers in and rearranging, we get  T.U ≅ 2.0 24 W
