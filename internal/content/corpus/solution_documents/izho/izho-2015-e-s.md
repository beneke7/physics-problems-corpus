...
the one across the resistor R0  1,0 Ohm . If the voltage is
...
which is equal to the rod resistance.
        ...
        To calculate the resistivity of use is the following formula
                          4l             d2          (1,0 103 )2
                  R                       R                     3,78  5,93 105 Onm  m
                         d  2
                                           4l        4  5,0 10 2


Here l  (5, 0  0, 2) sm is the length of the rod between the leads.
...
1.2.6 The linearity of this dependence is observed at powers larger than 0, 2W .
       The coefficients of this dependence R  aP  b , calculated using the least square method, are
                   Ohm
found as a  0,13        , b  3, 75Ohm , consequently, the coefficient in formula (3) is evaluated as
                     W
     a
   0, 035W 1 .
     b
...
Calculation for the first five points leads to the following value
                                          Rg  (3,88  0, 03)Ohm.
        Since this value should obey the formula R g  R0 (1  T ) , the temperature coefficient of
...
measurements. Table 3 shows the results of calculations of logarithms.
      ...
      The slope coefficient of the obtained almost linear dependence is found as a  0,044s 1
                                                                                1
...
X International Zhautykov Olimpiad/ Experimental Competition                                Page 6/7
  ...
  1.2.2     marked only if the deviation from the table in the solution is less             3,0
            than 50%
            Measurements :
