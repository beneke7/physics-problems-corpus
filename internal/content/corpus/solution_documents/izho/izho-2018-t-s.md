---
id: solution-document-izho-2018-t-s
source: izho
...
mapped_problems: [izho-2018-t-q1, izho-2018-t-q2, izho-2018-t-q3]
verification_status: pending
provenance_note: "Source-provided solution document; preserved from cache/phoxiv/izho/2018_T_S.pdf."
---

XIV International Zhautykov Olympiad/Theoretical Competition/Solutions                           Page 1/15
...
obtained as:
                ...
                U  U1  U 2                 gx 2 .                          (10)
                                        2 S  S0
А2.2 If the tube drops with the velocity v0 , then the water between the
...
This equation is also an equation of harmonic oscillations with the same period
 ...
 Part                                 Content                                       Points
         Formula (1) ma  mg  S 0 h0  x g                                    0,2
         Formula (2) mg  S 0 h0 g                                               0,2
                          g
  А1     Formula (3) a   x                                                      0,2        0,8
                          h0
                                  h0
         Formula (4) T  2                                                       0,2
                                  g
         Formula (5) U1  mgx                                                   0,2
                                                        S0
         Formula (6) S 0 x  S  S 0 y        y          x                    0,2
                                                      S  S0
         Formula (7) m  S 0 x                                                  0,2
         Formula (8)
                                   1        S0    
         hC  h0  x  y   h0   x 
 А2.1                1                                       1 S                  0,2        1,2
                     ...
                     2             2      S  S0           2 S  S0
                                                   1 S       
         Formula (9) U 2  mghC  S 0 xg h0          x                   0,2
                                                   2 S  S0 
                                        1 S0 S
         Formula (10) U  U1  U 2            gx 2                           0,2
                                        2 S  S0
                                                         S0
         Formula (11) v0 S 0  vS  S 0   v               v0                  0,2
                                                       S  S0
         Formula (12) m1   S  S 0 h0                                         0,2
         Formula (13)
 А2.2                                                                  2                     0,6
             mv02 m1v 2          v2                 1  S0       
          K            S 0 h0 0   S  S 0 h0        v0  
              2    2              2                 2  S  S0                   0,2
              1 S0 S
                      h0 v02
              2 S  S0
...
and solving it together with (30) provides the following temperature at the altitude 𝐻′
        ...
        Then, the altitude itself is delivered by formula (15) as
                             𝑇 −𝑇(𝐻 ′ )         𝑇                            𝑎−ln 𝜑
                       𝐻′ = 0 𝛽               = 𝛽0 (1 − exp (𝜇𝐻2 𝑂𝑔 )) = 2.55 ∙ 103 m.      (33)
                                                                                  −𝑏
                                                                             𝛽𝑅
...
XIV International Zhautykov Olympiad/Theoretical Competition/Solutions                          Page 8/15
  ...
  2.3    Formula (20) ∆𝐻𝑎𝑡𝑚 =                                                                 0,2     0,8
         ...
         Correct numerical value ∆𝐻𝑎𝑡𝑚 = 2,05 ∙ 103 𝑚                                         0,2
                                          𝑝2 −𝑝1
         Formula (21) 𝑝(𝑇) = 𝑝1 + 𝑇 −𝑇 (𝑇 − 𝑇1 )                                              0,4
                                             2       1
  2.4                                                                                                 0,6
  ...
  2.7                                                    𝑎−ln 𝜑
         ...
         Formula (32) 𝑇(𝐻 ′ ) = 𝑇0 exp (𝜇𝐻2 𝑂 𝑔 )                                             0,2
                               ...
                               𝑇 −𝑇(𝐻 ′ )            𝑇                              𝑎−ln 𝜑
         Formula (33) 𝐻 ′ = 0 𝛽              = 𝛽0 (1 − exp (𝜇𝐻2 𝑂 𝑔 ))                        0,4
                                                                                         −𝑏
                                                                                    𝛽𝑅
...
3.5 [0,2 points] Using formula (53) the water refraction index is found to be
 ...
 Part                                       Content                                  Points
  ...
  1.2                         mc 2                                                            0,6
         Formula (6) E                                                             0,2
                            1  v2 / c2
         Formula (7) inv  E 2  p 2c 2  m2c 4                                     0,2
                           E
         Formula (8) p                                                             0,2
                           c
         Formula (9) E  h                                                         0,2
  2.1    Formula (10) px  p cos                                                   0,2       1,0
         Formula (11) p y  p sin                                                  0,2
                                1  V cos  / c
         Formula (12)  '                                                         0,2
                                 1  V 2 / c2
                      h '           h
         Formula (13)      sin  '      sin                                       0,2
                       c              c
  2.2                                                                                         0,4
                                1  V 2 / c 2 sin 
         Formula (14) sin  '                                                      0,2
...
XIV International Zhautykov Olympiad/Theoretical Competition/Solutions     Page 14/15
  ...
  2.4
         ...
         Formula (28) vII  2 ln                    c                   0,2
                                 ...
                                               
                                          0     
         Numerical value vII  7.108 104 c  21.31km/s                 0,2
                               dx '
         Formula (29) u x '                                             0,1
                               dt '
                               dy '
