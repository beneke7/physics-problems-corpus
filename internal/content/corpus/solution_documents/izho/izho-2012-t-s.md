---
id: solution-document-izho-2012-t-s
source: izho
...
mapped_problems: [izho-2012-t-q1, izho-2012-t-q2, izho-2012-t-q3]
verification_status: pending
provenance_note: "Source-provided solution document; preserved from cache/phoxiv/izho/2012_T_S.pdf."
---

VIII International Zhautykov Olympiad, Almaty, Kazakhstan, 2012 1
SOLUTIONS OF PROBLEMS OF THEORETICAL TOUR
Problem1. (10 points)
Problem 1A. 2012
Forces acting on the system are
shown in Fig. Since the hard core and
non-tensile yarn, acceleration loads
are as 1:2:3. The sum of the torques
acting on a weightless rod is zero.
These two conditions together with
the equations of the 2nd law of
Newton for all goods provide a
system of equations



...
=
. (2)
However, this value of acceleration is obtained second load more free-fall
acceleration. This means that the second thread of the load will not be tight, but its
acceleration is equal to g. You can also show that the formal system of equations (1) that,
for which the thread cannot be. Therefore, the thread to which the suspended second load,
the rod does not work. Therefore, the system of equations (1) incorrectly describes the
device under consideration. To calculate the acceleration of the rod and the other second
load should be deleted.
Valid values for the acceleration of the first and third loads are from the following
system of equations



...
Total 4,0
Task 1.B. Anddiodes
We denote the voltage on a pair of parallel-connected diodes by 1 U and on three of
the diodes by 2 U . The total current in the circuit I can be found in two ways:
• A double value of the current through one diode pair:
( ) 1 0 2 U I I = ; (1)
• Three times the value as a force in one of
the three diodes:
( ) 2 0 3 U I I = . (2)
We construct the graphs of
( ) U I0 2 and
( ) U I0 3 . It's enough to “multiply” the graph of
the
( ) U I0 by appropriate factor, i.e. for
several values of the voltage on the schedule
to remove the corresponding values of the
forces of currents, multiply them by 2 and 3
and apply the appropriate point on the
graphs. When connected in series the total voltage is the sum of the stresses in some parts
of the circuit, so
U U U = + 2 1 . (3)
Graphically, this condition corresponds to a “horizontally summing” graphs ( ) U I0 2
and ( ) U I0 3 : for a given value of current and voltage values 1 U and 2 U are read, and their
...
functions):VIII International Zhautykov Olympiad, Almaty, Kazakhstan, 2012 3
( ) 



...
• To approximate the dependence;
• To solve the equations explicitly;
0,4
0,4
Total 2,5VIII International Zhautykov Olympiad, Almaty, Kazakhstan, 2012 4
Tasks 1.C. Flat lens
Plate will form an image S′ if the optical path length S SAB l ′ = for any ray of light,
...
a r << , ie, we use the paraxial approximation. Distance
SA
found using the Pythagorean
theorem and make the approximation a r << , given that:
 


 
...
b r b S B
. (2)
Thus, the optical path length S SAB ′ is equal to
( ) ( )
2
0 0
2
...
β
(3)
This value does not depend on r (i.e., the same for all rays) for the vanishing of the
factor
0
2
1
...
a
b
β . (8)VIII International Zhautykov Olympiad, Almaty, Kazakhstan, 2012 5
...
№ points
1 Formulation of basic idea: the constancy of the propagation
time for all the paths
1,5
...
S B ′
- The exact formula;
- Expansion of the approximate formula;
0,2
0,4
...
Total 3,5VIII International Zhautykov Olympiad, Almaty, Kazakhstan, 2012 6
Problem2
...
1 0 1 0 1 ( ) ( ) ( )( ) A Mg H H p S H H Mg p S H H = − + − = + − (2)
...
2 0 273 T T = = K. (10)
2.6. [0.5 points] The height 2 H is found by (9) and (10), as well as the equation of state of
gas
0
2
0
...
pV const γ
= (12)
we obtainVIII International Zhautykov Olympiad, Almaty, Kazakhstan, 2012 7
dV
dp p
V
γ = −
...
molecule is
2 3 tot rot B B B W W W k T k T k T = + = + = (20)
...
Mg
p
k T p k T S p S Mg u k T S k T S
k T m k T m π π
+
+ = −
(21)
...
,
2 2
( ) ( 1) 4 2 2 2 g α α α α α α = + + + − − − , (23)
and temperature
( ) 2 2
3 0 5 4 2 2( 1) 4 2 116 T T α α α α α = + + − + + + =
K, (24)
that isVIII International Zhautykov Olympiad, Almaty, Kazakhstan, 2012 8
0 C T = ,
2 2
( ) 5 4 2 2( 1) 4 2 h α α α α α α =+ + − + + + . (25)
Grading scheme of Problem 2
N points
2.1 Formula (1) 0,25 0,5
Numerical value of 1 p 0,25
2.2 Formula (2) 0,25
1,5
Formula (3) 0,25
Formula (4) 0,25
...
Formula (7) 0,25
Numerical value of 1 T 0,25
2.3 Formula (8) 0,25 0,5
Numerical value of 1 H 0,25
2.4 Formula (9) 0,25 0,5
Numerical value of 2 p 0,25
2.5 Formula (10) 0,25 0,5
Numerical value of 2 T 0,25
2.6 Formula (11) 0,25 0,5
Numerical value of 2 H 0,25
2.7 Formula (12) 0,25
2,0
Formula (13) 0,25
Formula (14) 0,5
Formula (15) 0,5
Formula (16) 0,25
Numerical value of ω 0,25
2.8 Formula (18) for A 0,25
1,0 Formula (18) for ( ) f α 0,25
Formula (17) 0,25
Numerical value of 3 p 0,25
2.9 Formula (19) 0,25
2,0
Formula (20) 0,5
Formula (21) 0,25
Formula (23) for B 0,25
Formula (23) for ( ) g α 0,25
Formula (22) 0,25
Numerical value of u 0,25
2.10 Formula for (25) for C 0,25
1,0 Formula for (25) for ( ) h α 0,25
Formula (24) 0,25
Numerical value of u 0,25
Total 10,0VIII International Zhautykov Olympiad, Almaty, Kazakhstan, 2012 9
Problem3
Nuclear droplet (10 points)
3.1 [2 points] We calculate the total electrostatic energy of the protons in the
nucleus. Within the droplet model of the nuclear charge Zeis uniformly distributed inside a
...
∞ ∞
= = = ∫ ∫ . (5)
3.2 [1 point] From (5), Q Ze = and 1/3
0 ( ) R A R A = we see that the electrostatic energy
...
2 2 2/3
0 4 4 sur E S R R A σ πσ πσ = = = . (9)
We conclude that the surface energy corresponds to the second term of the semi-empirical
formula Weizsäcker
2 2/3 2/3
0 2 4 R A ea A πσ = (10)
whence
17 2
2
0
...
3.6 [0.5 points] The function ( ) f k is symmetric with respect to the point 0.50 k = , so at this
...
formula for the volume of an ellipsoid and the fact that , 1 ε λ  we obtain
( ) 3 3 4 4
1 2
3 3
V R R
...
C surf E E ∆ > ∆ (20)VIII International Zhautykov Olympiad, Almaty, Kazakhstan, 2012 11
whence
2 3
2 0 0
2
...
3.2 Formula (6) 0.5
1.0 Formula (7) 0.25
Numerical value of 0 R 0.25
3.3 Formula (8) 0.75 1.0
Numerical value of m ρ 0.25
3.4 Formula (9) 0.25
1.0 Formula (10) 0.25
Formula (11) 0.25
Numerical value of σ 0.25
3.5 Formula (12) 0.5
2.0
Formula (13) 0.5
