...
−
. (4)
Then the time of motion 1 t is obtained as the sum of small intervals, which finally reduces to a
simple integration
( )
0 0
1
...
−
  . (5)
1.4 The oscillation period is 4 times longer than the found time 1 t , viz.
1 4t T = . (6)
...
0

 = this formula further simplifies toXVII International Zhautykov Olympiad/Experimental Competition Page 2/8
2cos k k   = . (12а)
...
1
,
Therefore, the travel time k t  of the k ’th interval from 1 − k  to k  is obtained as
k k
k t
 

...
2
. (13)
2.5 The time k t to reach the angle k  is found via
k k k t t t  + = −1 (14)
at the initial condition 0 0 = t .
2.6 The oscillation period N T when dividing into N intervals is eventually written as
N N t T 4 = . (15)
...
23 0,4418 1,3446 0,0367 1,5366XVII International Zhautykov Olympiad/Experimental Competition Page 3/8
...
contrary, the deflection angles are set and corresponding times are calculated.XVII International Zhautykov Olympiad/Experimental Competition Page 4/8
Table 2.
k t 
0 0,0000 1,5708
1 0,0982 1,5632
...
slope coefficient 3 , 2 −  a and the shift 65 , 1 −  b . Therefore, the sought parameters of the dependence are
found as
19 , 0 ) exp(
3 , 2
 =
...
002 , 0 =  is expressed asXVII International Zhautykov Olympiad/Experimental Competition Page 5/8
1/
min 8
С
N
...
 
. (19)
So, all further calculations should be carried out at min 8 N N = = .
...
4 0,6545 1,0340 0,1673 1,1976 4 0,7854 1,1892 0,1751 1,2692XVII International Zhautykov Olympiad/Experimental Competition Page 6/8
...
the parameter 1 = a . To check the applicability of
...
amplitude 2
0  , which is shown in the figure on the
right.
The slope coefficient of the obtained
dependence is 0706 , 0 , therefore, the parameter b
...
l
T  2 =
0.1 0.1XVII International Zhautykov Olympiad/Experimental Competition Page 7/8
1.2
Law of motion
...
~
= T 0.2 0.2
1.7 Formula (9): ( ) 0 2(cos cos )     = − 0.2 0.2
2. Designing an experimental setup, planning an experiment. 1.5
2.1 Formula (10):
N
0 
 =  0.1 0.1
2.2 Formula (11):     − = −1 k k 0.1 0.1
2.3 Formula (12): 0 cos cos    − = k k 0.1 0.1
2.4
...
0.5
0.5
2.5 Formula (14): k k k t t t  + = −1
0.1 0.1
2.6 Formula (15): N N t T 4 = 0.1 0.1
3. Trial experiment, estimation of errors. 9.0
3.1
Graded only if the periods obtained differ from those in this official
...
3.2
Graph:
All points are plotted in accordance with the table;
Smooth line is drawn;
0.5
0.3
0.2
3.3
Graph
Law of motion is obtained, table 2
All points are plotted in accordance with the table
Smooth line is drawn;
1.0
0.5
...
3.5
Graph
Double logarithm scale is used
Linearized dependence is drawn
2.3
0.5
0.5XVII International Zhautykov Olympiad/Experimental Competition Page 8/8
Linear dependence is obtained
The power is found as 1 , 0 3 , 2   
The coefficient is found as 1 , 0 19 , 0   C
0.3
0.5
0.5
3.6 Concluded that 1 8 = N 0.5 0.5
4. Experiment: the dependence of the period on the amplitude. 8.0
4.1
Graded only if the periods obtained differ from those in this official
solution lees than 0,02
For each period obtained
One period is added from part 3
4.2
0.8
0.2
4.2
Graph of the linearized dependence
Correct linearization is used ( ) 2
0  T
Graph is plotted
Linearized dependence is obtained
1.5
0.5
0.5
0.5
...
Parameter 1 = a (only exact value is accepted)
Parameter b in the range 13-16
1.3
0.3
1.0
