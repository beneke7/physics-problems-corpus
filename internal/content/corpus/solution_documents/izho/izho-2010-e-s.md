---
id: solution-document-izho-2010-e-s
source: izho
...
provenance_note: "Source-provided solution document; preserved from cache/phoxiv/izho/2010_E_S.pdf."
---
...
the calculated velocities V.Table 2.
...
slowed down by the above mentioned viscous friction acting on its lateral surface.It is reasonable to assume that the viscous friction force acting on
...
least-squares method from Table 3, is2. To obtain velocities it is enough to measure time intervals for a wood stick to pass a fixed path
