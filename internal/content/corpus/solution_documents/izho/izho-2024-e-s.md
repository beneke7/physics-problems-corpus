...
12
+ 2𝑚𝑚1𝑧𝑧2
designates the moment of inertia of the rod with the nuts.
Formulas(1) and (2) areactually used inthework,but their derivationisnot requiredandisnot graded.
Part 1. Observation of the effect and its theoretical description
1.1 Therod end moves along trajectories corresponding totheadditionof perpendicular oscillations with close
...
𝑙𝑙
2
𝛽𝛽𝑚𝑚𝑚𝑚𝑚𝑚 sin(𝜔𝜔0𝑡𝑡 + (𝜔𝜔1−𝜔𝜔0)𝑡𝑡)
. (6)
In the expression𝑦𝑦(𝑡𝑡) for close frequencies, thevalue∆𝜑𝜑 = (𝜔𝜔1−𝜔𝜔0)𝑡𝑡 can be considered as a slowly varying
...
𝑇𝑇1
|𝑇𝑇0−𝑇𝑇1|
. (9)XV International Zhautykov Olimpiad/Experimental Competition с. 2/7
...
The corresponding dependence graph looks likeXV International Zhautykov Olimpiad/Experimental Competition с. 3/7
...
construct dependencies 𝑇𝑇1(𝑎𝑎−1
), or 𝑇𝑇1
−1
(𝑎𝑎). However, in these methods it is necessary to prove that the
...
0,0 1,0 2,0 3,0 4,0
ln a
ln TXV International Zhautykov Olimpiad/Experimental Competition с. 4/7
...
The graph of thisrelationship is shown in thefigurebelow. It can be seen that theresulting dependence
is nonlinear.
...
�
2
depends linearly on 𝑧𝑧2
, and the graph of the linearized dependence is shown in
the figure below.
...
z^2, sm^2
U,sm^ 2XV International Zhautykov Olimpiad/Experimental Competition с. 5/7
Part 4. Mixed oscillations
4.1, 4.2 Table4 shows theresults of measurements and calculations necessary to verifythe theoretical formula
(9).
Table 4. Study of mixed oscillations.
𝑧𝑧, cm 𝑇𝑇1, s
𝑇𝑇0
𝑇𝑇1 𝑁𝑁𝐶𝐶 (теор.) 𝑁𝑁𝐶𝐶 (эксп)
1
𝑁𝑁𝐶𝐶
10,5 1,247 1,059 17
...
𝑇𝑇0
𝑇𝑇1
, which is theoretically described by the formula
1
𝑁𝑁𝐶𝐶
= �
𝑇𝑇0
...
0,8 Explicit time dependencies 2х0,1=0,2
...
T0/T1
1/NcXV International Zhautykov Olimpiad/Experimental Competition с. 6/7
1.3
...
Random error calculated (averaging of deviation modules, standard
...
20% range if the time of less than 10 oscillations is measured, 0.1 per
measurement)
0,15х10=1,5
...
Plotting a graph (the axes are labeled and digitized, all points are plotted
in accordance with the table, a smoothing curve is drawn)
0,1+0,2+0,2=
=0,5
3.2
...
Linearization is carried out on a double logarithmic scale (calculations
are provided)
(reciprocals, with proof of passing through zero);
0,5
(0,2+0,2)
A graph of the linearized dependence is plotted (the axes are labeled and
digitized, all pointsare plottedinaccordance with the table, asmoothing
line is drawn)
0,1+0,2+0,2=
=0,5
3.3
...
calculated)
0,3 1,0XV International Zhautykov Olimpiad/Experimental Competition с. 7/7
...
2х0,4=0,8
Errors of coefficients are calculated 2х0,1=0,2
...
0,05х10=0,5 0,5
4.3
Linearization is proposed (the reciprocal of the number of oscillations
...
0,5
0,2+0,1=0,3
1,5 The linearized dependence is calculated 0,2
A graph of linearized dependence is plotted
A graph of measurement results is plotted
0,4
0,2
...
TOTAL 20,0XX Международная Жаутыковская Олимпиада/Экспериментальный тур с. 1/7
...
4𝐿𝐿𝐿𝐿
𝑚𝑚𝑚𝑚𝑎𝑎2, (2)
мұндағы 𝑚𝑚 = 𝑚𝑚0 + 2𝑚𝑚1 –маятник массасы, 𝑚𝑚0 –стержень массасы, 𝑚𝑚1 –гайка массасы, 𝐼𝐼 =
𝑚𝑚0𝑙𝑙2
12
+
2𝑚𝑚1𝑧𝑧2
– стержень мен гайканың инерция моменті.
...
келетіні айқын. Осымен байланысты C T циклдің периоды мына шартты қанағаттандырады
(𝜔𝜔1−𝜔𝜔0)𝑇𝑇𝐶𝐶 = ±2𝜋𝜋, (7)
бұдан
𝑇𝑇𝐶𝐶 =
𝑇𝑇0𝑇𝑇1
|𝑇𝑇0−𝑇𝑇1|
. (8)
1.4 Циклдағы қума тербелістердің санын мына түрде жазуға боладыXX Международная Жаутыковская Олимпиада/Экспериментальный тур с. 2/7
𝑁𝑁𝐶𝐶 =
𝑇𝑇𝐶𝐶
𝑇𝑇0
=
...
= 6.5 ∙ 10−2
с.
Уаұытты өлшеудің толық қателігі
∆𝑡𝑡 = �∆𝑡𝑡1
2
+ ∆𝑡𝑡2
2
...
20,5 13,87 1,387 3,0204 0,3271
24,0 11,98 1,198 3,1781 0,1807
Сәйкес тәуелділіктің графигіXX Международная Жаутыковская Олимпиада/Экспериментальный тур с. 3/7
...
−1
(𝑎𝑎) тәуелділігін тұрғызу болып табылады. Бірақ бұл әдісте графиктің түзу сызық
...
0,0 1,0 2,0 3,0 4,0
ln a
ln TXX Международная Жаутыковская Олимпиада/Экспериментальный тур с. 4/7
11 50,84 2,542 121 6,462 370,5
12 52,15 2,608 144 6,799 389,8
13 53,47 2,674 169 7,148 409,8
14 54,85 2,743 196 7,521 431,2
...
2
шамасы 𝑧𝑧2
-тан сызықтық тәуелді, олай болса оның графигі төмендегідей
...
0 50 100 150 200 250
z^2, sm^2
U,sm^ 2XX Международная Жаутыковская Олимпиада/Экспериментальный тур с. 5/7
...
4.3 Жоғарыдағы (9) өрнегін тексеру үшін
1
𝑁𝑁𝐶𝐶
шамасының
𝑇𝑇0
𝑇𝑇1
шамасынан тәуелділігінің графигі
тұрғызылған. Ол теориялық тұрғыдан
1
𝑁𝑁𝐶𝐶
= �
𝑇𝑇0
𝑇𝑇1
− 1� өрнегімен сипатталады. Бұл тәуелділіктің
...
1,0 4 сурет: екі кесінді суреті, қозғалыс бағыты дұрыс көрсетілген
екі эллипс 4х0,2
4х0,2=0,8
1.2
Ауытқу бұрышы арқылы анықталған координат өрнегі 2х0,2=0,4
0,8 Уақыттан айқын тәуелділік 2х0,1=0,2
...
0,90 0,92 0,94 0,96 0,98 1,00 1,02 1,04 1,06 1,08
T0/T1
1/NcXX Международная Жаутыковская Олимпиада/Экспериментальный тур с. 6/7
...
Графиктің салынуы (остер жазылған және саналған;
нүктелер салынған. Жатық қисық тұрғызылған)
0,1+0,2+0,2=
=0,5
3.2
...
(кері шама, нөлден өту дәлелімен)
0,5
(0,2+0,2)
...
График тұрғызылған (остер жазылған және саналған;
нүктелер салынған. Жатық қисық тұрғызылған)
0,1+0,2+0,2=
=0,5
3.4
...
0,1+0,2+0,2=
=0,5
Түзу сызық алынған 0,2XX Международная Жаутыковская Олимпиада/Экспериментальный тур с. 7/7
3.5
...
0,05х10=0,5 0,5
4.3
Линеаризация ұсынылған (периодтар қатынасы мен тербеліс
санының кері шамалары, периодтар айырымы);
Тербеліс саны теориялық тұрғыдан есептелген, тәжірибемен
салыстырылған
0,5
0,2+0,1=0,3
1,5 Линеаризацияланған тәуелділікке есептеулер жасалған 0,2
Линеаризацияланған тәуелділіктің графигі тұрғызылған
Өлшеу нәтижелерінің графигі тұрғызылған
0,4
0,2
Сан модулінің функциясының графигіне ұқсас график алынған 0,3
График минимумының дұрыс орыны 0,1
БАРЛЫҒЫ 20,0XX Международная Жаутыковская Олимпиада/Экспериментальный тур с. 1/7
...
4𝐿𝐿𝐿𝐿
𝑚𝑚𝑚𝑚𝑎𝑎2, (2)
где 𝑚𝑚 = 𝑚𝑚0 + 2𝑚𝑚1 – масса маятника, 𝑚𝑚0 – масса стержня, 𝑚𝑚1 – масса гайки, 𝐼𝐼 =
𝑚𝑚0𝑙𝑙2
12
+ 2𝑚𝑚1𝑧𝑧2
–
...
величину ±2𝜋𝜋. Таким образом, период цикла C T подчиняется условию
(𝜔𝜔1−𝜔𝜔0)𝑇𝑇𝐶𝐶 = ±2𝜋𝜋, (7)
откуда следует
𝑇𝑇𝐶𝐶 =
𝑇𝑇0𝑇𝑇1
|𝑇𝑇0−𝑇𝑇1|
. (8)
1.4 Число колебаний продольных колебаний в цикле можно записать в видеXX Международная Жаутыковская Олимпиада/Экспериментальный тур с. 2/7
𝑁𝑁𝐶𝐶 =
𝑇𝑇𝐶𝐶
𝑇𝑇0
=
...
〈𝑡𝑡20〉 = 26.41 с,
а приборная погрешность равна половине цены деления секундомера
∆𝑡𝑡1 = 0.5 ∙ 10−3
c.
...
20,5 13,87 1,387 3,0204 0,3271
24,0 11,98 1,198 3,1781 0,1807
Соответствующий график зависимости имеет видXX Международная Жаутыковская Олимпиада/Экспериментальный тур с. 3/7
...
Альтернативными способами является построение зависимостей 𝑇𝑇1(𝑎𝑎−1
), или 𝑇𝑇1
−1
(𝑎𝑎). Однако, в этих
...
�
2
линейно зависит от 𝑧𝑧2
, а график линеаризованной зависимости показан
на рисунке ниже.
...
𝑇𝑇0
𝑇𝑇1
, которая теоретически описывается формулой
1
𝑁𝑁𝐶𝐶
= �
𝑇𝑇0
...
Рассчитана случайная погрешность (усреднение модулей
...
диапазон 20%, если измерялось время менее 10 колебаний, по 0,1 за
измерение)
0,15х10=1,5
...
(проведен расчет)
(обратные величины, с доказательством прохождения через
нуль);
0,5
(0,2+0,2)
...
Получена нелинейная зависимость выпуклость вниз 0,1XX Международная Жаутыковская Олимпиада/Экспериментальный тур с. 7/7
Построение графика (оси подписаны и оцифрованы, нанесены все
точки в соответствии с таблицей, проведена сглаживающая
кривая)
0,1+0,2+0,2=
...
2х0,4=0,8
Рассчитаны погрешности коэффициентов 2х0,1=0,2
...
0,05х10=0,5 0,5
4.3
Предложена линеаризация (обратные величины числа колебаний
...
0,5
0,2+0,1=0,3
1,5 Проведен расчет линеаризованной зависимости 0,2
Построен график линеаризованной зависимости
Построен график результатов измерений
0,4
0,2
