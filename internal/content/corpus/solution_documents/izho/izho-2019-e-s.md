...
1,5 100 66,67 6,67
1,3 86 66,15 5,69
The graph of the voltage across the resistor versus its current is shown in the figure below.XV International Zhautykov Olimpiad/Experimental Competition Page 2/7
...
2 50 161 24,9 2 3,91 5,08 3,21XV International Zhautykov Olimpiad/Experimental Competition Page 3/7
...
k n I In ln ln ln 0 − = . (5)
At such a scale, the dependence of n I ln on the number n of light filters should be linear. The measurements
...
Table 4XV International Zhautykov Olimpiad/Experimental Competition Page 4/7
...
grey filter 0,450
blue filter 0,431
yellow filter 0,759XV International Zhautykov Olimpiad/Experimental Competition Page 5/7
...
1.2 Measurements ( ) R U :
Marked only if data are within 50% from the provided in the official
solution:
- maximumal voltage no more than 350 mV;
- maximumal resistance no more than 90 kΩ;
- minimal resistamce less than 2 kΩ;
- number of points 15 or more (10-14, 7- 9, less);
- not less than 5 points in the range of 0-10 kΩ;
- monotonically dcreasing dependence;
- units stated correctly (kΩ. mV);
3,5
0,2
0,2
0,2
...
0,2
0,1+0,1
1.3 Load characteristic:
(marked only if 1.2 had been marked)
- formula to calculate electric current;
- current calculated for all experimental points;
- unit of current stated (𝜇A);
- correct qualitative behavior (slow decrease followed by sharp decline);
Plotting a graph:
- axis named and ticked;
- all points correctly drawn;
- smooth curve drawn;
0,9
0,1
0,2
...
0,1
0.1
1.4 Heat power versus resistance:
(marked only if 1.2 had been marked)
- formula to calculate heat power;
- heat power calculated for all experimental points;
- correct unit of heat power (𝜇W);
...
2.1 Formula 0 I k I n
n = 0,2 0,2
2.2 Transmittance measurements 2,6XV International Zhautykov Olimpiad/Experimental Competition Page 6/7
Marked only if data are within 50% from the provided in the official
solution:
- Measurements in the range of 0-200 mV;
- Initial measurement without filters;
- measurements with 5 (4) filters;
- decreasing dependence obtained;
Linearization
- Correct semi-log scale;
- logarithns calculated for all points;
Plotting a graph (marked only if measurements had been marked)::
- axis named and ticked;
- all points correctly drawn;
- straight line drawn;
Linear dependence obtained;
0,1
0,1х3=0,3
0,3х3=0,9
0,1х3=0.3
...
0.1
0,3
2.3 Formula for the transmittance ) exp(a k =
Formula for the experimental error a a k   =  ) exp( ;
Calculations for all points (LSM, averaging);
(Calculations for 2 points only);
Transmittances found:
Gray in the range of 0,45-0,55 (0,4 -0,6; out of)
Yellow in the range of 0,85-0,95 (0,8-0,98; out of)
Blue in the range of 0,30-0,40 (0,25-0,45; out of)
Experimntal errors found
1,4 0,1
0,1
0,3
0,1
...
0,2(0,1;0)
0,1х3=0,3
2.4 Measurement of transmittance
Gray+yellow in the range of 0,30-0,40 (0,25-0,45; out of)
Blue+gray in the range of 0,15-0,25 (0,10-0,30; out of)
Gray +yellow in the range of 0,40-0,50 (0,35 – 0,55; out of);
Formula 2 1 2 , 1 k k k  = ;
Products found;
...
Marked only if data are within 50% from the provided in the official
solution:
- Measurements in the range of 0-100 mV;
- Initial measurement without filters;
- measurements with 5 (4) filters;
- logarithns calculated for all points;
...
- all points correctly drawn;
- smooth curve drawn;
Linear dependence for gray filter;
Nonlinear dependence for blue filter
1,9
0,1
0,1х3=0,3
0,2х3=0,6
...
0,1
0,2
3.2 Theroretical formula not confirmed
Reason: transmittance depends on the wavelength
0,3 0,1
0,2
3.3 Transmittance measurements
Gray filter in the range of 0,4-0,5 (0,35-0,55; out of)
Blue filter in the range of 0,4-0,5 (0,35-0,55; out of)
Yellow filter in the range of 0,7 – 0,8 (0,65 – 0,85; out of)
Blue+yellow filters in the range of 0,22-0,3 (0,18 -3,5;out of)
Blue+gray filters in the range of 0,14-0,23 (0,1 -0,27;out of)
1,3
0,2(0,1;0)
0,2(0,1;0)
0,2(0,1;0)
0,2(0,1;0)
0,2(0,1;0)XV International Zhautykov Olimpiad/Experimental Competition Page 7/7
Yellow+gray filters in the range of 0,3 – 0,4 (0,25 – 0,45; out of)
Experimental and theoretical transmittances do not coincide
0,2(0,1;0)
0,1
TOTAL 15
