...
Part A. Stationary states and instabilities (3 points)
  ...
  For R = 3.00 Ω, one always gets exactly one intersection.                                        0.2
  For R = 1.00 Ω, one gets 1, 2 or 3 intersections depending on the value of E.                    0.4
...
                                                E − Rint I0
 ...
 The Kirchoff law for the circuit reads
                                          dI                         dI
                      E = IR + UX + L        = IR + (I0 − I)Rint + L
                                          dt                         dt
 This implies
                                  dI
                               L     = E − I0 Rint − (R − Rint )I
                                  dt
...
off branches we can put UX = Ron/off IX . On either of the branches, the circuit behaves
as a standard RC-circuit with conductance C and resistance Ron/off R/(Ron/off + R) (the
...
 on the switched on branch during the cycle is estimated by
 ...
 Note:
     ...
     • Formula + answer outside the range above but inside 1 W ≤ P ≤ 100 W give 0.5
       points
 ...
 Note: The correct answer s = λ/4 = 459 m gives full points, and the mistake s = λ/2 =
 918 m only 0.4 pts.
...
Part C. Bistable non-linear elements in biology: neuristor (2 points)
 ...
 For Ẽ = 12.0 V, the steady state of the system is located on the switched off
 branch:
                                   Roff
                            Ũ =          Ẽ = 9.23 V.
                                 R + Roff
 When the voltage is increased to E = 15.0 V, the system starts moving to the right along
