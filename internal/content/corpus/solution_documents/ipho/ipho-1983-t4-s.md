---
id: solution-document-ipho-1983-t4-s
source: ipho
...
provenance_note: "Source-provided solution document; preserved from cache/phoxiv/ipho/1983/T4_S.pdf."
---
...
Compton scattering
A photon of wavelength λi is scattered by a moving, free electron. As a result the electron stops
and the resulting photon of wavelength λ0 scattered at an angle θ = 60° with respect to the
direction of the incident photon, is again scattered by a second free electron at rest. In this
second scattering process a photon with wavelength of λ f = 1,25 × 10 −10 m emerges at an angle
θ = 60° with respect to the direction of the photon of wavelength λ . Find the de Broglie
                                                                            0
...
For initial, free electron in motion the momentum p oe and the energy E oe are
 ...
 E oe = m ⋅ c = 2
                     ...
                     1− β 2
                                                                                                ...
                                                                                                v 1e
where m 0 is the rest mass of electron and m is the mass of moving electron. As usual, β =           .
                                                                                                 c
...
Pi + poe = p 0                                                                       ( 4.6)
and
E i + E 0e = E 0 + E 1e                                                              ( 4.7)
The conservation of moment on Ox direction is written as
h ⋅ fi                     h ⋅ f0
       + m ⋅ v 1e ⋅ cosα =        cosθ                                               ( 4.8)
 c                           c
and the conservation of moment on Oy is
                        h ⋅ f0
m ⋅ v 1e ⋅ sinα =              sinθ                                                  ( 4.9)
                          c
To eliminate α , the last two equation must be written again as

 (m ⋅ v 1e ⋅ cosα )2 = h 2 ⋅ (f0 ⋅ cosθ − f i )2
                               2


                              c
                                          2                                          ( 4.10)
 (m ⋅ v 1e ⋅ sinα ) = h ⋅ f0 sinθ
                        2
...
IPhO 1983                                                                       Theoretical Question IV
     ...
     m 02 ⋅ c 2
                  2
                                      (
                      ⋅ v 12e = h 2 ⋅ f 02 + f12 − 2f 0 ⋅ f i ⋅ cosθ   )                                  ( 4.12)
    v
1 − 1e
     c
The conservation of energy (4.7) can be written again as
m ⋅ c 2 + h ⋅ f1 = m 0 ⋅ c 2 + h ⋅ f 0                                                                    ( 4.13)
or
      m0 ⋅ c 2
                          = m 0 ⋅ c 2 + h ⋅ (f 0 − f1 )                                                   ( 4.14)
                      2
         v
     1 − 1e
          c
...
2m 0 ⋅ c 2 ⋅ h ⋅ (f 0 − f1 ) + 2h 2 ⋅ f1 ⋅ f 0 ⋅ cosθ − 2h 2 ⋅ f1 ⋅ f = 0                                 ( 4.16)
or
     h
           (1 − cosθ ) = c − c                                                                            ( 4.17)
m0 ⋅ c                           f1       f0
...
process gives
     ...
     h
           sinθ − m ⋅ v 2e ⋅ sin β = 0
     λf
To eliminate the unknown angle β must square and then add the equations (4.22)
That is
                                             2
          h            h
                                                 = (m ⋅ v 2e ⋅ cos β )
...
h ⋅c ⋅
 2            2
                              −                  + m 02 ⋅ c 4 + 2h ⋅ c 3 ⋅ m 0 ⋅        −          = m2 ⋅c4                ( 4.27)
                       λf           λ0                                             λf       λ0
...
Atomics – Problem IV - Solution                                                        Page 6 from 6
