...
contribution of each plate to the electric field is E
2
1
. Force is defined by the electric filed
...
V
Q
C = . (0.1)Using the answer to 1.3, we get
1
0
2
0 2
...
mechanical force isx k Fm 2 − = . (The coefficient (2) has (0.2))
...
for final result)Note: Students may simplify the above relation using the approximation 2 2
x d >> . It does
...
g m
x = max .
Moreover, from the result obtained in 3.2, we haved A C d
x A
V V
S
S
