...
FRINGES
1400 mm
ii. Vis a vis the diﬀraction phenomenon, β =
! y
1400 mm
"
...
The accepted value is 680 nm so that the departure from accepted value equals 1.5%.Section 2
...
35 mm
2x’
2 ’ θi. The entrance beam diameter is 2.00 mm. The following is an example of the calculations expected:
...
ii. & iii. One thus obtains the following table of results. 2θ′
can be determined as shown above, OR by
looking down onto the tank and using the protractor to measure the value of 2θ′
. It is important
...
using either method. Making the correct observations requires observational
...
0
ln T milk
Figure 2: Sample plotDetailed Mark Allocation
Section 1
