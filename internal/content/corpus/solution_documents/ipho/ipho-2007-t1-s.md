...
c, characteristic of special relativity, and G characteristic of gravity. Especially, it isindependent of the Planck constant h which is characteristic of quantum mechanical
phenomena.
γ β α
m c G A =
...
k c B
= η (0.1)
3.1)The first law of thermodynamics is dW dQ dE + = . By assumption, 0 = W d . Using the
...
(0.2)
(0.2)
(0.1) + (0.4) (For the first and the second terms respectively)4.5) Considering the solution to 4.3, one verifies that it will go away from the
equilibrium. (0.6)
⇒  


