...
SOLUTION
1. After some time t, the normal to the coil plane makes an angle ω t with the magnetic field i B B
r r
0 0 = . Then, the
...
r
is given by ( ) j t i t a S
r r r
ω ω π sin cos 2
+ =
Therefore t B a N ω π φ cos 0
2
=
The induced electromotive force is
dt
dφ
ε − = ⇒ t B a N ω ω π ε sin 0
2
=
