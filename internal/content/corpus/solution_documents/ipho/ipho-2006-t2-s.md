---
id: solution-document-ipho-2006-t2-s
source: ipho
...
provenance_note: "Source-provided solution document; preserved from cache/phoxiv/ipho/2006/T2_S.pdf."
---

SOLUTIONS to Theory Question 2

Basic relations Position x̃ shows up on the picture if light was emitted
...
Upon solving for x̃ we find

                                              q
2.2                           x̃ = γ 2 x − βγ D 2 + (γx)2 .
...
2.3      L̃(x0 ) = γL + βγ D 2 + γx0 −                 − βγ D 2 + γx0 +             .
                                       2                                   2
                                                        ...
                                                        dx0
Since the rod moves with the constant speed v, we have      = v and therefore
                                                         dt
the question is whether L̃(x0 ) increases or decreases when x0 increases. We
...
for L̃(x0 ), and this difference clearly decreases when x0 increases.
...
located at
                ...
                x̃0 = γ 2 x0 − βγ D 2 + (γx0 )2
                   ...
                   = βγ  (γD)2 +                        −      (γD)2 +                      ,
                                  2                                      2
                                                         L
which is at a distance ℓ = x̃+ − x̃0 =                      − x̃0 from the image of the front
                                                         2γ
end, that is
...
2.9                                           v=     .
                    ...
                    L̃early + L̃late   2
It follows that γ = q                = √ = 1.1547. Combined with
                   2 L̃early L̃late     3

                                       q
2.10                            L=       L̃early L̃late = 1.73 m ,
