---
id: solution-document-ipho-2018-e1-s
source: ipho
...
provenance_note: "Source-provided solution document; preserved from cache/phoxiv/ipho/2018/E1_S.pdf."
---
...
Using Ohm’s law, the current through the voltage divisor is 𝐼 = 𝑉in /(𝑅𝑥 + 𝑅𝑦 ), and 𝑉out = 𝑅𝑦 𝐼. Thus
...
A.2
    ...
    A.2     Uncertainty in each measurement: ±0.01 Ω                                                 0.5pt
                               #            𝑅T1           𝑅T2            𝑅T3
...
A.3
    ...
    A.3     For a parallelepiped conductor of length 𝑙, width 𝑤 and thickness 𝑡, the resis-        0.3pt
            tance is given by
                                                        𝑙
                                                   𝑅=𝜌
                                                       𝑤𝑡
...
A.6
  ...
  A.6   Uncertainty in resistance measurements: ±1 Ω.                                           0.3pt
...
where 𝑅𝑦′ is the equivalent resistance of the parallel association between 𝑅𝑦 and 𝑅L :
...
Thus,
                                           ...
                                           ′
                                        𝑅𝑦                                                𝑅L
                                       𝑅𝑥 +𝑅𝑦′      (𝑅𝑥 + 𝑅𝑦 )𝑅𝑦′   (𝑅𝑥 + 𝑅𝑦 ) 𝑅 +𝑅
                                                                                𝑦  L
                                𝑓=      𝑅𝑦
                                                  =               =
                                       𝑅𝑥 +𝑅𝑦
                                                           ′
                                                    (𝑅𝑥 + 𝑅𝑦 )𝑅𝑦     𝑅𝑥 + 𝑅 𝑦 𝑅 L     𝑅𝑦 +𝑅L


                                   𝑅
Note that in terms of 𝜂 = 1/(1 + 𝑅𝑦 ), the factor 𝑓 can be written as
                                       L
...
B.4
      ...
      B.4                                                                                             0.7pt
                                  ...
                                  Gate: A        𝑉GS = 0 V          𝑅DS = 50.0
                                                                                                              ...
                                                                                                              Confidential
                                      𝐿
              Drain   𝑉out /V       𝑉out /V       𝑉DS /𝑉         𝐼DS /mA        𝑟𝐼/V          𝑓
...
The 𝑅DS values are obtained from the slopes of the linear region of the output curves (small 𝑉DS voltages).
...
A linear fit to 𝑓𝑥) = 𝑎 𝑥 + 𝑏 gave 𝑎 = 2.50(2) and 𝑏 = 3.47(2). Thus, 𝑉P = −𝑏/𝑎 = −1.39(2) V and 𝐼DSS =
4.232 = 12.0(2) mA.

      B.8                         𝑉P = −𝑏/𝑎 = −1.39(2) V                                                                    0.4pt
                                  𝐼DSS = 4.232 = 12.0(2) mA.
...
roughly 20 times larger.
     ...
     sub
Let 𝐼DS  = 𝐴(1−exp(−𝑡/𝜏1 )) be the data subtracted from the long time constant component. A logarithmic
                 sub
plot of log(𝐴 − 𝐼DS  ) should be a straight line of slope −1/𝜏1 . The constant 𝐴, the saturation current of
