...
liquid phase 𝑐ℓ and the partial pressure 𝑃$0
...
LH⋅N−3
• Henry's constant at 𝑇0 =20°$, 𝑘)(20°$)=3.3×10−4
NPM⋅N−3
⋅1B−1
• Henry's constant at 𝑇0 =6°$, 𝑘)(6°$)=5.4×10−4
NPM⋅N−3
⋅1B−1
...
𝑎0 ≈40µN. Thenumberofmolesof$0 transferredatthebubble'ssurfaceperunitareaandtimeisnoted
𝑗. Two models are possible for 𝑗.
• model (1) 𝑗 =
𝐷
𝑎
(𝑐ℓ −𝑐C) where 𝐷 is the diffusion coefficient of $0 in the liquid.
...
and 𝑃C ≈𝑃0.
A.3 Express the number of $0 moles in the bubble 𝑛D in terms of 𝑎,𝑃0,𝑇0 and ideal
...
SOLUTION:
A.3.1. The number of moles of $0 (ideal gas) inside the bubble is 𝑛D = 4
3
𝜋𝑎3 𝑃0
𝑅𝑇0
...
𝑎2
𝜌ℓ𝑔0.
A.4.3. Time between two bubbles: 𝛥𝑡 =1/𝑓CTheory
...
∈[0.36−0.49]NN 0.2
There are 𝑁C nucleation sites of bubbles. Assume that the bubbles are nucleated at a constant frequencyTheory
...
film outside the rim remains still, with constant thickness ℎ.Theory
...
B.1.6. 𝑣𝑓 =√2𝜎/𝜌ℓℎ
If partial answer: 𝑣𝑓 =√𝜎/𝜌ℓℎ obtained only by dimensional analysis: 0.2 pt to the questionTheory
...
ℓ
𝑔0
B.3.6. Numerical value ℎ =3.7µNTheory
...
In a bottle, the total quantity of $0 is 𝑛5 = 0.2NPM, either dissolved in the volume 𝑉- = 750N- of liquid
champagne, or as a gas in the volume 𝑉( = 25N- under the cork (Fig. 6. left). 𝑉( contains only $0.
...
C.1 Give the numerical value of the pressure 𝑃J of gaseous $0 in the bottle for
𝑇0 =6°$ and 𝑇0 =20°$.
0.4pt
SOLUTION:
C.1.1. Conservation of $0 molecules: 𝑛𝑇 =𝑛𝑉 +𝑛𝐿 =𝑛𝑉 +𝑘𝐻(𝑇0)𝑃𝑖𝑉𝐿
...
$0
TBU for the $0 solid/gas transition follows : MPH10 ⒧
𝑃
$0
TBU
𝑃0
...
, and 𝐶 =−3.49,.
C.2 Give the numerical value 𝑇G of the $0 gas at the end of the expansion, after
...
⒭
(1/𝛾)−1
C.2.3. For 𝑇0 =6°$: 𝑃𝑖 =4.69CBS and 𝑇𝑓 =195.3,=−77.8°$.
C.2.4. For 𝑇0 =20°$: 𝑃𝑖 =7.45CBS and 𝑇𝑓 =184.3,=−88.8°$.
...
$0
TBU (𝑇𝑓 = 6°$) = 1.07CBS > 𝑃0 . As the solid-liquid frontier has a positive slope in 𝑃,𝑇
state-diagram, the final state of $0 is gaseous. 𝑃
$0
TBU (𝑇𝑓 = 20°$) = 0.41CBS < 𝑃0 . As the solid-gas frontier
...
𝑃0
⒭
−𝐶. 𝑇𝑡𝑟𝑎𝑛𝑠 = 194.4, = −78.8°$. For 𝑇0 = 6°$: 𝑇𝑓 = 195.3, > 𝑇𝑡𝑟𝑎𝑛𝑠; the
final state of $0 is gaseous. For 𝑇0 = 20°$: 𝑇𝑓 = 184.3, < 𝑇𝑡𝑟𝑎𝑛𝑠; the final gaseous state hypothesis isTheory
...
C.2.3. For 𝑇0 =6°$: 𝑃𝑖 =4.69CBS and 𝑇𝑓 =195.3, ; 0.1
C.2.4. For 𝑇0 =20°$: 𝑃𝑖 =7.45CBS and 𝑇𝑓 =184.3,; 0.1
...
At 𝑇0 =6°$: 𝑃𝑖 =4.69CBS . 𝑊𝑓 =−1.17+; 𝑊𝑒 =−0.64+; 𝛥𝑈𝑔 =−2.57+; 𝐸𝑐 =0.76+
...
find a work done by $0on the cork equal to: 𝑃𝑖(𝜋ℓ0𝑑2
