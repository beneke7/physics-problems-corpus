---
id: solution-document-ipho-2005-e1-s
source: ipho
...
mapped_problems: [ipho-2005-e1]
verification_status: pending
provenance_note: "Source-provided solution document; preserved from cache/phoxiv/ipho/2005/E1_S.pdf."
---
...
Draw the electric connections in the boxes and between boxes below.
   ...
   A
       ...
       Photoresistor                                      Ω      Ohmmeter
                                                          V      Voltmeter
       Incandescent Bulb
                                                          A      Ammeter
       Potentiometer
                                                          P      Platform
       Red socket                                        Pm      Potentiometer
       Black socket                                       B      Battery
...
For axis Y : σ R =
                   ∑ ∆R B2
                           = 0.047
                           B               n
σ =             σ R2 + m 2σ I2     =       0.12 + 0.167 2 ⋅ 0.012 = 0.1
                    B



∆R B 0 =
                          σ2  ∑ I 2 = 0.12 × 130.38 = 0.13
                        n∑ I 2 − (∑ I )
                                       2
                                         10 ⋅ 130.38 − 35.05 2
...
Method A
                                       ∆T       ∆R B 0               1           0.1 
ln a = ln T0 − 0.83 ln R B 0 ; ∆a = a 0 + 0.83         ; ∆a = 39.40
                                                                           + 0.83         = 0.419 = 0.4
                                        T
                                       0         R B0                297        11 .40 
Method B
                                           ...
                                           T0 + ∆T0                      297 + 1
Higher value of a:          amax =                            =                      = 39.8255
                                                      0.83
                                         (R0 − ∆R0 )              (11.4 − 0.1)0.83
                                           T0 − ∆T0                      297 − 1
Smaller value of a:         amin =                            =                      = 38.9863
                                                       0.83
                                         (R0 + ∆R0 )              (11.4 + 0.1)0.83

       amax − a min   39.8255 − 38.9863
∆a =                =                   = 0.419 = 0.4
            2                 2
...
b)
                      ...
                      R                              R                 5.07
Because of       ln      = γ ln 0.512 ;     γ = ln      ln 0.51 2 = ln      ln 0.512 = 0.702
                      R'                             R'                8.11
...
Method A
      ln R R '         1  ∆R ∆R '        1     0.01 0.01 
γ =            ; ∆γ =         +      =             +      = 0.00479 ; ∆γ = 0.005
        ln t          ln t  R   R '  ln 0.512  5.07 8.11 

Method B
                                         R − ∆R             5.07 − 0.01
Higher value of γ :         γ max = ln            ln γ = ln             ln 0.512 = 0.70654
                                         R'+ ∆R '           8.11 + 0.01

                                         R + ∆R            5.07 + 0.01
Smaller value of γ: γ max = ln                   ln γ = ln             ln 0.512 = 0.69696
                                         R '−∆R'           8.11 − 0.01

       γ max − γ min        0.70654 − 0.69696
∆γ =                    =                     = 0.00479 ;       ∆γ = 0.005
             2                      2
...
c)
                                                                c 2γ
                                                                λ0T
                                    We know that R = c3e               (3)
                                                                      cγ
                                    then                ln R = ln c3 + 2
                                                                      λ0T
                                    Because of          T = aRB0.83    (6)
                                                                       cγ
                                    consequently         ln R = ln c3 + 2 RB− 0.83
                                                                       λ0 a

                                                        cγ
                                          ln R = ln c3 + 2 RB− 0.83 Eq. (9)
                                                        λ0 a
...
We work out the errors for all the first row, as example.
                                          ...
                                          2           2                   2            2
                                      ∆V    ∆I                 0.01    0.1 
Error for RB: ∆R B = R B                  +           = 110.9        +             = 0. 2 Ω
                                      V     I                  9.48    85.5 

                             ∆a       ∆R               0. 3         0.2 
Error for T: ∆T = T            + 0.83 B  ; ∆T = 1962      + 0.83        = 18 K
                             a         RB              39.4        110.9 

Error for RB-0.83 :
                                                                              ∆RB                         ∆RB
                      x = RB− 0.83 ; ln x = −0.83 ln RB ; ∆x = x ⋅ 0.83
                                                                               RB
                                                                                           (      )
                                                                                  ; ∆ RB− 0.83 = RB− 0.83
                                                                                                           RB
...
σ = σ ln2 R + m 2σ 2 − 0.83 =
                            RB
                                                                      (
                                           0.002 2 + 414.672 2 ⋅ 0.003 × 10 − 2       ) = 0.0126
                                                                                       2
...
then
      ...
      414.67 ⋅ 1.381 × 10 −23 ·590 × 10 −9 ⋅ 39.4
h =                                                 = 6.33 × 10 − 34
                            8
                 2.998 × 10 ⋅ 0.702
...
∆h = h      +     +       +
       ...
        m     k       λ0     a       γ 
                                2              2            2              2
                     8. 3      28     0.3       0.01 
∆h = 6.34 × 10 − 34        +0+      +       +0+                        = 0.34 × 10 − 34
                     415       590    39.4      0.70 




      h = 6.3 × 10-34 J · s                                 ∆ h = 0.3 × 10-34 J · s
