...
Using ⟨𝑣𝑚 𝑣𝑛 ⟩ = 𝐶 for 𝑛 = 𝑚 and 0 otherwise, we find
                            𝑁
        ⟨Δ𝑥(𝑡)2 ⟩ = ∑ 𝐶𝛿 2 = 𝑁 𝐶𝛿 2 .                                                                    (S1.13)
                          𝑛=1
...
6.34 𝜇m2 . Plugging this and the values of the parameters given in the question sheet, we obtain
        𝑁𝐴 = 5.6 × 1023 mol−1 .                                                                                   (S1.32)
...
for general 𝑡. This can be rewritten as
                             2𝐷
        ⟨Δ𝑥2 ⟩ = 𝑢2 𝑡 (𝑡 +      ) = 𝑢2 𝑡(𝑡 + 𝑡∗ ),                                                                (S1.34)
                             𝑢2
with 𝑡∗ = 2𝐷/𝑢2 . Therefore,
