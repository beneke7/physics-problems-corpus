...
From which we have
         ...
         1         q 2 R l 2  L2  2lL cos                                                     (15)
 F
               
       4 0 l 2  L2  2lL cos   R 2 2      
...
where r is a vector on the sphere and d ' denotes the vector position of the image charge. When r
                                   
coincides with some ri , then we just have
...
From the requirement that the potential on the surface of the sphere vanishes we have
 ...
 r  d' r  d                                                                                      (24)
                                                       
where d denotes the vector position of the charge q ( r is on the sphere).
...
                  qi   
         ...
         1 1      qq'   1 1      qq '    1 1      q2R
                                 
         2 4 0 d 'd  2 4 0 d  d ' 2 4 0 d 2  R 2
