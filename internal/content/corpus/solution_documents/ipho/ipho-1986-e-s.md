---
id: solution-document-ipho-1986-e-s
source: ipho
kind: official_solution_document
language: en
solution_type: official
source_pdf: cache/phoxiv/ipho/1986_E_S.pdf
extraction_method: pdftotext-layout
mapped_problems: []
verification_status: flagged
provenance_note: "Source-provided solution document; preserved from cache/phoxiv/ipho/1986_E_S.pdf."
---
...
1.     FOR WATER AND RED LIGHT AT EXTREME END OF SPECTRUM
     ...
     k = 1           First Order Rainbow            θ1 =129.0°    φ 1 = 137.0 ±5.0°
     k = 2           Second Order Rainbow           θ2= 129.0°    φ 2 = 231.0 ±3.0°
     k = 5           Fifth Order Rainbow            θ5= 126.0°    φ 5 = 486.0 ±4.0°
...
2.       LIQUIDS A AND B USING SECOND ORDER RAINBOWS
         ...
         For Liquid A                      θ2 = 105.0°           φ 2= 255.0 ±3.0°

         For Liquid B                      θ2 = 89.5°            φ 2= 270.5 ±3.0°

                                                                               o
             For n = 1                      θ2 = 0.0..o           φ 2= 0.0..

         Gradient of graph                                        = 0.84 ±0.07

         Extrapolated, n =2,              θ2, value of φ          = 304 ±25o
...
Is the total momentum conserved?                                    YES /NO
                                                                          0.0000018
Accuracy of computer calculation                                    100             ≈ 0.002% 0:1
                                                                              0.1
(RMS velocity = 0.1)
...
Equilibrium value of Ek*      (Average 24 to 180) = 0.534 ±0.05

Equilibrium time SD           (see Fig. E 2.1 )         ≅ (10 to 20 ) ×0.1
Value of S recorded                                     > 20, e.g. 60
Value of α
             (for SD=60)         (see Fig. E2.2 )       = 0.503
...
Gradient of AVERAGE <R2> in linear region                                     = 0.035
...
160      0.0000016   0.0000010       0.000077     0.000048
    ...
    S     <VX,2>      <VY,2>         <KE> = T*              <U>               <E>= Total Energy
...
All values are in reduced units. <KE> is the mean kinetic energy per atom. <U*> is twice the
potential energy. <VX,2> and <VY,2> are the mean values of the squares of the X and Y velocity
components, as described in the question. Similarly <VX,1> and <VY,1> are the mean values of the
velocity components. <PX> and <PY> are the mean momentum per particle.
    ...
    Figure E2,3
                        ...
                        2
                            ...
                            0             6       12            18        24
                                  ...
                                  <R z > curves as a function of time
...
Time Number
SZ - S-SR     SR = 261   SR = 301   SR = 334    SR = 370    AVERAGE
               <R2>       <R2>       <R2>      <R2>          <R2>
