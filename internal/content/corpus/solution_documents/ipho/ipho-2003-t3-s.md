...
(a) Let ( c 2 E e , cqe ) , ( c 2 E p , cq p ) , and ( c 2 E v , cqv ) be the energy-momentum 4-vectors of the
   electron, the proton, and the anti-neutrino, respectively, in the rest frame of the neutron.
                                K K K
   Notice that E e , E p , Eν , qe , q p , qν are all in units of mass. The proton and the anti-neutrino
   ...
   of the center of mass and we have
                      vm     q          qp            q           q
                         = v         =            = c          = e                   (A12)
                       c     Ev E =E    Ep            Ec E =E     E c M =m + m
                                           max           E = Emax            max             c   p   v
...
cqe and energy c2Ee, the proton with cq p and c 2 E p , and the anti-neutrino with cqv and
                                      K
c 2 Ev . With the magnitude of vector qα denoted by the symbol qα, we have

                          E 2p = m 2p + q 2p ,     E v2 = mv2 + qv2 ,     E e2 = me2 + qe2                (1A)
...
Note that the equality in Eq. (8A) holds only if θ = 0, i.e., the energy of the electron c2Ee takes
on its maximum value only when the anti-neutrino and the proton move in the same direction.
 ...
 cβ p and cβ v , respectively. We then have q p = β p E p and qv = β v E v . As shown in Fig.
A1, we introduce the angle φ v ( 0 ≤ φ v < π / 2 ) for the antineutrino by

           qv = mv tan φ v ,           Ev = mv2 + qv2 = mv sec φ v ,             β v = qv / Ev = sin φ v        (9A)
...
Similarly, for the proton, we write, with 0 ≤ φ p < π / 2 ,
          ...
          q p = m p tan φ p ,         E p = m 2p + q 2p = m p sec φ p ,         β p = q p / E p = sin φ p      (10A)
...
The factor in parentheses at the end of the last equation may be expressed as
      ...
      1 − sin φ p sin φ v        1 − sin φ p sin φ v − cos φ p cos φ v          1 − cos(φ p − φ v )
                             =                                           +1 =                         +1 ≥ 1   (12A)
        cos φ p cos φ v                      cos φ p cos φ v                      cos φ p cos φ v

and clearly assumes its minimum possible value of 1 when φ p = φ v, i.e., when the
anti-neutrino and the proton move with the same velocity so that β p = β v. Thus, it follows
...
(b) Refer to Fig. B1. Refraction of light at the spherical surface obeys Snell’s law and leads to
                                           n sin θ i = sin θ t                               (B1)
   Neglecting terms of the order (δ /R)3or higher in sine functions, Eq. (B1) becomes
                                            nθ i ≈ θ t                                                      (B2)
   For the triangle ∆FAC in Fig. B1, we have
                                                                                              z
                  β = θ t − θ i ≈ nθ i − θ i = (n − 1)θ i            (B3)
                                                                                                   F

       Let f 0 be the frequency of the incident light. If n p
   is the number of photons incident on the plane surface per                            θt
   unit area per unit time, then the total number of photons                                  β
   incident on the plane surface per unit time is n pπδ 2 . The
                                                                                     A
   total power P of photons incident on the plane surface is                                  θi
    (n pπδ 2 )(hf 0 ) , with h being Planck’s constant. Hence,
                                         P                                                             n
                               np =                                  (B4)                 θi
                                      πδ 2 hf 0
                                                                                                   C
   ...
   per unit time is n p (2πrdr ) , where r = R tan θ i ≈ Rθ i .
                                                                                         Fig. B1
   Therefore,

                                      n p (2πrdr ) ≈ n p (2πR 2 )θ i dθ i                                   (B5)
...
where tan θ im =
                   δ
                       ≈ θ im . Therefore, by the result of Eq. (B5), we have
                   R

                        πR 2 P hf 0 δ 2     ( n − 1) 2 δ 2   P     ( n − 1) 2 δ 2
                Fz =                    1 −                =   1 −                      (B8)
                       πδ 2 hf 0 c R 2          4R 2         c         4R 2
...
4.0 pts.    4.0     ¾ 0.5 use energy-momentum conservation and can convert it into
                    ...
                    ¾ 0.5 for concluding β v = E e2 − me2 /(mn − Ee ) .
...
Part B      (b)     Laser power needed to balance the weight of the glass hemisphere.
                    ¾ 0.3 for law of refraction n sin θ i = sin θ t .
4.0 pts     4.0     ¾ 0.3 for making the linear approximation nθ i ≈ θ t .
                    ...
                    ¾ 0.4 for force of levitation = sum of forces exerted by incident and
                           refracted photons.
                    ¾ 0.4 for force of levitation = (n-1)2δ 2P/(4cR 2).
                    ¾ 0.3 for the needed laser power P = 4mgcR 2/(n-1)2δ 2.
