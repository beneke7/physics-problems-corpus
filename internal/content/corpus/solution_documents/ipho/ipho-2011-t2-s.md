...
2. SOLUTION
  ...
  2.1. The bubble is surrounded by air.
      ...
      The pressure and density are related by the ideal gas law:
                               RT
       PV  nRT or P                , where M = the molar mass of air.               … (2)
                               M
...
2.4. Ignore the radius change  Radius remains R0  1.0 cm
    ...
    The drag force from Stokes’ Law is F  6 R0u                           … (9)
    ...
    When the bubble is in thermal equilibrium Ti  Ta .
                            4             4      4 3
    6 R0u   4 R02  st   R03 a 1       g   R0  a g
                            3          R0 Pa      3
...
2.5. The numerical value is u  0.36 m/s .
    ...
    The 2nd term is about 3 orders of magnitude lower than the 1 st term.
...
Eq = total field just outside the pill box =                      
  ...
  = E  E
                                                                       ...
                                                                       
Using Gauss’s Law on the pill box, we have E                             perpendicular to the film
                                                                      2 0
...
                                                  Theoretical Competition: Solution
   ...
    R0   R0  32  0 R0 Pa
                    2     4
                                ...
                                R1
   Note that (17) yields            1 when q  0 , as expected.
                                R0



                                                        q2
2.7. Approximate solution for R1 when                                1
                                                  32 2 0 R04 Pa

    Write R1  R0  R, R  R0
                                             4
               R     R  R          R
    Therefore, 1 1  ,  1   1  4                                             … (18)
               R0    R0  R0         R0
