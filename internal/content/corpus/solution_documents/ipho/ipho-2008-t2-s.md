---
id: solution-document-ipho-2008-t2-s
source: ipho
kind: official_solution_document
language: en
solution_type: official
source_pdf: cache/phoxiv/ipho/2008/T2_S.pdf
extraction_method: pdftotext-layout
mapped_problems: [ipho-2008-t2]
verification_status: pending
provenance_note: "Source-provided solution document; preserved from cache/phoxiv/ipho/2008/T2_S.pdf."
---
...
1.
     ...
     Let us consider a plane containing the particle trajectory. At t = 0 , the particle

position is at point A. It reaches point B at t = t1 . According to the Huygens principle, at


moment 0 < t < t1 , the radiation emitted at A reaches the circle with a radius equal to AD
...
proportional to the distance of their centre to B:
     ...
     The spheres are therefore transformed into each other by homothety of vertex B and
                                                                                      ...
                                                                                      1 π
their envelope is the cone of summit B and half aperture ϕ = Arcsin                     = −θ ,
                                                                                      βn 2
...
BD'.
                                              ...
                                              1
     1.2. They make an angle ϕ = Arcsin          with the particle trajectory.
                                              βn
...
containing the trajectory of the particle and the optical axis of the mirror.
    ...
    IS – the straight-line trajectory of the charged particle making a small angle α with
...
the focal plane at O. We have FO ≈ f × α .
    Starting from C, we draw two lines in both sides of the line CO making with it an
angle θ. These two lines intersect the focal plane at M and N, respectively. All the rays of
Cherenkov radiation in the plane of the sketch, striking the mirror and being reflected,
...
3.
                                                                                            c
     3.1. For the Cherenkov effect to occur it is necessary that n >                          , that is
                                                                                            v
      c
nmin = .
      v

Putting ζ = n − 1 = 2.7 × 10−4 P ,           we get

                                         c          1
           ζ min = 2.7 × 10−4 Pmin = − 1 =              −1                                    (1)
                                         v          β
Because
...
then K = 0.094 ; 0.05 ; 0.014 for proton, kaon and pion, respectively.
     From (2) we can express β through K as

                     1
             β=                                                                               (3)
                   1+ K 2

   Since K 2 << 1 for all three kinds of particles we can neglect the terms of order
higher than 2 in K . We get
   ...
   We get the following numerical values of the minimal pressure:
              ...
              Pmin = 16 atm                        for protons,


              Pmin = 4.6 atm                       for kaons,


              Pmin = 0.36 atm                      for pions.


   3.2. For θ π = 2θ κ                we have


       cos θ π = cos 2θ κ = 2 cos 2 θ κ − 1                                                     (5)
...
Substituting β = 1 − ε and n = 1 + ζ into (7), we get approximately:
   ...
   The corresponding value of refraction index is n = 1.00162. We get:
        ...
        θ κ = 1.6o ;                          θ π = 2θ κ = 3.2o .
We do not observe the ring image of protons since
             P1 = 6 atm < 16 atm = Pmin for protons.
              2
...
tan θ = θ , we derive
     ...
     We obtain
                                                          ...
                                                          π                      Δθ κ          1o
     -for kaons K κ = 0.05 ,         θ κ = 1.6o = 1.6          rad , and so,          = 0.51         ,
                                                        180                      Δp          GeV / c

     -for          pions           K π = 0.014            ,          θ π = 3.2 o           ,           and
...
Δθ < 0.1(θ π − θ κ ) = 0.16o .

                            1 1.6
     It follows    Δp <      ×     = 0.3 GeV / c .
                           10 0.53
...
on the refraction index n of the medium is given by the expression
...
θ π = 3.2o , n = 1.00162.
                                                                                        ...
                                                                                        δn
   Putting approximately tan θ = θ              and        n = 1, we get        δθ =       = 0.033o .
                                                                                        θ
   6.2.
          6.2.1. The broadening due to dispersion in terms of half width at half height is,
                      1
according to (6.1),     δθ = 0.017o .
                      2
          6.2.2.   The      broadening       due      to     achromaticity       is,     from     4.1.,

        1o
0.02         × 0.3 GeV/c = 0.006o , that is three times smaller than above.
       GeV/c
