...
the fall.
     ...
     A.2    Determine the theoretical expression for the maximum drop height ÷NBY . Cal-        0.5pt
...
the experiment only twice, and compute the mean value ‫ܝ‬.
     ...
     A.3    Present your results in a table: mass of the ball ܿ, drop height ÷, impact energy   1.7pt
            ‫ܞ‬, crater diameter ‫ܝ‬.
...
Experiment
   ...
   A.4      Plot your results on the graph paper of your choice (logarithmic or linear). On   1.2pt
...
We assume that the ball rolls on the rail without slipping and neglect any energy dissipation.
     ...
     B.1     Express the position ݊ of the ball as a function of time ݆, angle ঞ and acceleration    0.4pt
             of gravity ܺ.
...
Experiment
    ...
    B.2        Take 5 measurements and present the result along with the order of magnitude             0.7pt
...
reproducible.
    ...
    B.4        Plot your results with error bars to confirm the law established at question B.1.        1pt
...
We can plot ü as a function of ݆ Ҩ or vice versa to obtain a straight line.
...
Experiment
            ...
            B4(1) : smart choice for the axes (ü, ݆ Ҩ ) or anything that ends to a line          0.2pt
            B4(2) : Presence of error bars for t                                                 0.2pt
            B4(3) : Adjustment made by a straight line.                                          0.2pt
            B4(4) : value of g between 6ms    ֟Ҩ
                                                   and 14 ms   ֟Ҩ
                                                                                                 0.2pt
            B4(5) : values of g between 8ms֟Ҩ and 12 ms֟Ҩ                                        0.1pt
            B4(6) : Uncertainty on g of the order of 1 ms      ֟Ҩ
                                                                                                 0.1pt
...
a power law of the form ‫ ܥ‬ƭ üն in which the exponent গ takes two different values.

     B.5     For model 1 and model 2, give the relationship between ‫ ܥ‬and ü and the value                0.6pt
             of গ.
...
The point are compatible with a straight line and a "solid-like" friction model (suggestion #1)
           ...
           B7(4) : graph L as a function of ü or log(‫ )ܥ‬as a function of log(ü), axes,    0.1pt
           values and units
