---
id: solution-document-ipho-2002-e2-s
source: ipho
kind: official_solution_document
language: en
solution_type: official
source_pdf: cache/phoxiv/ipho/2002/E2_S.pdf
extraction_method: pdftotext-layout
mapped_problems: [ipho-2002-e2]
verification_status: pending
provenance_note: "Source-provided solution document; preserved from cache/phoxiv/ipho/2002/E2_S.pdf."
---
...
3. Additional information [total 1.0 pts]:
                           ...
                           no.1          no.3        no.2
 Distance of the grating (no.1)                   Distance of the grating (no.2)
  to the left wall is practically zero          to the right wall is practically zero
      [0.2 pts]                                          [0.2 pts]
...
4. Diffraction grating [total 2.0 pts]:
        ...
        Path length difference:
                                ∆ = d sin θ ,                d = spacing of the grating
        ...
        Observation data:
                 tan θ          θ                 sin θ
                 0.34           18.780            0.3219
                 0.32           17.740            0.3048                       number of data ≥ 3
                 0.32           17.740            0.3048                          [0.5 pts]
...
5. Diffraction grating [total 2.0 pts]:
     ...
     Observation data:
                tanθ            θ               sinθ
                1.04            46.120          0.7208
                0.96            43.830          0.6925                         number of data ≥ 3

                1.08            47.200          0.7330                            [0.5 pts]
...
6. Plan-parallel plate [total 2.0 pts]:
                                     ...
                                     ϕ   A             D
                                          ϕ′
                                                        C
                                                   B
                            n                          drawing and labels should be complete
                                                                              [0.4 pts]
                                     90°−ϕ
     Snell’s law:
               sin ϕ = n sin ϕ′ ,                       ϕ′ = ∠ BAC
     Path length inside the plate:
              AC = AB / cos ϕ′ ,                        AB = h = plate thickness
     Beam displacement:
             CD = t = AC sin ∠ CAD ,               ∠ CAD = ϕ − ϕ′
     Hence:
             t = h sin ϕ [ 1 − cos ϕ / (n2 − sin2 ϕ)1/2 ]   [0.6 pts]

     Observation data:
               ϕ                 t
               0                0        (angle between beam and axis 49°)
                  490           7.3 arbitrary scale                           [0.5 pts]
