...
2. Answer:
![](../../../figures/solution-ocr/b69721aeee2859bb86350be0.jpg)
...
3. Answer:
![](../../../figures/solution-ocr/2a2ec43c078681cab0c940e3.jpg)
...
| Rear mass closing phase![](../../../figures/solution-ocr/20e43f1cfac3c14abb28e5bc.jpg) $\begin{aligned} & \mathrm { N } = \mathrm { W } = 4.9 \mathrm {~N} \\ & \mathrm {~F} _ { \mathrm { c } } = 1.4 \mathrm {~N} \\ & \text { Friction } = 0.74 \mathrm {~N} \end{aligned}$ | Front mass closing phase![](../../../figures/solution-ocr/9494580131465515115f1a01.jpg) $\begin{aligned} & \mathrm { N } = \mathrm { W } = 4.9 \mathrm {~N} \\ & \mathrm {~F} _ { \mathrm { c } } = 1.4 \mathrm {~N} \\ & \text { Friction } = 1.23 \mathrm {~N} \end{aligned}$ |
| :--- | :--- |
| Rear mass opening phase![](../../../figures/solution-ocr/fb54a53dc083fc3e218fdf10.jpg) $\begin{aligned} & \mathrm { N } = \mathrm { W } = 4.9 \mathrm {~N} \\ & \mathrm {~F} _ { \mathrm { o } } = 1.4 \mathrm {~N} \end{aligned}$ <br> Friction $= 1.23 \mathrm {~N}$ | Front mass opening phase![](../../../figures/solution-ocr/6a0de74ddca45ba88f20c4d8.jpg) $\begin{aligned} & \mathrm { N } = \mathrm { W } = 4.9 \mathrm {~N} \\ & \mathrm {~F} _ { \mathrm { o } } = 1.4 \mathrm {~N} \\ & \text { Friction } = 0.74 \mathrm {~N} \end{aligned}$ |
...
![](../../../figures/solution-ocr/125006370ea2dfca548af431.jpg)

| Axes labels, units and scale<br>- Must be displacement vs time<br>- Units must be compatible with the label<br>- Scale must be regular<br>- Scale does not need to be the right order of magnitude<br>- 1 mark per correct axes<br> | +2.0 |
| :--- | :--- |
...
3. Solution:
![](../../../figures/solution-ocr/a80cc194e03c4822d0731acb.jpg)
...
5. Answer:
![](../../../figures/solution-ocr/d2b8fd2f2e13e49cdc38df53.jpg)
...
1. Solution:
![](../../../figures/solution-ocr/f59a7060cf33a6830c6ed03d.jpg)
...
| Correct paths Award:<br>- + 0.5 for reflection off glass<br>- + 1 for refraction and 1 reflection off mirror<br>- + 1.25 multiple reflections through the glass<br>- + 0.25 fully correct<br>- -0.5 light transmitted through metal surface<br> | +3.0 |
| :--- | :--- |
| Explanation | +2.0 |
| Total | 5.0 |
...
3. Solution:
![](../../../figures/solution-ocr/0833e4056af3ff45a0962ea2.jpg)
...
| compute necessary additional horizontal friction force in the correct direction. <br> No penalty for errors in numerical values from the previous question. But they don't get the mark unless they've used torque in the previous parts. | +0.5 |
| :--- | :--- |
