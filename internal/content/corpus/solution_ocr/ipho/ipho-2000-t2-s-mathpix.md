---
id: solution-ocr-ipho-2000-t2-s
source: ipho
...
Angular velocity $\omega = \mathrm { e } B / \mathrm { m }$; so time for one orbit $T = 2 \pi \mathrm {~m} / \mathrm { e } B$
...
Maximum $u$ corresponds to minimum $\phi$ - at 23°
Therefore $u = 2.687 \times 10 ^ { 8 } \mathrm {~m} / \mathrm { s } = 0.896 \mathrm { c }$.
Relativistic $\% \left( 1 - v ^ { 2 } / c ^ { 2 } \right) ^ { - 1 / 2 } = 2.255$,
so kinetic energy of electron $= ( \gamma - 1 ) \mathrm { m } \mathrm { c } ^ { 2 } = 641 \mathrm { keV }$.
...
Acceleration caused by this force $a = B$ e $u \sin \phi / \gamma \mathrm { m }$
...
$$
\begin{array} { l l }
\text { VERTICAL } & ( y / B s \sin \phi ) ^ { 2 } \\
\text { HORIZONTAL } & ( B s t \sin \phi / V ) ^ { 2 }
\end{array}
$$
Therefore we have a gradient
$$
( \mathrm { e } / \mathrm { m } ) ^ { 2 }
$$
and a vertical-axis intercept
$$
- ( \mathrm { e } s / \mathrm { m } \mathrm { c } ) ^ { 2 }
$$
