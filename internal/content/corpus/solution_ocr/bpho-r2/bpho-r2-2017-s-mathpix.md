---
id: solution-ocr-bpho-r2-2017-s
source: bpho-r2
...
mapped_problems: [bpho-r2-2017-q2, bpho-r2-2017-q3, bpho-r2-2017-q4, bpho-r2-2017-q5]
verification_status: promoted
provenance_note: "Mathpix PDF API Markdown conversion; promoted to canonical display without manual proofreading."
---
## Round 2 Solutions - January 2017

These solutions written about the problems and do not constitute what the student might be expected to write as a solution in an exam.

Some changes occur during marking and those changes may not be included here.

## Correction

In Q4(b)(ii) there is a spurious $\mu$ in the solution suggested to the differential equation derived. This is a hangover from the original setting of the question in terms of reduced mass, so should have been replaced by $m _ { p }$.

The formula they find in (b)(iii) for Kepler's 3rd law may end up having a $\mu$ in it, and students will at least have come across the 3rd law in some detail and most of them will have seen it in terms of the semi-major axis in the BAAO paper - meaning that there should not be too much confusion over its use in parts (c) and (d).

However, be sure to bear this error in mind when looking at their attempts at Q4.
This is a set of solutions and eaplanations rather than a markscone. students will dowill on one or two quistions and rey bady or not ever attenyt others. Give marks far progress. Be writtent heat fillow your fudgements. We are Meding out the top students from this, not typing is obtain an enoct ranking for everyone We have awads in back because with the questions it's not prosille trhase a preceive mark shome. It incloult enail Robin Hugher on RH584Q Camac.ur


## British Physics Olympiad <br> Round 2 Solutions Qs 2-5
